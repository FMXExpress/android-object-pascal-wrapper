...
type
  ...
  JSettings_SecureClass = interface(JObjectClass)
    ['{127FE117-2FCE-4E9D-A18C-EAA05334D7D1}']
    ...
    function isLocationProviderEnabled(cr : JContentResolver; provider : JString) : boolean; cdecl;// (Landroid/content/ContentResolver;Ljava/lang/String;)Z A: $19
    ...
    procedure setLocationProviderEnabled(cr : JContentResolver; provider : JString; enabled : boolean) ; cdecl;// (Landroid/content/ContentResolver;Ljava/lang/String;Z)V A: $19
  ...
  JSettings_Secure = interface(JObject)
    ['{0ACC117D-365C-4E84-B76E-093F5BA47A31}']
  end;
