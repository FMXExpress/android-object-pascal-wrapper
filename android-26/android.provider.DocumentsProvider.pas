...
type
  ...
  JDocumentsProviderClass = interface(JObjectClass)
    ['{5A4C83EF-0DB2-4EA3-B769-A52A050E19AD}']
    ...
    function copyDocument(sourceDocumentId : JString; targetParentDocumentId : JString) : JString; cdecl;// (Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String; A: $1
    ...
    function createWebLinkIntent(documentId : JString; options : JBundle) : JIntentSender; cdecl;// (Ljava/lang/String;Landroid/os/Bundle;)Landroid/content/IntentSender; A: $1
    ...
    function findDocumentPath(parentDocumentId : JString; childDocumentId : JString) : JDocumentsContract_Path; cdecl;// (Ljava/lang/String;Ljava/lang/String;)Landroid/provider/DocumentsContract$Path; A: $1
    function getDocumentStreamTypes(documentId : JString; mimeTypeFilter : JString) : TJavaArray<JString>; cdecl;// (Ljava/lang/String;Ljava/lang/String;)[Ljava/lang/String; A: $1
    ...
    function moveDocument(sourceDocumentId : JString; sourceParentDocumentId : JString; targetParentDocumentId : JString) : JString; cdecl;// (Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String; A: $1
    ...
    function openTypedDocument(documentId : JString; mimeTypeFilter : JString; opts : JBundle; signal : JCancellationSignal) : JAssetFileDescriptor; cdecl;// (Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;Landroid/os/CancellationSignal;)Landroid/content/res/AssetFileDescriptor; A: $1
    ...
    function queryChildDocuments(JStringparam0 : JString; TJavaArrayJStringparam1 : TJavaArray<JString>; JStringparam2 : JString) : JCursor; cdecl; overload;// (Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor; A: $401
    function queryChildDocuments(parentDocumentId : JString; projection : TJavaArray<JString>; queryArgs : JBundle) : JCursor; cdecl; overload;// (Ljava/lang/String;[Ljava/lang/String;Landroid/os/Bundle;)Landroid/database/Cursor; A: $1
    ...
    procedure ejectRoot(rootId : JString) ; cdecl;                              // (Ljava/lang/String;)V A: $1
    procedure removeDocument(documentId : JString; parentDocumentId : JString) ; cdecl;// (Ljava/lang/String;Ljava/lang/String;)V A: $1
  ...
  JDocumentsProvider = interface(JObject)
    ['{41633CBD-8E7B-4A59-A41C-A01FEC7C975C}']
    function call(method : JString; arg : JString; extras : JBundle) : JBundle; cdecl;// (Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle; A: $1
    function canonicalize(uri : JUri) : JUri; cdecl;                            // (Landroid/net/Uri;)Landroid/net/Uri; A: $1
    function copyDocument(sourceDocumentId : JString; targetParentDocumentId : JString) : JString; cdecl;// (Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String; A: $1
    function createDocument(parentDocumentId : JString; mimeType : JString; displayName : JString) : JString; cdecl;// (Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String; A: $1
