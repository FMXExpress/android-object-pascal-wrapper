...
type
  ...
  JBitmapClass = interface(JObjectClass)
    ['{E1788BCD-DA90-40E9-ABA0-9552B052F670}']
    ...
    function getColorSpace : JColorSpace; cdecl;                                // ()Landroid/graphics/ColorSpace; A: $11
  ...
  JBitmap = interface(JObject)
    ['{5749CF95-08C4-447E-BCD1-6CCA2BB11214}']
    function compress(format : JBitmap_CompressFormat; quality : Integer; stream : JOutputStream) : boolean; cdecl;// (Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z A: $1
    function copy(config : JBitmap_Config; isMutable : boolean) : JBitmap; cdecl;// (Landroid/graphics/Bitmap$Config;Z)Landroid/graphics/Bitmap; A: $1
    function describeContents : Integer; cdecl;                                 // ()I A: $1
    function extractAlpha : JBitmap; cdecl; overload;                           // ()Landroid/graphics/Bitmap; A: $1
  ...
  JCanvasClass = interface(JObjectClass)
    ['{E063D865-D254-49CA-B96F-040506D74AB0}']
    ...
    function save : Integer; cdecl; overload;                                   // ()I A: $1
    function save(saveFlags : Integer) : Integer; deprecated; cdecl; overload;  // (I)I A: $1
  ...
  JCanvas = interface(JObject)
    ['{6D5C08EE-5CAC-4E57-B021-5DC1976C6830}']
    function clipOutPath(path : JPath) : boolean; cdecl;                        // (Landroid/graphics/Path;)Z A: $1
    function clipOutRect(left : Integer; top : Integer; right : Integer; bottom : Integer) : boolean; cdecl; overload;// (IIII)Z A: $1
    function clipOutRect(left : Single; top : Single; right : Single; bottom : Single) : boolean; cdecl; overload;// (FFFF)Z A: $1
    function clipOutRect(rect : JRect) : boolean; cdecl; overload;              // (Landroid/graphics/Rect;)Z A: $1
  ...
  JPictureClass = interface(JObjectClass)
    ['{E32A6DC3-AEFC-4385-BDC4-25AA2C7B8BCF}']
  ...
  JPicture = interface(JObject)
    ['{6E08C075-E1DC-4FD4-AC1E-3D6931483FAD}']
    function beginRecording(width : Integer; height : Integer) : JCanvas; cdecl;// (II)Landroid/graphics/Canvas; A: $1
    function getHeight : Integer; cdecl;                                        // ()I A: $1
    function getWidth : Integer; cdecl;                                         // ()I A: $1
    procedure draw(canvas : JCanvas) ; cdecl;                                   // (Landroid/graphics/Canvas;)V A: $1
