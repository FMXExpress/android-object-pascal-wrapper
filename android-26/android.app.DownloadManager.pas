...
type
  ...
  JDownloadManagerClass = interface(JObjectClass)
    ['{3C4BBE69-7DE6-4139-A701-0DBA897716F1}']
    ...
    function addCompletedDownload(title : JString; description : JString; isMediaScannerScannable : boolean; mimeType : JString; path : JString; length : Int64; showNotification : boolean) : Int64; cdecl; overload;// (Ljava/lang/String;Ljava/lang/String;ZLjava/lang/String;Ljava/lang/String;JZ)J A: $1
    function addCompletedDownload(title : JString; description : JString; isMediaScannerScannable : boolean; mimeType : JString; path : JString; length : Int64; showNotification : boolean; uri : JUri; referer : JUri) : Int64; cdecl; overload;// (Ljava/lang/String;Ljava/lang/String;ZLjava/lang/String;Ljava/lang/String;JZLandroid/net/Uri;Landroid/net/Uri;)J A: $1
  ...
  JDownloadManager = interface(JObject)
    ['{91A2EBD5-41DE-4562-8190-41C1539697CA}']
    function addCompletedDownload(title : JString; description : JString; isMediaScannerScannable : boolean; mimeType : JString; path : JString; length : Int64; showNotification : boolean) : Int64; cdecl; overload;// (Ljava/lang/String;Ljava/lang/String;ZLjava/lang/String;Ljava/lang/String;JZ)J A: $1
    function addCompletedDownload(title : JString; description : JString; isMediaScannerScannable : boolean; mimeType : JString; path : JString; length : Int64; showNotification : boolean; uri : JUri; referer : JUri) : Int64; cdecl; overload;// (Ljava/lang/String;Ljava/lang/String;ZLjava/lang/String;Ljava/lang/String;JZLandroid/net/Uri;Landroid/net/Uri;)J A: $1
    function enqueue(request : JDownloadManager_Request) : Int64; cdecl;        // (Landroid/app/DownloadManager$Request;)J A: $1
    function getMimeTypeForDownloadedFile(id : Int64) : JString; cdecl;         // (J)Ljava/lang/String; A: $1
