...
type
  ...
  JScannerClass = interface(JObjectClass)
    ['{35A47B01-67EE-4EB4-8DCA-632461A02C5E}']
    ...
    function init(source : JFile) : JScanner; cdecl; overload;                  // (Ljava/io/File;)V A: $1
    function init(source : JFile; charsetName : JString) : JScanner; cdecl; overload;// (Ljava/io/File;Ljava/lang/String;)V A: $1
    function init(source : JInputStream) : JScanner; cdecl; overload;           // (Ljava/io/InputStream;)V A: $1
    function init(source : JInputStream; charsetName : JString) : JScanner; cdecl; overload;// (Ljava/io/InputStream;Ljava/lang/String;)V A: $1
    function init(source : JPath) : JScanner; cdecl; overload;                  // (Ljava/nio/file/Path;)V A: $1
    function init(source : JPath; charsetName : JString) : JScanner; cdecl; overload;// (Ljava/nio/file/Path;Ljava/lang/String;)V A: $1
    function init(source : JReadable) : JScanner; cdecl; overload;              // (Ljava/lang/Readable;)V A: $1
    function init(source : JReadableByteChannel) : JScanner; cdecl; overload;   // (Ljava/nio/channels/ReadableByteChannel;)V A: $1
    function init(source : JReadableByteChannel; charsetName : JString) : JScanner; cdecl; overload;// (Ljava/nio/channels/ReadableByteChannel;Ljava/lang/String;)V A: $1
    function init(source : JString) : JScanner; cdecl; overload;                // (Ljava/lang/String;)V A: $1
    ...
    function useLocale(locale : JLocale) : JScanner; cdecl;                     // (Ljava/util/Locale;)Ljava/util/Scanner; A: $1
  ...
  JScanner = interface(JObject)
    ['{3F8A3C89-87EA-42F7-925D-C3040CA058BF}']
    function delimiter : JPattern; cdecl;                                       // ()Ljava/util/regex/Pattern; A: $1
    function findInLine(pattern : JPattern) : JString; cdecl; overload;         // (Ljava/util/regex/Pattern;)Ljava/lang/String; A: $1
    function findInLine(pattern : JString) : JString; cdecl; overload;          // (Ljava/lang/String;)Ljava/lang/String; A: $1
    function findWithinHorizon(pattern : JPattern; horizon : Integer) : JString; cdecl; overload;// (Ljava/util/regex/Pattern;I)Ljava/lang/String; A: $1
