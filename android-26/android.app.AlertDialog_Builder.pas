...
type
  ...
  JAlertDialog_BuilderClass = interface(JObjectClass)
    ['{D16DC150-101C-4C72-A76B-670DCBF2AFA1}']
    ...
    function init(context : JContext; themeResId : Integer) : JAlertDialog_Builder; cdecl; overload;// (Landroid/content/Context;I)V A: $1
    ...
    function setInverseBackgroundForced(useInverseBackground : boolean) : JAlertDialog_Builder; deprecated; cdecl;// (Z)Landroid/app/AlertDialog$Builder; A: $1
    ...
    function setView(layoutResId : Integer) : JAlertDialog_Builder; cdecl; overload;// (I)Landroid/app/AlertDialog$Builder; A: $1
    function setView(view : JView) : JAlertDialog_Builder; cdecl; overload;     // (Landroid/view/View;)Landroid/app/AlertDialog$Builder; A: $1
  ...
  JAlertDialog_Builder = interface(JObject)
    ['{CCEA7A4D-C1D2-4689-802F-B34BD1D56D49}']
    function create : JAlertDialog; cdecl;                                      // ()Landroid/app/AlertDialog; A: $1
    function getContext : JContext; cdecl;                                      // ()Landroid/content/Context; A: $1
    function setAdapter(adapter : JListAdapter; listener : JDialogInterface_OnClickListener) : JAlertDialog_Builder; cdecl;// (Landroid/widget/ListAdapter;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder; A: $1
    function setCancelable(cancelable : boolean) : JAlertDialog_Builder; cdecl; // (Z)Landroid/app/AlertDialog$Builder; A: $1
