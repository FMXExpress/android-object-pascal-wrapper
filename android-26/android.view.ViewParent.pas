...
type
  ...
  JViewParentClass = interface(JObjectClass)
    ['{192E8F3B-B3D2-4479-AD6C-6734365E3B9A}']
    ...
    function invalidateChildInParent(TJavaArrayIntegerparam0 : TJavaArray<Integer>; JRectparam1 : JRect) : JViewParent; deprecated; cdecl;// ([ILandroid/graphics/Rect;)Landroid/view/ViewParent; A: $401
    ...
    function keyboardNavigationClusterSearch(JViewparam0 : JView; Integerparam1 : Integer) : JView; cdecl;// (Landroid/view/View;I)Landroid/view/View; A: $401
    ...
    function onNestedPrePerformAccessibilityAction(JViewparam0 : JView; Integerparam1 : Integer; JBundleparam2 : JBundle) : boolean; cdecl;// (Landroid/view/View;ILandroid/os/Bundle;)Z A: $401
    ...
    function showContextMenuForChild(JViewparam0 : JView) : boolean; cdecl; overload;// (Landroid/view/View;)Z A: $401
    function showContextMenuForChild(JViewparam0 : JView; Singleparam1 : Single; Singleparam2 : Single) : boolean; cdecl; overload;// (Landroid/view/View;FF)Z A: $401
    function startActionModeForChild(JViewparam0 : JView; JActionMode_Callbackparam1 : JActionMode_Callback) : JActionMode; cdecl; overload;// (Landroid/view/View;Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode; A: $401
    function startActionModeForChild(JViewparam0 : JView; JActionMode_Callbackparam1 : JActionMode_Callback; Integerparam2 : Integer) : JActionMode; cdecl; overload;// (Landroid/view/View;Landroid/view/ActionMode$Callback;I)Landroid/view/ActionMode; A: $401
    ...
    procedure invalidateChild(JViewparam0 : JView; JRectparam1 : JRect) ; deprecated; cdecl;// (Landroid/view/View;Landroid/graphics/Rect;)V A: $401
    ...
    procedure onDescendantInvalidated(child : JView; target : JView) ; cdecl;   // (Landroid/view/View;Landroid/view/View;)V A: $1
  ...
  JViewParent = interface(JObject)
    ['{8B8DF51A-0E59-43AB-938E-8FEB59046E7B}']
    function canResolveLayoutDirection : boolean; cdecl;                        // ()Z A: $401
    function canResolveTextAlignment : boolean; cdecl;                          // ()Z A: $401
    function canResolveTextDirection : boolean; cdecl;                          // ()Z A: $401
    function focusSearch(JViewparam0 : JView; Integerparam1 : Integer) : JView; cdecl;// (Landroid/view/View;I)Landroid/view/View; A: $401
