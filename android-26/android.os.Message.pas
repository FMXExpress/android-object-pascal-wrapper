...
type
  ...
  JMessageClass = interface(JObjectClass)
    ['{744A9394-8F27-4761-AE6D-BBADF9B3B4D2}']
    ...
    function _GetsendingUid : Integer; cdecl;                                   //  A: $1
    ...
    function isAsynchronous : boolean; cdecl;                                   // ()Z A: $1
    ...
    procedure _SetsendingUid(Value : Integer) ; cdecl;                          //  A: $1
    ...
    procedure setAsynchronous(async : boolean) ; cdecl;                         // (Z)V A: $1
