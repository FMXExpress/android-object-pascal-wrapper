...
type
  ...
  JSettings_GlobalClass = interface(JObjectClass)
    ['{38705426-AA7A-4147-834E-19E863FB8F59}']
    ...
    function _GetBOOT_COUNT : JString; cdecl;                                   //  A: $19
    function _GetCONTACT_METADATA_SYNC_ENABLED : JString; cdecl;                //  A: $19
    ...
    function _GetDEVICE_NAME : JString; cdecl;                                  //  A: $19
    ...
    property BOOT_COUNT : JString read _GetBOOT_COUNT;                          // Ljava/lang/String; A: $19
    property CONTACT_METADATA_SYNC_ENABLED : JString read _GetCONTACT_METADATA_SYNC_ENABLED;// Ljava/lang/String; A: $19
    ...
    property DEVICE_NAME : JString read _GetDEVICE_NAME;                        // Ljava/lang/String; A: $19
  ...
  JSettings_Global = interface(JObject)
    ['{DB599CBB-CBCA-4EEB-AA4E-FA02985621D7}']
  end;
...
const
  ...
  TJSettings_GlobalBOOT_COUNT = 'boot_count';
  TJSettings_GlobalCONTACT_METADATA_SYNC_ENABLED = 'contact_metadata_sync_enabled';
  ...
  TJSettings_GlobalDEVICE_NAME = 'device_name';
