...
type
  ...
  JArrayDequeClass = interface(JObjectClass)
    ['{D1FAFCCF-5322-4698-BB9E-732FF269AB84}']
    function &contains(obj : JObject) : boolean; cdecl;                         // (Ljava/lang/Object;)Z A: $1
    ...
    function init(minSize : Integer) : JArrayDeque; cdecl; overload;            // (I)V A: $1
    ...
    function remove(obj : JObject) : boolean; cdecl; overload;                  // (Ljava/lang/Object;)Z A: $1
    function removeFirst : JObject; cdecl;                                      // ()Ljava/lang/Object; A: $1
    function removeFirstOccurrence(obj : JObject) : boolean; cdecl;             // (Ljava/lang/Object;)Z A: $1
    function removeLast : JObject; cdecl;                                       // ()Ljava/lang/Object; A: $1
    function removeLastOccurrence(obj : JObject) : boolean; cdecl;              // (Ljava/lang/Object;)Z A: $1
  ...
  JArrayDeque = interface(JObject)
    ['{5FC8967D-CD01-4D26-8148-8EC964D412DC}']
    function &contains(obj : JObject) : boolean; cdecl;                         // (Ljava/lang/Object;)Z A: $1
    function add(e : JObject) : boolean; cdecl;                                 // (Ljava/lang/Object;)Z A: $1
    function clone : JArrayDeque; cdecl;                                        // ()Ljava/util/ArrayDeque; A: $1
    function descendingIterator : JIterator; cdecl;                             // ()Ljava/util/Iterator; A: $1
