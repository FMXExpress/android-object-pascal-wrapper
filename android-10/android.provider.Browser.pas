...
type
  ...
  JBrowserClass = interface(JObjectClass)
    ['{CC3E03E3-125D-49BC-BB05-3F667EF78266}']
    ...
    procedure sendString(c : JContext; s : JString) ; cdecl;                    // (Landroid/content/Context;Ljava/lang/String;)V A: $19
  ...
  JBrowser = interface(JObject)
    ['{93C58C79-7DB4-4DCC-9887-9C491ED9F062}']
  end;
