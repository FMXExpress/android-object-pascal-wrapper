...
type
  ...
  JDebug_MemoryInfoClass = interface(JObjectClass)
    ['{BF8C439C-E791-4CBF-AF22-2963CE12AD41}']
    ...
    function getOtherLabel(which : Integer) : JString; cdecl;                   // (I)Ljava/lang/String; A: $9
    function getOtherPrivateDirty(which : Integer) : Integer; cdecl;            // (I)I A: $1
    function getOtherPss(which : Integer) : Integer; cdecl;                     // (I)I A: $1
    function getOtherSharedDirty(which : Integer) : Integer; cdecl;             // (I)I A: $1
  ...
  JDebug_MemoryInfo = interface(JObject)
    ['{05BA324F-C39F-44F7-9BB7-39FC6C895DE7}']
    function _GetdalvikPrivateDirty : Integer; cdecl;                           //  A: $1
    function _GetdalvikPss : Integer; cdecl;                                    //  A: $1
    function _GetdalvikSharedDirty : Integer; cdecl;                            //  A: $1
    function _GetnativePrivateDirty : Integer; cdecl;                           //  A: $1
