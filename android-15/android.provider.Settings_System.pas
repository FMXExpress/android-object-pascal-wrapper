...
type
  ...
  JSettings_SystemClass = interface(JObjectClass)
    ['{C3D1CC21-A8C1-428E-984D-3FA01D48D57A}']
    ...
    function getShowGTalkServiceStatus(cr : JContentResolver) : boolean; cdecl; // (Landroid/content/ContentResolver;)Z A: $9
    ...
    procedure setShowGTalkServiceStatus(cr : JContentResolver; flag : boolean) ; cdecl;// (Landroid/content/ContentResolver;Z)V A: $9
  ...
  JSettings_System = interface(JObject)
    ['{1E7C2D44-B0AD-46AA-9256-1144D84B5845}']
  end;
