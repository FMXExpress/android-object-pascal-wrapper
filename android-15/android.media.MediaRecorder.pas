...
type
  ...
  JMediaRecorderClass = interface(JObjectClass)
    ['{CFA1A8A7-0594-4E95-86E9-9C9631D054B4}']
    ...
    procedure setAuxiliaryOutputFile(fd : JFileDescriptor) ; deprecated; cdecl; overload;// (Ljava/io/FileDescriptor;)V A: $1
    procedure setAuxiliaryOutputFile(path : JString) ; deprecated; cdecl; overload;// (Ljava/lang/String;)V A: $1
  ...
  JMediaRecorder = interface(JObject)
    ['{782626D3-B9C5-4235-8C1C-1C384ABEB6DF}']
    procedure prepare ; cdecl;                                                  // ()V A: $1
    procedure reset ; cdecl;                                                    // ()V A: $1
    procedure setAudioChannels(numChannels : Integer) ; cdecl;                  // (I)V A: $1
    procedure setAudioEncodingBitRate(bitRate : Integer) ; cdecl;               // (I)V A: $1
