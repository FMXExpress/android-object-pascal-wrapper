...
type
  ...
  JWebViewClass = interface(JObjectClass)
    ['{2EE23FE9-370F-4878-9A14-D7279E5960FE}']
    ...
    function getVisibleTitleHeight : Integer; deprecated; cdecl;                // ()I A: $1
    function getZoomControls : JView; deprecated; cdecl;                        // ()Landroid/view/View; A: $1
    ...
    function restorePicture(b : JBundle; src : JFile) : boolean; deprecated; cdecl;// (Landroid/os/Bundle;Ljava/io/File;)Z A: $1
    ...
    function savePicture(b : JBundle; dest : JFile) : boolean; deprecated; cdecl;// (Landroid/os/Bundle;Ljava/io/File;)Z A: $1
    ...
    procedure debugDump ; deprecated; cdecl;                                    // ()V A: $1
    procedure destroy ; cdecl;                                                  // ()V A: $1
    procedure disablePlatformNotifications ; deprecated; cdecl;                 // ()V A: $9
    procedure documentHasImages(response : JMessage) ; cdecl;                   // (Landroid/os/Message;)V A: $1
    procedure emulateShiftHeld ; deprecated; cdecl;                             // ()V A: $1
    procedure enablePlatformNotifications ; deprecated; cdecl;                  // ()V A: $9
  ...
  JWebView = interface(JObject)
    ['{DCF4823E-2450-4134-A713-51B11F3F9CCE}']
    function canGoBack : boolean; cdecl;                                        // ()Z A: $1
    function canGoBackOrForward(steps : Integer) : boolean; cdecl;              // (I)Z A: $1
    function canGoForward : boolean; cdecl;                                     // ()Z A: $1
    function canZoomIn : boolean; cdecl;                                        // ()Z A: $1
