...
type
  ...
  JResultSetClass = interface(JObjectClass)
    ['{F15C63D0-4C98-48AC-82F5-5D40D6FC7DD3}']
    ...
    function getBigDecimal(JStringparam0 : JString; Integerparam1 : Integer) : JBigDecimal; cdecl; overload;// (Ljava/lang/String;I)Ljava/math/BigDecimal; A: $401
    ...
    function getUnicodeStream(Integerparam0 : Integer) : JInputStream; cdecl; overload;// (I)Ljava/io/InputStream; A: $401
    function getUnicodeStream(JStringparam0 : JString) : JInputStream; cdecl; overload;// (Ljava/lang/String;)Ljava/io/InputStream; A: $401
  ...
  JResultSet = interface(JObject)
    ['{E56D7176-AE97-4BA0-BE54-39CD3F1DE032}']
    function &absolute(Integerparam0 : Integer) : boolean; cdecl;               // (I)Z A: $401
    function findColumn(JStringparam0 : JString) : Integer; cdecl;              // (Ljava/lang/String;)I A: $401
    function first : boolean; cdecl;                                            // ()Z A: $401
    function getArray(Integerparam0 : Integer) : JArray; cdecl; overload;       // (I)Ljava/sql/Array; A: $401
