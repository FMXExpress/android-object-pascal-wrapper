...
type
  ...
  JContacts_ContactMethodsClass = interface(JObjectClass)
    ['{1E6FFD72-B6D1-483E-8164-43DA47742161}']
    ...
    function decodeImProtocol(encodedString : JString) : JObject; cdecl;        // (Ljava/lang/String;)Ljava/lang/Object; A: $9
    function encodeCustomImProtocol(protocolString : JString) : JString; cdecl; // (Ljava/lang/String;)Ljava/lang/String; A: $9
    function encodePredefinedImProtocol(protocol : Integer) : JString; cdecl;   // (I)Ljava/lang/String; A: $9
    function getDisplayLabel(context : JContext; kind : Integer; &type : Integer; &label : JCharSequence) : JCharSequence; cdecl;// (Landroid/content/Context;IILjava/lang/CharSequence;)Ljava/lang/CharSequence; A: $19
    procedure addPostalLocation(context : JContext; postalId : Int64; latitude : Double; longitude : Double) ; cdecl;// (Landroid/content/Context;JDD)V A: $1
  ...
  JContacts_ContactMethods = interface(JObject)
    ['{5F1BA1CA-B0DD-4F92-8C74-DE67F27FCB22}']
    procedure addPostalLocation(context : JContext; postalId : Int64; latitude : Double; longitude : Double) ; cdecl;// (Landroid/content/Context;JDD)V A: $1
  end;
