...
////////////////////////////////////////////////////////////////////////////////
unit android.provider.Contacts_Intents_Insert;
...
type
  JContacts_Intents_Insert = interface;

  JContacts_Intents_InsertClass = interface(JObjectClass)
    ['{D214E26F-AF82-438F-9831-B23C8F8C82E2}']
    ...
    function init : JContacts_Intents_Insert; cdecl;                            // ()V A: $1
  ...
  [JavaSignature('android/provider/Contacts_Intents_Insert')]
  JContacts_Intents_Insert = interface(JObject)
    ['{AB6DF044-34D5-47B6-B6ED-1785019E73F9}']
  end;

  TJContacts_Intents_Insert = class(TJavaGenericImport<JContacts_Intents_InsertClass, JContacts_Intents_Insert>)
  end;

const
  TJContacts_Intents_InsertACTION = 'android.intent.action.INSERT';
  TJContacts_Intents_InsertFULL_MODE = 'full_mode';
  TJContacts_Intents_InsertNAME = 'name';
  TJContacts_Intents_InsertPHONETIC_NAME = 'phonetic_name';
  TJContacts_Intents_InsertCOMPANY = 'company';
  TJContacts_Intents_InsertJOB_TITLE = 'job_title';
  TJContacts_Intents_InsertNOTES = 'notes';
  TJContacts_Intents_InsertPHONE = 'phone';
  TJContacts_Intents_InsertPHONE_TYPE = 'phone_type';
  TJContacts_Intents_InsertPHONE_ISPRIMARY = 'phone_isprimary';
  TJContacts_Intents_InsertSECONDARY_PHONE = 'secondary_phone';
  TJContacts_Intents_InsertSECONDARY_PHONE_TYPE = 'secondary_phone_type';
  TJContacts_Intents_InsertTERTIARY_PHONE = 'tertiary_phone';
  TJContacts_Intents_InsertTERTIARY_PHONE_TYPE = 'tertiary_phone_type';
  TJContacts_Intents_InsertEMAIL = 'email';
  TJContacts_Intents_InsertEMAIL_TYPE = 'email_type';
  TJContacts_Intents_InsertEMAIL_ISPRIMARY = 'email_isprimary';
  TJContacts_Intents_InsertSECONDARY_EMAIL = 'secondary_email';
  TJContacts_Intents_InsertSECONDARY_EMAIL_TYPE = 'secondary_email_type';
  TJContacts_Intents_InsertTERTIARY_EMAIL = 'tertiary_email';
  TJContacts_Intents_InsertTERTIARY_EMAIL_TYPE = 'tertiary_email_type';
  TJContacts_Intents_InsertPOSTAL = 'postal';
  TJContacts_Intents_InsertPOSTAL_TYPE = 'postal_type';
  TJContacts_Intents_InsertPOSTAL_ISPRIMARY = 'postal_isprimary';
  TJContacts_Intents_InsertIM_HANDLE = 'im_handle';
  TJContacts_Intents_InsertIM_PROTOCOL = 'im_protocol';
  TJContacts_Intents_InsertIM_ISPRIMARY = 'im_isprimary';
