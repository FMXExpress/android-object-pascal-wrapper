...
type
  ...
  JWebViewClass = interface(JObjectClass)
    ['{30A175A7-CC25-4AD2-B39A-214BF14714E0}']
    ...
    function canZoomIn : boolean; cdecl;                                        // ()Z A: $1
    function canZoomOut : boolean; cdecl;                                       // ()Z A: $1
    ...
    function getVisibleTitleHeight : Integer; cdecl;                            // ()I A: $1
    ...
    function init(context : JContext; attrs : JAttributeSet; defStyle : Integer; privateBrowsing : boolean) : JWebView; cdecl; overload;// (Landroid/content/Context;Landroid/util/AttributeSet;IZ)V A: $1
    ...
    function showFindDialog(text : JString; showIme : boolean) : boolean; cdecl;// (Ljava/lang/String;Z)Z A: $1
    ...
    procedure removeJavascriptInterface(interfaceName : JString) ; cdecl;       // (Ljava/lang/String;)V A: $1
  ...
  JWebView = interface(JObject)
    ['{5A6A5691-26DD-48EF-84D5-EF50075143C9}']
    function canGoBack : boolean; cdecl;                                        // ()Z A: $1
    function canGoBackOrForward(steps : Integer) : boolean; cdecl;              // (I)Z A: $1
    function canGoForward : boolean; cdecl;                                     // ()Z A: $1
    function canZoomIn : boolean; cdecl;                                        // ()Z A: $1
