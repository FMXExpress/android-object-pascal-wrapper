...
type
  ...
  JDateUtilsClass = interface(JObjectClass)
    ['{15743EB2-FAE1-4C98-AD8C-0EF9B2C2A709}']
    ...
    function getAMPMString(ampm : Integer) : JString; cdecl;                    // (I)Ljava/lang/String; A: $9
    function getDayOfWeekString(dayOfWeek : Integer; abbrev : Integer) : JString; cdecl;// (II)Ljava/lang/String; A: $9
    function getMonthString(month : Integer; abbrev : Integer) : JString; cdecl;// (II)Ljava/lang/String; A: $9
  ...
  JDateUtils = interface(JObject)
    ['{DD326A7B-A353-4D0B-9C54-42E8B1A03F5A}']
  end;
