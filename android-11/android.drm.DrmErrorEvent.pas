...
type
  ...
  JDrmErrorEventClass = interface(JObjectClass)
    ['{E3785119-2DE5-4427-8137-FB538A9495AC}']
    ...
    function init(uniqueId : Integer; &type : Integer; &message : JString) : JDrmErrorEvent; cdecl;// (IILjava/lang/String;)V A: $1
  ...
  JDrmErrorEvent = interface(JObject)
    ['{E0907ED5-5C58-4D08-8B35-1815A5EDEFB6}']
  end;
