...
type
  ...
  JCursorWindowClass = interface(JObjectClass)
    ['{FCE1CF45-276E-4C02-9B02-D64E2A23AE87}']
    ...
    function isBlob(row : Integer; column : Integer) : boolean; cdecl;          // (II)Z A: $1
    function isFloat(row : Integer; column : Integer) : boolean; cdecl;         // (II)Z A: $1
    function isLong(row : Integer; column : Integer) : boolean; cdecl;          // (II)Z A: $1
    function isNull(row : Integer; column : Integer) : boolean; cdecl;          // (II)Z A: $1
    function isString(row : Integer; column : Integer) : boolean; cdecl;        // (II)Z A: $1
  ...
  JCursorWindow = interface(JObject)
    ['{BC2F8284-7520-45C2-A7A7-E28BA7896D40}']
    function allocRow : boolean; cdecl;                                         // ()Z A: $1
    function describeContents : Integer; cdecl;                                 // ()I A: $1
    function getBlob(row : Integer; column : Integer) : TJavaArray<Byte>; cdecl;// (II)[B A: $1
    function getDouble(row : Integer; column : Integer) : Double; cdecl;        // (II)D A: $1
