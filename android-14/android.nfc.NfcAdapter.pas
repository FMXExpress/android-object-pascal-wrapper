...
type
  ...
  JNfcAdapterClass = interface(JObjectClass)
    ['{46400EB2-A17E-4260-926A-246FE0DC6058}']
    ...
    procedure enableForegroundNdefPush(activity : JActivity; &message : JNdefMessage) ; cdecl;// (Landroid/app/Activity;Landroid/nfc/NdefMessage;)V A: $1
