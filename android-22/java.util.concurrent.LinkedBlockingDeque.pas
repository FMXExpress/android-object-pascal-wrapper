...
////////////////////////////////////////////////////////////////////////////////
unit java.util.concurrent.LinkedBlockingDeque;
...
type
  JLinkedBlockingDeque = interface;

  JLinkedBlockingDequeClass = interface(JObjectClass)
    ['{692B6EB0-E865-498F-8C84-F42F1BE4F42E}']
    ...
    function init : JLinkedBlockingDeque; cdecl; overload;                      // ()V A: $1
    function init(c : JCollection) : JLinkedBlockingDeque; cdecl; overload;     // (Ljava/util/Collection;)V A: $1
    function init(capacity : Integer) : JLinkedBlockingDeque; cdecl; overload;  // (I)V A: $1
    ...
    function offerFirst(e : JObject) : boolean; cdecl; overload;                // (Ljava/lang/Object;)Z A: $1
    function offerFirst(e : JObject; timeout : Int64; &unit : JTimeUnit) : boolean; cdecl; overload;// (Ljava/lang/Object;JLjava/util/concurrent/TimeUnit;)Z A: $1
    function offerLast(e : JObject) : boolean; cdecl; overload;                 // (Ljava/lang/Object;)Z A: $1
    function offerLast(e : JObject; timeout : Int64; &unit : JTimeUnit) : boolean; cdecl; overload;// (Ljava/lang/Object;JLjava/util/concurrent/TimeUnit;)Z A: $1
    ...
    function pollFirst : JObject; cdecl; overload;                              // ()Ljava/lang/Object; A: $1
    function pollFirst(timeout : Int64; &unit : JTimeUnit) : JObject; cdecl; overload;// (JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object; A: $1
    function pollLast : JObject; cdecl; overload;                               // ()Ljava/lang/Object; A: $1
    function pollLast(timeout : Int64; &unit : JTimeUnit) : JObject; cdecl; overload;// (JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object; A: $1
    ...
    function takeFirst : JObject; cdecl;                                        // ()Ljava/lang/Object; A: $1
    function takeLast : JObject; cdecl;                                         // ()Ljava/lang/Object; A: $1
    ...
    procedure putFirst(e : JObject) ; cdecl;                                    // (Ljava/lang/Object;)V A: $1
    procedure putLast(e : JObject) ; cdecl;                                     // (Ljava/lang/Object;)V A: $1
  end;

  [JavaSignature('java/util/concurrent/LinkedBlockingDeque')]
  JLinkedBlockingDeque = interface(JObject)
    ['{79417E76-9A96-4A5F-8352-4FE1B69D5746}']
    function &contains(o : JObject) : boolean; cdecl;                           // (Ljava/lang/Object;)Z A: $1
    function add(e : JObject) : boolean; cdecl;                                 // (Ljava/lang/Object;)Z A: $1
    function descendingIterator : JIterator; cdecl;                             // ()Ljava/util/Iterator; A: $1
    function drainTo(c : JCollection) : Integer; cdecl; overload;               // (Ljava/util/Collection;)I A: $1
  ...
  TJLinkedBlockingDeque = class(TJavaGenericImport<JLinkedBlockingDequeClass, JLinkedBlockingDeque>)
  end;
