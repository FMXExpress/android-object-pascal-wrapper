...
type
  ...
  JDevicePolicyManagerClass = interface(JObjectClass)
    ['{B9410854-E463-4F19-AEDB-F2CB6C3F648B}']
    ...
    function createAndInitializeUser(admin : JComponentName; &name : JString; ownerName : JString; profileOwnerComponent : JComponentName; adminExtras : JBundle) : JUserHandle; cdecl;// (Landroid/content/ComponentName;Ljava/lang/String;Ljava/lang/String;Landroid/content/ComponentName;Landroid/os/Bundle;)Landroid/os/UserHandle; A: $1
    function createUser(admin : JComponentName; &name : JString) : JUserHandle; cdecl;// (Landroid/content/ComponentName;Ljava/lang/String;)Landroid/os/UserHandle; A: $1
    ...
    function getCrossProfileCallerIdDisabled(who : JComponentName) : boolean; cdecl;// (Landroid/content/ComponentName;)Z A: $1
    ...
    function installKeyPair(who : JComponentName; privKey : JPrivateKey; cert : JCertificate; alias : JString) : boolean; cdecl;// (Landroid/content/ComponentName;Ljava/security/PrivateKey;Ljava/security/cert/Certificate;Ljava/lang/String;)Z A: $1
    ...
    procedure setCrossProfileCallerIdDisabled(who : JComponentName; disabled : boolean) ; cdecl;// (Landroid/content/ComponentName;Z)V A: $1
    ...
    procedure setProfileName(who : JComponentName; profileName : JString) ; cdecl;// (Landroid/content/ComponentName;Ljava/lang/String;)V A: $1
  ...
  JDevicePolicyManager = interface(JObject)
    ['{0618B22E-94F4-41A6-BD5B-32B3CA25F91B}']
    function addCrossProfileWidgetProvider(admin : JComponentName; packageName : JString) : boolean; cdecl;// (Landroid/content/ComponentName;Ljava/lang/String;)Z A: $1
    function createAndInitializeUser(admin : JComponentName; &name : JString; ownerName : JString; profileOwnerComponent : JComponentName; adminExtras : JBundle) : JUserHandle; cdecl;// (Landroid/content/ComponentName;Ljava/lang/String;Ljava/lang/String;Landroid/content/ComponentName;Landroid/os/Bundle;)Landroid/os/UserHandle; A: $1
    function createUser(admin : JComponentName; &name : JString) : JUserHandle; cdecl;// (Landroid/content/ComponentName;Ljava/lang/String;)Landroid/os/UserHandle; A: $1
    function enableSystemApp(admin : JComponentName; intent : JIntent) : Integer; cdecl; overload;// (Landroid/content/ComponentName;Landroid/content/Intent;)I A: $1
