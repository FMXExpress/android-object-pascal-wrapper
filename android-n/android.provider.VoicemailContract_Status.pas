...
type
  ...
  JVoicemailContract_StatusClass = interface(JObjectClass)
    ['{B90B06B7-114A-45F5-B0C4-F311E01828C0}']
    ...
    procedure setQuota(context : JContext; accountHandle : JPhoneAccountHandle; occupied : Integer; total : Integer) ; cdecl;// (Landroid/content/Context;Landroid/telecom/PhoneAccountHandle;II)V A: $9
  ...
  JVoicemailContract_Status = interface(JObject)
    ['{EA932E95-9022-4E37-86E1-6F1C95FEC367}']
  end;
