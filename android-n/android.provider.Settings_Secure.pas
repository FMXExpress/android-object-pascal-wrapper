...
type
  ...
  JSettings_SecureClass = interface(JObjectClass)
    ['{2C9A46A3-BA3B-4BA5-BEB3-CADD8906AFB6}']
    ...
    function _GetENABLED_NOTIFICATION_POLICY_ACCESS_PACKAGES : JString; cdecl;  //  A: $19
    ...
    property ENABLED_NOTIFICATION_POLICY_ACCESS_PACKAGES : JString read _GetENABLED_NOTIFICATION_POLICY_ACCESS_PACKAGES;// Ljava/lang/String; A: $19
  ...
  JSettings_Secure = interface(JObject)
    ['{6C655C36-EEFD-4F02-89F5-505839E8E836}']
  end;
...
const
  ...
  TJSettings_SecureENABLED_NOTIFICATION_POLICY_ACCESS_PACKAGES = 'enabled_notification_policy_access_packages';
