...
type
  ...
  JClipDescriptionClass = interface(JObjectClass)
    ['{82D6067A-7C72-4642-ADF6-E596C4CD52FE}']
    function _GetCREATOR : JParcelable_Creator; cdecl;                          //  A: $19
    function _GetEXTRA_TARGET_COMPONENT_NAME : JString; cdecl;                  //  A: $19
    function _GetEXTRA_USER_SERIAL_NUMBER : JString; cdecl;                     //  A: $19
    ...
    property EXTRA_TARGET_COMPONENT_NAME : JString read _GetEXTRA_TARGET_COMPONENT_NAME;// Ljava/lang/String; A: $19
    property EXTRA_USER_SERIAL_NUMBER : JString read _GetEXTRA_USER_SERIAL_NUMBER;// Ljava/lang/String; A: $19
  ...
  JClipDescription = interface(JObject)
    ['{62EEF09A-A488-40D8-AF7C-FE74BB71ADF6}']
    function describeContents : Integer; cdecl;                                 // ()I A: $1
    function filterMimeTypes(mimeType : JString) : TJavaArray<JString>; cdecl;  // (Ljava/lang/String;)[Ljava/lang/String; A: $1
    function getExtras : JPersistableBundle; cdecl;                             // ()Landroid/os/PersistableBundle; A: $1
    function getLabel : JCharSequence; cdecl;                                   // ()Ljava/lang/CharSequence; A: $1
...
const
  TJClipDescriptionEXTRA_TARGET_COMPONENT_NAME = 'android.content.extra.TARGET_COMPONENT_NAME';
  TJClipDescriptionEXTRA_USER_SERIAL_NUMBER = 'android.content.extra.USER_SERIAL_NUMBER';
