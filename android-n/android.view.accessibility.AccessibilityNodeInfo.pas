...
type
  ...
  JAccessibilityNodeInfoClass = interface(JObjectClass)
    ['{9E1D7F3D-E597-4F0D-89F9-236A90D0F872}']
    function _GetACTION_ACCESSIBILITY_FOCUS : Integer; cdecl;                   //  A: $19
    function _GetACTION_ARGUMENT_CLICK_CHARACTER_INDEX_INT : JString; cdecl;    //  A: $19
    function _GetACTION_ARGUMENT_CLICK_SPAN_INDEX_INT : JString; cdecl;         //  A: $19
    ...
    property ACTION_ARGUMENT_CLICK_CHARACTER_INDEX_INT : JString read _GetACTION_ARGUMENT_CLICK_CHARACTER_INDEX_INT;// Ljava/lang/String; A: $19
    property ACTION_ARGUMENT_CLICK_SPAN_INDEX_INT : JString read _GetACTION_ARGUMENT_CLICK_SPAN_INDEX_INT;// Ljava/lang/String; A: $19
  ...
  JAccessibilityNodeInfo = interface(JObject)
    ['{0E3C8788-B0DF-4722-BAD4-B20894A07AD3}']
    function canOpenPopup : boolean; cdecl;                                     // ()Z A: $1
    function describeContents : Integer; cdecl;                                 // ()I A: $1
    function equals(&object : JObject) : boolean; cdecl;                        // (Ljava/lang/Object;)Z A: $1
    function findAccessibilityNodeInfosByText(text : JString) : JList; cdecl;   // (Ljava/lang/String;)Ljava/util/List; A: $1
  ...
  // Merged from: c:\users\anonymous\documents\rad studio\java2pas\android-n\android.view.accessibility.AccessibilityWindowInfo.pas
  JAccessibilityWindowInfoClass = interface(JObjectClass)
    ['{F96EAE06-0E32-45F4-B396-F85BF6A7320D}']
    function _GetCREATOR : JParcelable_Creator; cdecl;                          //  A: $19
  ...
  JAccessibilityWindowInfo = interface(JObject)
    ['{B6C94735-0DE4-48E1-AEE2-01923E3DE56C}']
    function describeContents : Integer; cdecl;                                 // ()I A: $1
    function equals(obj : JObject) : boolean; cdecl;                            // (Ljava/lang/Object;)Z A: $1
    function getChild(&index : Integer) : JAccessibilityWindowInfo; cdecl;      // (I)Landroid/view/accessibility/AccessibilityWindowInfo; A: $1
    function getChildCount : Integer; cdecl;                                    // ()I A: $1
...
const
  ...
  TJAccessibilityNodeInfoACTION_ARGUMENT_CLICK_CHARACTER_INDEX_INT = 'android.view.accessibility.action.ARGUMENT_CLICK_CHARACTER_INDEX_INT';
  TJAccessibilityNodeInfoACTION_ARGUMENT_CLICK_SPAN_INDEX_INT = 'android.view.accessibility.action.ARGUMENT_CLICK_SPAN_INDEX_INT';
