...
type
  ...
  JParcelClass = interface(JObjectClass)
    ['{5633F50B-D1FB-4516-97B2-959BE580270C}']
    ...
    function readPersistableBundle : JPersistableBundle; cdecl; overload;       // ()Landroid/os/PersistableBundle; A: $11
    function readPersistableBundle(loader : JClassLoader) : JPersistableBundle; cdecl; overload;// (Ljava/lang/ClassLoader;)Landroid/os/PersistableBundle; A: $11
    function readSerializable : JSerializable; cdecl;                           // ()Ljava/io/Serializable; A: $11
    function readSize : JSize; cdecl;                                           // ()Landroid/util/Size; A: $11
    function readSizeF : JSizeF; cdecl;                                         // ()Landroid/util/SizeF; A: $11
    ...
    function readTypedObject(c : JParcelable_Creator) : JObject; cdecl;         // (Landroid/os/Parcelable$Creator;)Ljava/lang/Object; A: $11
    ...
    procedure unmarshall(data : TJavaArray<Byte>; offset : Integer; length : Integer) ; cdecl;// ([BII)V A: $11
    ...
    procedure writePersistableBundle(val : JPersistableBundle) ; cdecl;         // (Landroid/os/PersistableBundle;)V A: $11
    procedure writeSerializable(s : JSerializable) ; cdecl;                     // (Ljava/io/Serializable;)V A: $11
    procedure writeSize(val : JSize) ; cdecl;                                   // (Landroid/util/Size;)V A: $11
    procedure writeSizeF(val : JSizeF) ; cdecl;                                 // (Landroid/util/SizeF;)V A: $11
    ...
    procedure writeTypedObject(val : JParcelable; parcelableFlags : Integer) ; cdecl;// (Landroid/os/Parcelable;I)V A: $11
  ...
  JParcel = interface(JObject)
    ['{B4F1E298-ACFB-4F2B-8005-3D46171B5381}']
  end;
