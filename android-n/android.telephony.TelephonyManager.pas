...
type
  ...
  JTelephonyManagerClass = interface(JObjectClass)
    ['{086DF173-590B-4BF2-B22B-DD42BBC1DD2A}']
    ...
    function getCallState : Integer; cdecl; overload;                           // ()I A: $1
    function getCallState(subId : Integer) : Integer; cdecl; overload;          // (I)I A: $1
    ...
    function getDataNetworkType(subId : Integer) : Integer; cdecl;              // (I)I A: $1
    ...
    function getGroupIdLevel1 : JString; cdecl; overload;                       // ()Ljava/lang/String; A: $1
    function getGroupIdLevel1(subId : Integer) : JString; cdecl; overload;      // (I)Ljava/lang/String; A: $1
    function getIccSimChallengeResponse(appType : Integer; data : JString) : JString; cdecl;// (ILjava/lang/String;)Ljava/lang/String; A: $1
    function getLine1AlphaTag(subId : Integer) : JString; cdecl;                // (I)Ljava/lang/String; A: $1
    function getLine1Number : JString; cdecl; overload;                         // ()Ljava/lang/String; A: $1
    function getLine1Number(subId : Integer) : JString; cdecl; overload;        // (I)Ljava/lang/String; A: $1
    ...
    function getNetworkCountryIso : JString; cdecl; overload;                   // ()Ljava/lang/String; A: $1
    function getNetworkCountryIso(subId : Integer) : JString; cdecl; overload;  // (I)Ljava/lang/String; A: $1
    function getNetworkOperator : JString; cdecl; overload;                     // ()Ljava/lang/String; A: $1
    function getNetworkOperator(subId : Integer) : JString; cdecl; overload;    // (I)Ljava/lang/String; A: $1
    function getNetworkOperatorName : JString; cdecl; overload;                 // ()Ljava/lang/String; A: $1
    function getNetworkOperatorName(subId : Integer) : JString; cdecl; overload;// (I)Ljava/lang/String; A: $1
    function getNetworkType : Integer; cdecl; overload;                         // ()I A: $1
    function getNetworkType(subId : Integer) : Integer; cdecl; overload;        // (I)I A: $1
    function getPhoneCount : Integer; cdecl;                                    // ()I A: $1
    function getPhoneType : Integer; cdecl;                                     // ()I A: $1
    function getSimCountryIso : JString; cdecl; overload;                       // ()Ljava/lang/String; A: $1
    function getSimCountryIso(subId : Integer) : JString; cdecl; overload;      // (I)Ljava/lang/String; A: $1
    function getSimOperator : JString; cdecl; overload;                         // ()Ljava/lang/String; A: $1
    function getSimOperator(subId : Integer) : JString; cdecl; overload;        // (I)Ljava/lang/String; A: $1
    function getSimOperatorName : JString; cdecl; overload;                     // ()Ljava/lang/String; A: $1
    function getSimOperatorName(subId : Integer) : JString; cdecl; overload;    // (I)Ljava/lang/String; A: $1
    function getSimSerialNumber : JString; cdecl; overload;                     // ()Ljava/lang/String; A: $1
    function getSimSerialNumber(subId : Integer) : JString; cdecl; overload;    // (I)Ljava/lang/String; A: $1
    function getSimState : Integer; cdecl;                                      // ()I A: $1
    function getSubscriberId : JString; cdecl; overload;                        // ()Ljava/lang/String; A: $1
    function getSubscriberId(subId : Integer) : JString; cdecl; overload;       // (I)Ljava/lang/String; A: $1
    function getVoiceMailAlphaTag : JString; cdecl; overload;                   // ()Ljava/lang/String; A: $1
    function getVoiceMailAlphaTag(subId : Integer) : JString; cdecl; overload;  // (I)Ljava/lang/String; A: $1
    function getVoiceMailNumber : JString; cdecl; overload;                     // ()Ljava/lang/String; A: $1
    function getVoiceMailNumber(subId : Integer) : JString; cdecl; overload;    // (I)Ljava/lang/String; A: $1
    function getVoiceNetworkType(subId : Integer) : Integer; cdecl;             // (I)I A: $1
    ...
    function hasCarrierPrivileges : boolean; cdecl; overload;                   // ()Z A: $1
    function hasCarrierPrivileges(subId : Integer) : boolean; cdecl; overload;  // (I)Z A: $1
    function hasIccCard : boolean; cdecl;                                       // ()Z A: $1
    function iccCloseLogicalChannel(channel : Integer) : boolean; cdecl; overload;// (I)Z A: $1
    function iccCloseLogicalChannel(subId : Integer; channel : Integer) : boolean; cdecl; overload;// (II)Z A: $1
    function iccExchangeSimIO(fileID : Integer; command : Integer; p1 : Integer; p2 : Integer; p3 : Integer; filePath : JString) : TJavaArray<Byte>; cdecl; overload;// (IIIIILjava/lang/String;)[B A: $1
    function iccExchangeSimIO(subId : Integer; fileID : Integer; command : Integer; p1 : Integer; p2 : Integer; p3 : Integer; filePath : JString) : TJavaArray<Byte>; cdecl; overload;// (IIIIIILjava/lang/String;)[B A: $1
    function iccOpenLogicalChannel(AID : JString) : JIccOpenLogicalChannelResponse; cdecl; overload;// (Ljava/lang/String;)Landroid/telephony/IccOpenLogicalChannelResponse; A: $1
    function iccOpenLogicalChannel(subId : Integer; AID : JString) : JIccOpenLogicalChannelResponse; cdecl; overload;// (ILjava/lang/String;)Landroid/telephony/IccOpenLogicalChannelResponse; A: $1
    function iccTransmitApduBasicChannel(cla : Integer; instruction : Integer; p1 : Integer; p2 : Integer; p3 : Integer; data : JString) : JString; cdecl; overload;// (IIIIILjava/lang/String;)Ljava/lang/String; A: $1
    function iccTransmitApduBasicChannel(subId : Integer; cla : Integer; instruction : Integer; p1 : Integer; p2 : Integer; p3 : Integer; data : JString) : JString; cdecl; overload;// (IIIIIILjava/lang/String;)Ljava/lang/String; A: $1
    function iccTransmitApduLogicalChannel(channel : Integer; cla : Integer; instruction : Integer; p1 : Integer; p2 : Integer; p3 : Integer; data : JString) : JString; cdecl; overload;// (IIIIIILjava/lang/String;)Ljava/lang/String; A: $1
    function iccTransmitApduLogicalChannel(subId : Integer; channel : Integer; cla : Integer; instruction : Integer; p1 : Integer; p2 : Integer; p3 : Integer; data : JString) : JString; cdecl; overload;// (IIIIIIILjava/lang/String;)Ljava/lang/String; A: $1
    function isHearingAidCompatibilitySupported : boolean; cdecl;               // ()Z A: $1
    function isNetworkRoaming : boolean; cdecl; overload;                       // ()Z A: $1
    function isNetworkRoaming(subId : Integer) : boolean; cdecl; overload;      // (I)Z A: $1
    ...
    function sendEnvelopeWithStatus(content : JString) : JString; cdecl; overload;// (Ljava/lang/String;)Ljava/lang/String; A: $1
    function sendEnvelopeWithStatus(subId : Integer; content : JString) : JString; cdecl; overload;// (ILjava/lang/String;)Ljava/lang/String; A: $1
    function setLine1NumberForDisplay(alphaTag : JString; number : JString) : boolean; cdecl; overload;// (Ljava/lang/String;Ljava/lang/String;)Z A: $1
    function setLine1NumberForDisplay(subId : Integer; alphaTag : JString; number : JString) : boolean; cdecl; overload;// (ILjava/lang/String;Ljava/lang/String;)Z A: $1
    function setOperatorBrandOverride(brand : JString) : boolean; cdecl; overload;// (Ljava/lang/String;)Z A: $1
    function setOperatorBrandOverride(subId : Integer; brand : JString) : boolean; cdecl; overload;// (ILjava/lang/String;)Z A: $1
    function setPreferredNetworkTypeToGlobal : boolean; cdecl; overload;        // ()Z A: $1
    function setPreferredNetworkTypeToGlobal(subId : Integer) : boolean; cdecl; overload;// (I)Z A: $1
    function setVoiceMailNumber(alphaTag : JString; number : JString) : boolean; cdecl; overload;// (Ljava/lang/String;Ljava/lang/String;)Z A: $1
    function setVoiceMailNumber(subId : Integer; alphaTag : JString; number : JString) : boolean; cdecl; overload;// (ILjava/lang/String;Ljava/lang/String;)Z A: $1
  ...
  JTelephonyManager = interface(JObject)
    ['{3084A66E-4639-49D1-B5BA-DE62E9C4D775}']
    function canChangeDtmfToneLength : boolean; cdecl;                          // ()Z A: $1
    function getAllCellInfo : JList; cdecl;                                     // ()Ljava/util/List; A: $1
    function getCallState : Integer; cdecl; overload;                           // ()I A: $1
    function getCallState(subId : Integer) : Integer; cdecl; overload;          // (I)I A: $1
