...
uses
  ...
  java.awt.font.NumericShaper_Range;

type
  JNumericShaper = interface;

  JNumericShaperClass = interface(JObjectClass)
    ['{060E858E-18DE-4AB0-8B45-A7558EDDDE38}']
    ...
    function getContextualShaper(ranges : JSet) : JNumericShaper; cdecl; overload;// (Ljava/util/Set;)Ljava/awt/font/NumericShaper; A: $9
    function getContextualShaper(ranges : JSet; defaultContext : JNumericShaper_Range) : JNumericShaper; cdecl; overload;// (Ljava/util/Set;Ljava/awt/font/NumericShaper$Range;)Ljava/awt/font/NumericShaper; A: $9
    function getRangeSet : JSet; cdecl;                                         // ()Ljava/util/Set; A: $1
    function getRanges : Integer; cdecl;                                        // ()I A: $1
    function getShaper(singleRange : Integer) : JNumericShaper; cdecl; overload;// (I)Ljava/awt/font/NumericShaper; A: $9
    function getShaper(singleRange : JNumericShaper_Range) : JNumericShaper; cdecl; overload;// (Ljava/awt/font/NumericShaper$Range;)Ljava/awt/font/NumericShaper; A: $9
    ...
    procedure shape(text : TJavaArray<Char>; start : Integer; count : Integer; context : JNumericShaper_Range) ; cdecl; overload;// ([CIILjava/awt/font/NumericShaper$Range;)V A: $1
  ...
  [JavaSignature('java/awt/font/NumericShaper$Range')]
  JNumericShaper = interface(JObject)
    ['{8CC175DB-FE7A-4B21-94D1-42A3DE06B5C8}']
    function equals(o : JObject) : boolean; cdecl;                              // (Ljava/lang/Object;)Z A: $1
    function getRangeSet : JSet; cdecl;                                         // ()Ljava/util/Set; A: $1
    function getRanges : Integer; cdecl;                                        // ()I A: $1
    function hashCode : Integer; cdecl;                                         // ()I A: $1
