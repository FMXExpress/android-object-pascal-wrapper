...
type
  ...
  JContactsContract_Intents_InsertClass = interface(JObjectClass)
    ['{403CB3A9-7FBA-4A78-862B-C943DB3881A3}']
    ...
    function _GetEXTRA_ACCOUNT : JString; cdecl;                                //  A: $19
    function _GetEXTRA_DATA_SET : JString; cdecl;                               //  A: $19
    ...
    property EXTRA_ACCOUNT : JString read _GetEXTRA_ACCOUNT;                    // Ljava/lang/String; A: $19
    property EXTRA_DATA_SET : JString read _GetEXTRA_DATA_SET;                  // Ljava/lang/String; A: $19
  ...
  JContactsContract_Intents_Insert = interface(JObject)
    ['{B6CC8678-B1BC-43E7-AF6F-2B303CDE91E7}']
  end;
...
const
  ...
  TJContactsContract_Intents_InsertEXTRA_ACCOUNT = 'android.provider.extra.ACCOUNT';
  TJContactsContract_Intents_InsertEXTRA_DATA_SET = 'android.provider.extra.DATA_SET';
