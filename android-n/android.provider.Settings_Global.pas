...
type
  ...
  JSettings_GlobalClass = interface(JObjectClass)
    ['{6A3078EB-F874-41D4-9246-89F9B081981C}']
    ...
    function _GetCONTACT_METADATA_SYNC : JString; cdecl;                        //  A: $19
    ...
    property CONTACT_METADATA_SYNC : JString read _GetCONTACT_METADATA_SYNC;    // Ljava/lang/String; A: $19
  ...
  JSettings_Global = interface(JObject)
    ['{B780D1AF-AB34-4EE0-89EB-198E3E769422}']
  end;
...
const
  ...
  TJSettings_GlobalCONTACT_METADATA_SYNC = 'contact_metadata_sync';
