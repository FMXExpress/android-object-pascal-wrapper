...
type
  ...
  JUCharacterEnums_ECharacterCategoryClass = interface(JObjectClass)
    ['{FAEAEEB3-ACFC-45E8-B09A-FF12C129C7BD}']
    function _GetCHAR_CATEGORY_COUNT : Byte; cdecl;                             //  A: $19
    ...
    property CHAR_CATEGORY_COUNT : Byte read _GetCHAR_CATEGORY_COUNT;           // B A: $19
  ...
  JUCharacterEnums_ECharacterCategory = interface(JObject)
    ['{A95DA5ED-40B8-49D5-ABD6-4E80F2243246}']
  end;
...
const
  TJUCharacterEnums_ECharacterCategoryCHAR_CATEGORY_COUNT = 30;
