...
uses
  ...
  Androidapi.JNI.os,
  android.hardware.SensorManager_DynamicSensorConnectionCallback,
...
type
  ...
  JSensorManagerClass = interface(JObjectClass)
    ['{B5FDEB3D-C423-4F7B-B4F9-598C8F7D6244}']
    ...
    procedure registerDynamicSensorCallback(callback : JSensorManager_DynamicSensorConnectionCallback) ; cdecl; overload;// (Landroid/hardware/SensorManager$DynamicSensorConnectionCallback;)V A: $1
    procedure registerDynamicSensorCallback(callback : JSensorManager_DynamicSensorConnectionCallback; handler : JHandler) ; cdecl; overload;// (Landroid/hardware/SensorManager$DynamicSensorConnectionCallback;Landroid/os/Handler;)V A: $1
    procedure unregisterDynamicSensorCallback(callback : JSensorManager_DynamicSensorConnectionCallback) ; cdecl;// (Landroid/hardware/SensorManager$DynamicSensorConnectionCallback;)V A: $1
  ...
  [JavaSignature('android/hardware/SensorManager$DynamicSensorConnectionCallback')]
  JSensorManager = interface(JObject)
    ['{F58374D6-89E5-44E2-BEE1-CD738A643849}']
    function cancelTriggerSensor(listener : JTriggerEventListener; sensor : JSensor) : boolean; cdecl;// (Landroid/hardware/TriggerEventListener;Landroid/hardware/Sensor;)Z A: $1
    function flush(listener : JSensorEventListener) : boolean; cdecl;           // (Landroid/hardware/SensorEventListener;)Z A: $1
    function getDefaultSensor(&type : Integer) : JSensor; cdecl; overload;      // (I)Landroid/hardware/Sensor; A: $1
    function getDefaultSensor(&type : Integer; wakeUp : boolean) : JSensor; cdecl; overload;// (IZ)Landroid/hardware/Sensor; A: $1
