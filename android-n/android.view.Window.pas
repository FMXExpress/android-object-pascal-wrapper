...
type
  JWindow_FrameMetricsListener = interface; // merged
  JWindow = interface;

  JWindowClass = interface(JObjectClass)
    ['{4D316AD1-897C-456D-972D-7030FC0D903F}']
    ...
    procedure addFrameMetricsListener(listener : JWindow_FrameMetricsListener; handler : JHandler) ; cdecl;// (Landroid/view/Window$FrameMetricsListener;Landroid/os/Handler;)V A: $11
    ...
    procedure removeFrameMetricsListener(listener : JWindow_FrameMetricsListener) ; cdecl;// (Landroid/view/Window$FrameMetricsListener;)V A: $11
  ...
  [JavaSignature('android/view/Window$FrameMetricsListener')]
  JWindow = interface(JObject)
    ['{C255710C-BC16-4BDC-BFF4-0F00B5509F8D}']
    function findViewById(id : Integer) : JView; cdecl;                         // (I)Landroid/view/View; A: $1
    function getAllowEnterTransitionOverlap : boolean; cdecl;                   // ()Z A: $1
    function getAllowReturnTransitionOverlap : boolean; cdecl;                  // ()Z A: $1
    function getContentScene : JScene; cdecl;                                   // ()Landroid/transition/Scene; A: $1
  ...
  // Merged from: c:\users\anonymous\documents\rad studio\java2pas\android-n\android.view.Window_FrameMetricsListener.pas
  JWindow_FrameMetricsListenerClass = interface(JObjectClass)
    ['{F53C3034-148E-433B-8FBE-CABE77A91183}']
    procedure onMetricsAvailable(JWindowparam0 : JWindow; JFrameMetricsparam1 : JFrameMetrics; Integerparam2 : Integer) ; cdecl;// (Landroid/view/Window;Landroid/view/FrameMetrics;I)V A: $401
  end;

  [JavaSignature('android/view/Window_FrameMetricsListener')]
  JWindow_FrameMetricsListener = interface(JObject)
    ['{B6AA85A4-C926-4DE5-9BF9-19DEE74DCC15}']
    procedure onMetricsAvailable(JWindowparam0 : JWindow; JFrameMetricsparam1 : JFrameMetrics; Integerparam2 : Integer) ; cdecl;// (Landroid/view/Window;Landroid/view/FrameMetrics;I)V A: $401
  end;

  TJWindow_FrameMetricsListener = class(TJavaGenericImport<JWindow_FrameMetricsListenerClass, JWindow_FrameMetricsListener>)
  end;
