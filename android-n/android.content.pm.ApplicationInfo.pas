...
type
  ...
  JApplicationInfoClass = interface(JObjectClass)
    ['{5C307FB6-DA18-420B-85B9-BB8C2334F2DF}']
    ...
    function _GetminSdkVersion : JString; cdecl;                                //  A: $1
    ...
    procedure _SetminSdkVersion(Value : JString) ; cdecl;                       //  A: $1
    ...
    property minSdkVersion : JString read _GetminSdkVersion write _SetminSdkVersion;// Ljava/lang/String; A: $1
  ...
  JApplicationInfo = interface(JObject)
    ['{AAB40CF8-45A3-4574-BEE0-96EBFCEC576B}']
    function _GetbackupAgentName : JString; cdecl;                              //  A: $1
    function _GetclassName : JString; cdecl;                                    //  A: $1
    function _GetcompatibleWidthLimitDp : Integer; cdecl;                       //  A: $1
    function _GetdataDir : JString; cdecl;                                      //  A: $1
