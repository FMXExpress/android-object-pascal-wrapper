...
type
  ...
  JDeflaterClass = interface(JObjectClass)
    ['{18CC574B-F7EE-4592-AF20-22EBC86ED113}']
    ...
    function deflate(buf : TJavaArray<Byte>; off : Integer; nbytes : Integer) : Integer; cdecl; overload;// ([BII)I A: $21
    ...
    procedure setDictionary(buf : TJavaArray<Byte>) ; cdecl; overload;          // ([B)V A: $1
  ...
  JDeflater = interface(JObject)
    ['{578A24C2-17CA-4D41-8349-065776E089CD}']
    function deflate(buf : TJavaArray<Byte>) : Integer; cdecl; overload;        // ([B)I A: $1
    procedure setDictionary(buf : TJavaArray<Byte>) ; cdecl; overload;          // ([B)V A: $1
    procedure setInput(buf : TJavaArray<Byte>) ; cdecl; overload;               // ([B)V A: $1
  end;
