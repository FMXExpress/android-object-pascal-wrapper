...
type
  ...
  JGradientDrawable_OrientationClass = interface(JObjectClass)
    ['{471A1C75-5BCB-4037-B2AE-61B334653DDA}']
    ...
    function values : TJavaArray<JGradientDrawable_Orientation>; cdecl;         // ()[Landroid/graphics/drawable/GradientDrawable$Orientation; A: $19
  ...
  JGradientDrawable_Orientation = interface(JObject)
    ['{28D34093-45D0-4707-BFD1-9986BA63C7E5}']
  end;
