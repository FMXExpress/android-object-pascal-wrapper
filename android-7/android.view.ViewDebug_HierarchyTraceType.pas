...
type
  ...
  JViewDebug_HierarchyTraceTypeClass = interface(JObjectClass)
    ['{8A66C121-1FB0-49AB-9934-214E3C2E0D7B}']
    ...
    function values : TJavaArray<JViewDebug_HierarchyTraceType>; cdecl;         // ()[Landroid/view/ViewDebug$HierarchyTraceType; A: $19
  ...
  JViewDebug_HierarchyTraceType = interface(JObject)
    ['{C1553BDA-7488-48D8-ACF2-138FB0A166A3}']
  end;
