...
type
  ...
  JSupplicantStateClass = interface(JObjectClass)
    ['{97F7D689-7AFC-4C71-836A-8F6327E2CA9B}']
    ...
    function values : TJavaArray<JSupplicantState>; cdecl;                      // ()[Landroid/net/wifi/SupplicantState; A: $19
  ...
  JSupplicantState = interface(JObject)
    ['{35BCF550-5951-4BE6-B509-7766C60E48C9}']
    function describeContents : Integer; cdecl;                                 // ()I A: $1
    procedure writeToParcel(dest : JParcel; flags : Integer) ; cdecl;           // (Landroid/os/Parcel;I)V A: $1
  end;
