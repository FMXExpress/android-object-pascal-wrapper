...
type
  ...
  JMediaStore_Video_ThumbnailsClass = interface(JObjectClass)
    ['{6446540D-02B9-44E1-9696-2B5CA56D6381}']
    ...
    function getThumbnail(cr : JContentResolver; origId : Int64; kind : Integer; options : JBitmapFactory_Options) : JBitmap; cdecl;// (Landroid/content/ContentResolver;JILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap; A: $9
    function init : JMediaStore_Video_Thumbnails; cdecl;                        // ()V A: $1
    procedure cancelThumbnailRequest(cr : JContentResolver; origId : Int64) ; cdecl;// (Landroid/content/ContentResolver;J)V A: $9
  ...
  JMediaStore_Video_Thumbnails = interface(JObject)
    ['{FD6014C8-1A6E-4040-B4FE-164EC768E96A}']
  end;
