...
type
  ...
  JWebViewClass = interface(JObjectClass)
    ['{3E5A8340-5E33-49E4-99A7-8606462D1010}']
    ...
    procedure loadDataWithBaseURL(baseUrl : JString; data : JString; mimeType : JString; encoding : JString; failUrl : JString) ; cdecl;// (Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V A: $1
    procedure loadUrl(url : JString) ; cdecl;                                   // (Ljava/lang/String;)V A: $1
  ...
  JWebView = interface(JObject)
    ['{E8AF9518-6366-4F17-A637-1D1DB31162FD}']
    function canGoBack : boolean; cdecl;                                        // ()Z A: $1
    function canGoBackOrForward(steps : Integer) : boolean; cdecl;              // (I)Z A: $1
    function canGoForward : boolean; cdecl;                                     // ()Z A: $1
    function capturePicture : JPicture; cdecl;                                  // ()Landroid/graphics/Picture; A: $1
