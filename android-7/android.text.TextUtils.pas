...
type
  ...
  JTextUtilsClass = interface(JObjectClass)
    ['{47B24940-DEAA-40E2-BA30-7A5DD3EA7DB1}']
  ...
  JTextUtils = interface(JObject)
    ['{C9A5B3DB-7B47-4097-9696-87EF4BE18989}']
  end;
