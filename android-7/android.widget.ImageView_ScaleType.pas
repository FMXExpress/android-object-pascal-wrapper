...
type
  ...
  JImageView_ScaleTypeClass = interface(JObjectClass)
    ['{EF1F3E7A-3FD9-4082-88EA-497C9C922259}']
    ...
    function values : TJavaArray<JImageView_ScaleType>; cdecl;                  // ()[Landroid/widget/ImageView$ScaleType; A: $19
  ...
  JImageView_ScaleType = interface(JObject)
    ['{1774FA2C-7860-4F8D-A72C-2A0C569D765E}']
  end;
