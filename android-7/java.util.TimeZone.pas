...
type
  ...
  JTimeZoneClass = interface(JObjectClass)
    ['{C4D4560A-3607-4297-A3BA-2F45D0F99640}']
    ...
    function getAvailableIDs(offset : Integer) : TJavaArray<JString>; cdecl; overload;// (I)[Ljava/lang/String; A: $29
    ...
    function getTimeZone(&name : JString) : JTimeZone; cdecl;                   // (Ljava/lang/String;)Ljava/util/TimeZone; A: $29
    ...
    procedure setID(&name : JString) ; cdecl;                                   // (Ljava/lang/String;)V A: $1
  ...
  JTimeZone = interface(JObject)
    ['{D9AF53E2-20EA-4DD4-9E24-2FBA2C03B4CD}']
    function clone : JObject; cdecl;                                            // ()Ljava/lang/Object; A: $1
    function getDSTSavings : Integer; cdecl;                                    // ()I A: $1
    function getDisplayName(daylightTime : boolean; style : Integer; locale : JLocale) : JString; cdecl; overload;// (ZILjava/util/Locale;)Ljava/lang/String; A: $1
    function getID : JString; cdecl;                                            // ()Ljava/lang/String; A: $1
