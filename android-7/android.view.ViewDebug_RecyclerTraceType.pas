...
type
  ...
  JViewDebug_RecyclerTraceTypeClass = interface(JObjectClass)
    ['{8197E947-B61B-41B9-943A-92A4A94013DC}']
    ...
    function _GetMOVE_TO_ACTIVE_HEAP : JViewDebug_RecyclerTraceType; cdecl;     //  A: $4019
    ...
    property MOVE_TO_ACTIVE_HEAP : JViewDebug_RecyclerTraceType read _GetMOVE_TO_ACTIVE_HEAP;// Landroid/view/ViewDebug$RecyclerTraceType; A: $4019
  ...
  JViewDebug_RecyclerTraceType = interface(JObject)
    ['{036098FA-EB3C-4202-8463-25D214230A22}']
  end;
