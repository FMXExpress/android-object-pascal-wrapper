...
type
  ...
  JConsoleMessage_MessageLevelClass = interface(JObjectClass)
    ['{00FE542B-8237-42BA-9B45-1A528E27EB58}']
    ...
    function values : TJavaArray<JConsoleMessage_MessageLevel>; cdecl;          // ()[Landroid/webkit/ConsoleMessage$MessageLevel; A: $19
  ...
  JConsoleMessage_MessageLevel = interface(JObject)
    ['{142A0D34-AEBF-4118-B5EE-6612AA27CC7B}']
  end;
