...
type
  ...
  JClassClass = interface(JObjectClass)
    ['{401D45E9-E828-4AD8-BD30-24C671B0A017}']
    ...
    function forName(className : JString; initializeBoolean : boolean; classLoader : JClassLoader) : JClass; cdecl; overload;// (Ljava/lang/String;ZLjava/lang/ClassLoader;)Ljava/lang/Class; A: $9
  ...
  JClass = interface(JObject)
    ['{4AAF9887-82B5-474B-95D9-F6C432C8AB24}']
    function asSubclass(clazz : JClass) : JClass; cdecl;                        // (Ljava/lang/Class;)Ljava/lang/Class; A: $1
    function cast(obj : JObject) : JObject; cdecl;                              // (Ljava/lang/Object;)Ljava/lang/Object; A: $1
    function getAnnotation(annotationClass : JClass) : JAnnotation; cdecl;      // (Ljava/lang/Class;)Ljava/lang/annotation/Annotation; A: $1
    function getAnnotations : TJavaArray<JAnnotation>; cdecl;                   // ()[Ljava/lang/annotation/Annotation; A: $1
