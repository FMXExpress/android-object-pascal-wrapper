...
type
  ...
  JCallableStatementClass = interface(JObjectClass)
    ['{70A73CE6-6237-4E50-B624-AE6EBAA2FE57}']
    ...
    function getBigDecimal(Integerparam0 : Integer; Integerparam1 : Integer) : JBigDecimal; cdecl; overload;// (II)Ljava/math/BigDecimal; A: $401
    ...
    procedure setAsciiStream(JStringparam0 : JString; JInputStreamparam1 : JInputStream; Integerparam2 : Integer) ; cdecl;// (Ljava/lang/String;Ljava/io/InputStream;I)V A: $401
    ...
    procedure setBinaryStream(JStringparam0 : JString; JInputStreamparam1 : JInputStream; Integerparam2 : Integer) ; cdecl;// (Ljava/lang/String;Ljava/io/InputStream;I)V A: $401
    ...
    procedure setCharacterStream(JStringparam0 : JString; JReaderparam1 : JReader; Integerparam2 : Integer) ; cdecl;// (Ljava/lang/String;Ljava/io/Reader;I)V A: $401
  ...
  JCallableStatement = interface(JObject)
    ['{9FFDD148-9D99-457C-90D6-61779A8F7B9B}']
    function getArray(Integerparam0 : Integer) : JArray; cdecl; overload;       // (I)Ljava/sql/Array; A: $401
    function getArray(JStringparam0 : JString) : JArray; cdecl; overload;       // (Ljava/lang/String;)Ljava/sql/Array; A: $401
    function getBigDecimal(Integerparam0 : Integer) : JBigDecimal; cdecl; overload;// (I)Ljava/math/BigDecimal; A: $401
    function getBigDecimal(Integerparam0 : Integer; Integerparam1 : Integer) : JBigDecimal; cdecl; overload;// (II)Ljava/math/BigDecimal; A: $401
