...
type
  ...
  JURIClass = interface(JObjectClass)
    ['{53063CE7-8BAC-455A-8B80-37D16966620E}']
    ...
    function init(scheme : JString; ssp : JString; frag : JString) : JURI; cdecl; overload;// (Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V A: $1
    ...
    function init(uri : JString) : JURI; cdecl; overload;                       // (Ljava/lang/String;)V A: $1
  ...
  JURI = interface(JObject)
    ['{AD5A776C-8DB1-4ACF-B47E-B5375E64840B}']
    function compareTo(uri : JURI) : Integer; cdecl;                            // (Ljava/net/URI;)I A: $1
    function equals(o : JObject) : boolean; cdecl;                              // (Ljava/lang/Object;)Z A: $1
    function getAuthority : JString; cdecl;                                     // ()Ljava/lang/String; A: $1
    function getFragment : JString; cdecl;                                      // ()Ljava/lang/String; A: $1
