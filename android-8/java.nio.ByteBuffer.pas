...
type
  ...
  JByteBufferClass = interface(JObjectClass)
    ['{BA670DD8-E3B1-4D33-9D90-97B32C72DC1B}']
    ...
    function get(dest : TJavaArray<Byte>) : JByteBuffer; cdecl; overload;       // ([B)Ljava/nio/ByteBuffer; A: $1
    function get(dest : TJavaArray<Byte>; off : Integer; len : Integer) : JByteBuffer; cdecl; overload;// ([BII)Ljava/nio/ByteBuffer; A: $1
    ...
    function put(src : TJavaArray<Byte>; off : Integer; len : Integer) : JByteBuffer; cdecl; overload;// ([BII)Ljava/nio/ByteBuffer; A: $1
    ...
    function wrap(&array : TJavaArray<Byte>; start : Integer; len : Integer) : JByteBuffer; cdecl; overload;// ([BII)Ljava/nio/ByteBuffer; A: $9
  end;

  [JavaSignature('java/nio/ByteBuffer')]
  JByteBuffer = interface(JObject)
    ['{FA36717C-B27E-4563-B0A9-EC61B122BD2C}']
    function asCharBuffer : JCharBuffer; cdecl;                                 // ()Ljava/nio/CharBuffer; A: $401
    function asDoubleBuffer : JDoubleBuffer; cdecl;                             // ()Ljava/nio/DoubleBuffer; A: $401
    function asFloatBuffer : JFloatBuffer; cdecl;                               // ()Ljava/nio/FloatBuffer; A: $401
    function asIntBuffer : JIntBuffer; cdecl;                                   // ()Ljava/nio/IntBuffer; A: $401
