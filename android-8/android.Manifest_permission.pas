...
type
  ...
  JManifest_permissionClass = interface(JObjectClass)
    ['{BF6B7927-194B-4924-9C7F-65A85FE09593}']
    ...
    function _GetREAD_OWNER_DATA : JString; cdecl;                              //  A: $19
    ...
    function _GetWRITE_OWNER_DATA : JString; cdecl;                             //  A: $19
    ...
    property READ_OWNER_DATA : JString read _GetREAD_OWNER_DATA;                // Ljava/lang/String; A: $19
    ...
    property WRITE_OWNER_DATA : JString read _GetWRITE_OWNER_DATA;              // Ljava/lang/String; A: $19
  ...
  JManifest_permission = interface(JObject)
    ['{72D99479-254E-4A28-A903-0C39E5CC2C5B}']
  end;
...
const
  ...
  TJManifest_permissionREAD_OWNER_DATA = 'android.permission.READ_OWNER_DATA';
  ...
  TJManifest_permissionWRITE_OWNER_DATA = 'android.permission.WRITE_OWNER_DATA';
