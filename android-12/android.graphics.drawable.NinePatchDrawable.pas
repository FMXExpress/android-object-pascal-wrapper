...
type
  ...
  JNinePatchDrawableClass = interface(JObjectClass)
    ['{24320D6C-F634-4400-A9A7-A7734DC7AED1}']
    ...
    function init(bitmap : JBitmap; chunk : TJavaArray<Byte>; padding : JRect; srcName : JString) : JNinePatchDrawable; cdecl; overload;// (Landroid/graphics/Bitmap;[BLandroid/graphics/Rect;Ljava/lang/String;)V A: $1
    function init(patch : JNinePatch) : JNinePatchDrawable; cdecl; overload;    // (Landroid/graphics/NinePatch;)V A: $1
  ...
  JNinePatchDrawable = interface(JObject)
    ['{4F69EFFA-D561-43A6-9F5A-88C46E147617}']
    function getChangingConfigurations : Integer; cdecl;                        // ()I A: $1
    function getConstantState : JDrawable_ConstantState; cdecl;                 // ()Landroid/graphics/drawable/Drawable$ConstantState; A: $1
    function getIntrinsicHeight : Integer; cdecl;                               // ()I A: $1
    function getIntrinsicWidth : Integer; cdecl;                                // ()I A: $1
