...
type
  ...
  JWebSettingsClass = interface(JObjectClass)
    ['{EB9FC6EB-2C4A-4A38-8396-3AB8620B87BA}']
    ...
    function getUseWebViewBackgroundForOverscrollBackground : boolean; cdecl;   // ()Z A: $1
    ...
    procedure setUseWebViewBackgroundForOverscrollBackground(view : boolean) ; cdecl;// (Z)V A: $1
  ...
  JWebSettings = interface(JObject)
    ['{7276F1EF-87FD-4846-A10F-1526760A280A}']
    function enableSmoothTransition : boolean; cdecl;                           // ()Z A: $1
    function getAllowContentAccess : boolean; cdecl;                            // ()Z A: $1
    function getAllowFileAccess : boolean; cdecl;                               // ()Z A: $1
    function getBuiltInZoomControls : boolean; cdecl;                           // ()Z A: $1
