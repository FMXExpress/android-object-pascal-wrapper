...
type
  ...
  JHandlerClass = interface(JObjectClass)
    ['{3C805575-D0E1-4FD0-8D92-76DF390676AC}']
    function createAsync(looper : JLooper) : JHandler; cdecl; overload;         // (Landroid/os/Looper;)Landroid/os/Handler; A: $9
    function createAsync(looper : JLooper; callback : JHandler_Callback) : JHandler; cdecl; overload;// (Landroid/os/Looper;Landroid/os/Handler$Callback;)Landroid/os/Handler; A: $9
    ...
    function postDelayed(r : JRunnable; delayMillis : Int64) : boolean; cdecl; overload;// (Ljava/lang/Runnable;J)Z A: $11
    function postDelayed(r : JRunnable; token : JObject; delayMillis : Int64) : boolean; cdecl; overload;// (Ljava/lang/Runnable;Ljava/lang/Object;J)Z A: $11
  ...
  JHandler = interface(JObject)
    ['{4374A389-414C-4EBD-B68C-80B28D56641B}']
    function getMessageName(&message : JMessage) : JString; cdecl;              // (Landroid/os/Message;)Ljava/lang/String; A: $1
    function sendMessageAtTime(msg : JMessage; uptimeMillis : Int64) : boolean; cdecl;// (Landroid/os/Message;J)Z A: $1
    function toString : JString; cdecl;                                         // ()Ljava/lang/String; A: $1
    procedure dispatchMessage(msg : JMessage) ; cdecl;                          // (Landroid/os/Message;)V A: $1
