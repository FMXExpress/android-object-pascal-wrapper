...
type
  ...
  JResourceBundleClass = interface(JObjectClass)
    ['{968EAE07-37A0-4FBD-B053-43E3484B3013}']
    function containsKey(key : JString) : boolean; cdecl;                       // (Ljava/lang/String;)Z A: $1
    function getBaseBundleName : JString; cdecl;                                // ()Ljava/lang/String; A: $1
    function getBundle(baseName : JString) : JResourceBundle; cdecl; overload;  // (Ljava/lang/String;)Ljava/util/ResourceBundle; A: $19
    ...
    function getBundle(baseName : JString; locale : JLocale) : JResourceBundle; cdecl; overload;// (Ljava/lang/String;Ljava/util/Locale;)Ljava/util/ResourceBundle; A: $19
    function getBundle(baseName : JString; locale : JLocale; loader : JClassLoader) : JResourceBundle; cdecl; overload;// (Ljava/lang/String;Ljava/util/Locale;Ljava/lang/ClassLoader;)Ljava/util/ResourceBundle; A: $9
  ...
  JResourceBundle = interface(JObject)
    ['{E23B47BD-1562-4F8D-9A6B-500ED922787F}']
    function containsKey(key : JString) : boolean; cdecl;                       // (Ljava/lang/String;)Z A: $1
    function getBaseBundleName : JString; cdecl;                                // ()Ljava/lang/String; A: $1
    function getKeys : JEnumeration; cdecl;                                     // ()Ljava/util/Enumeration; A: $401
    function getLocale : JLocale; cdecl;                                        // ()Ljava/util/Locale; A: $1
  ...
  JResourceBundle_ControlClass = interface(JObjectClass)
    ['{49B89409-E18F-4C68-8CE7-F972D064D7B9}']
    ...
    function getControl(formats : JList) : JResourceBundle_Control; cdecl;      // (Ljava/util/List;)Ljava/util/ResourceBundle$Control; A: $19
    ...
    function getNoFallbackControl(formats : JList) : JResourceBundle_Control; cdecl;// (Ljava/util/List;)Ljava/util/ResourceBundle$Control; A: $19
  ...
  JResourceBundle_Control = interface(JObject)
    ['{B4131C8D-9A02-4F56-B9B4-CB63E7808344}']
    function getCandidateLocales(baseName : JString; locale : JLocale) : JList; cdecl;// (Ljava/lang/String;Ljava/util/Locale;)Ljava/util/List; A: $1
    function getFallbackLocale(baseName : JString; locale : JLocale) : JLocale; cdecl;// (Ljava/lang/String;Ljava/util/Locale;)Ljava/util/Locale; A: $1
    function getFormats(baseName : JString) : JList; cdecl;                     // (Ljava/lang/String;)Ljava/util/List; A: $1
    function getTimeToLive(baseName : JString; locale : JLocale) : Int64; cdecl;// (Ljava/lang/String;Ljava/util/Locale;)J A: $1
