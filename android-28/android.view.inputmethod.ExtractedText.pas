...
type
  ...
  JExtractedTextClass = interface(JObjectClass)
    ['{A92C2D01-FBDC-42C8-9026-0DC384100F78}']
    ...
    function _Gethint : JCharSequence; cdecl;                                   //  A: $1
    ...
    procedure _Sethint(Value : JCharSequence) ; cdecl;                          //  A: $1
    ...
    property hint : JCharSequence read _Gethint write _Sethint;                 // Ljava/lang/CharSequence; A: $1
  ...
  JExtractedText = interface(JObject)
    ['{A5E55A44-0423-40E3-A6D4-DF4BCD94B389}']
    function _Getflags : Integer; cdecl;                                        //  A: $1
    function _Gethint : JCharSequence; cdecl;                                   //  A: $1
    function _GetpartialEndOffset : Integer; cdecl;                             //  A: $1
    function _GetpartialStartOffset : Integer; cdecl;                           //  A: $1
