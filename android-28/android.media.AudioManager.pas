...
uses
  ...
  android.media.AudioManager_AudioPlaybackCallback,
  Androidapi.JNI.os,
...
type
  ...
  JAudioManagerClass = interface(JObjectClass)
    ['{D1132278-0718-460F-87B2-347A76483557}']
    ...
    function _GetACTION_MICROPHONE_MUTE_CHANGED : JString; cdecl;               //  A: $19
    ...
    function _GetAUDIOFOCUS_NONE : Integer; cdecl;                              //  A: $19
    function _GetAUDIOFOCUS_REQUEST_DELAYED : Integer; cdecl;                   //  A: $19
    ...
    function _GetSTREAM_ACCESSIBILITY : Integer; cdecl;                         //  A: $19
    ...
    function abandonAudioFocus(l : JAudioManager_OnAudioFocusChangeListener) : Integer; deprecated; cdecl;// (Landroid/media/AudioManager$OnAudioFocusChangeListener;)I A: $1
    function abandonAudioFocusRequest(focusRequest : JAudioFocusRequest) : Integer; cdecl;// (Landroid/media/AudioFocusRequest;)I A: $1
    function generateAudioSessionId : Integer; cdecl;                           // ()I A: $1
    function getActivePlaybackConfigurations : JList; cdecl;                    // ()Ljava/util/List; A: $1
    ...
    function getMicrophones : JList; cdecl;                                     // ()Ljava/util/List; A: $1
    ...
    function getStreamMinVolume(streamType : Integer) : Integer; cdecl;         // (I)I A: $1
    function getStreamVolume(streamType : Integer) : Integer; cdecl;            // (I)I A: $1
    function getStreamVolumeDb(streamType : Integer; &index : Integer; deviceType : Integer) : Single; cdecl;// (III)F A: $1
    function getVibrateSetting(vibrateType : Integer) : Integer; deprecated; cdecl;// (I)I A: $1
    function isBluetoothA2dpOn : boolean; deprecated; cdecl;                    // ()Z A: $1
    ...
    function requestAudioFocus(focusRequest : JAudioFocusRequest) : Integer; cdecl; overload;// (Landroid/media/AudioFocusRequest;)I A: $1
    function requestAudioFocus(l : JAudioManager_OnAudioFocusChangeListener; streamType : Integer; durationHint : Integer) : Integer; deprecated; cdecl; overload;// (Landroid/media/AudioManager$OnAudioFocusChangeListener;II)I A: $1
    ...
    procedure registerAudioPlaybackCallback(cb : JAudioManager_AudioPlaybackCallback; handler : JHandler) ; cdecl;// (Landroid/media/AudioManager$AudioPlaybackCallback;Landroid/os/Handler;)V A: $1
    ...
    procedure unregisterAudioPlaybackCallback(cb : JAudioManager_AudioPlaybackCallback) ; cdecl;// (Landroid/media/AudioManager$AudioPlaybackCallback;)V A: $1
    ...
    property ACTION_MICROPHONE_MUTE_CHANGED : JString read _GetACTION_MICROPHONE_MUTE_CHANGED;// Ljava/lang/String; A: $19
    ...
    property AUDIOFOCUS_NONE : Integer read _GetAUDIOFOCUS_NONE;                // I A: $19
    property AUDIOFOCUS_REQUEST_DELAYED : Integer read _GetAUDIOFOCUS_REQUEST_DELAYED;// I A: $19
    ...
    property STREAM_ACCESSIBILITY : Integer read _GetSTREAM_ACCESSIBILITY;      // I A: $19
  ...
  JAudioManager = interface(JObject)
    ['{C7FACDAF-3437-4F3B-8D7A-B661A45C2742}']
    function abandonAudioFocus(l : JAudioManager_OnAudioFocusChangeListener) : Integer; deprecated; cdecl;// (Landroid/media/AudioManager$OnAudioFocusChangeListener;)I A: $1
    function abandonAudioFocusRequest(focusRequest : JAudioFocusRequest) : Integer; cdecl;// (Landroid/media/AudioFocusRequest;)I A: $1
    function generateAudioSessionId : Integer; cdecl;                           // ()I A: $1
    function getActivePlaybackConfigurations : JList; cdecl;                    // ()Ljava/util/List; A: $1
...
const
  ...
  TJAudioManagerACTION_MICROPHONE_MUTE_CHANGED = 'android.media.action.MICROPHONE_MUTE_CHANGED';
  ...
  TJAudioManagerAUDIOFOCUS_NONE = 0;
  TJAudioManagerAUDIOFOCUS_REQUEST_DELAYED = 2;
  ...
  TJAudioManagerSTREAM_ACCESSIBILITY = 10;
