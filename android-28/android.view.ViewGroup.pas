...
type
  ...
  JViewGroupClass = interface(JObjectClass)
    ['{B6E99EA2-57F4-4ECF-9039-99D3ECDEBC7A}']
    ...
    function getPersistentDrawingCache : Integer; deprecated; cdecl;            // ()I A: $1
    ...
    function invalidateChildInParent(location : TJavaArray<Integer>; dirty : JRect) : JViewParent; deprecated; cdecl;// ([ILandroid/graphics/Rect;)Landroid/view/ViewParent; A: $1
    ...
    procedure invalidateChild(child : JView; dirty : JRect) ; deprecated; cdecl;// (Landroid/view/View;Landroid/graphics/Rect;)V A: $11
    ...
    procedure setPersistentDrawingCache(drawingCacheToKeep : Integer) ; deprecated; cdecl;// (I)V A: $1
  ...
  JViewGroup = interface(JObject)
    ['{523B3402-D5E2-44E6-866C-A37B438D807A}']
    function addStatesFromChildren : boolean; cdecl;                            // ()Z A: $1
    function dispatchApplyWindowInsets(insets : JWindowInsets) : JWindowInsets; cdecl;// (Landroid/view/WindowInsets;)Landroid/view/WindowInsets; A: $1
    function dispatchCapturedPointerEvent(event : JMotionEvent) : boolean; cdecl;// (Landroid/view/MotionEvent;)Z A: $1
    function dispatchDragEvent(event : JDragEvent) : boolean; cdecl;            // (Landroid/view/DragEvent;)Z A: $1
