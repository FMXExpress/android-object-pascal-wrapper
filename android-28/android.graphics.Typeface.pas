...
type
  ...
  JTypefaceClass = interface(JObjectClass)
    ['{078480C2-0B26-44A8-8D34-B76AD51619B1}']
    ...
    function create(family : JTypeface; weight : Integer; italic : boolean) : JTypeface; cdecl; overload;// (Landroid/graphics/Typeface;IZ)Landroid/graphics/Typeface; A: $9
    ...
    function createFromFile(&file : JFile) : JTypeface; cdecl; overload;        // (Ljava/io/File;)Landroid/graphics/Typeface; A: $9
  ...
  JTypeface = interface(JObject)
    ['{C941C63C-3F78-45BB-A034-E5ABC1DE09DF}']
    function equals(o : JObject) : boolean; cdecl;                              // (Ljava/lang/Object;)Z A: $1
    function getStyle : Integer; cdecl;                                         // ()I A: $1
    function getWeight : Integer; cdecl;                                        // ()I A: $1
    function hashCode : Integer; cdecl;                                         // ()I A: $1
