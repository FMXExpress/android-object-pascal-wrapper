...
type
  ...
  JContacts_OrganizationsClass = interface(JObjectClass)
    ['{802F1AC1-EE89-49A7-8FB2-86F8898C1640}']
    function _GetCONTENT_DIRECTORY : JString; cdecl;                            //  A: $19
    function _GetCONTENT_URI : JUri; cdecl;                                     //  A: $19
    function _GetDEFAULT_SORT_ORDER : JString; cdecl;                           //  A: $19
    function getDisplayLabel(context : JContext; &type : Integer; &label : JCharSequence) : JCharSequence; deprecated; cdecl;// (Landroid/content/Context;ILjava/lang/CharSequence;)Ljava/lang/CharSequence; A: $9
  ...
  JContacts_Organizations = interface(JObject)
    ['{11ECA586-6319-46CF-9F06-EE0CE7D25D92}']
  end;
