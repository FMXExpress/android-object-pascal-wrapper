...
type
  ...
  JManifest_permissionClass = interface(JObjectClass)
    ['{A676A785-57DB-4096-92A7-76FA2D7245D2}']
    function _GetACCEPT_HANDOVER : JString; cdecl;                              //  A: $19
    ...
    function _GetFOREGROUND_SERVICE : JString; cdecl;                           //  A: $19
    ...
    function _GetNFC_TRANSACTION_EVENT : JString; cdecl;                        //  A: $19
    ...
    function _GetUSE_BIOMETRIC : JString; cdecl;                                //  A: $19
    ...
    property ACCEPT_HANDOVER : JString read _GetACCEPT_HANDOVER;                // Ljava/lang/String; A: $19
    ...
    property FOREGROUND_SERVICE : JString read _GetFOREGROUND_SERVICE;          // Ljava/lang/String; A: $19
    ...
    property NFC_TRANSACTION_EVENT : JString read _GetNFC_TRANSACTION_EVENT;    // Ljava/lang/String; A: $19
    ...
    property USE_BIOMETRIC : JString read _GetUSE_BIOMETRIC;                    // Ljava/lang/String; A: $19
  ...
  JManifest_permission = interface(JObject)
    ['{0D1094ED-4493-4BCF-9778-4B8DA266ECC7}']
  end;
...
const
  TJManifest_permissionACCEPT_HANDOVER = 'android.permission.ACCEPT_HANDOVER';
  ...
  TJManifest_permissionFOREGROUND_SERVICE = 'android.permission.FOREGROUND_SERVICE';
  ...
  TJManifest_permissionNFC_TRANSACTION_EVENT = 'android.permission.NFC_TRANSACTION_EVENT';
  ...
  TJManifest_permissionUSE_BIOMETRIC = 'android.permission.USE_BIOMETRIC';
