...
type
  ...
  JCall_DetailsClass = interface(JObjectClass)
    ['{C5330D32-D975-40E6-9869-34ECBBAAE2B8}']
    ...
    function _GetPROPERTY_RTT : Integer; cdecl;                                 //  A: $19
    ...
    function getCreationTimeMillis : Int64; cdecl;                              // ()J A: $1
    ...
    property PROPERTY_RTT : Integer read _GetPROPERTY_RTT;                      // I A: $19
  ...
  JCall_Details = interface(JObject)
    ['{DBFB20AE-CE7F-4AD9-BB48-09369C6E4398}']
    function can(capability : Integer) : boolean; cdecl; overload;              // (I)Z A: $1
    function equals(o : JObject) : boolean; cdecl;                              // (Ljava/lang/Object;)Z A: $1
    function getAccountHandle : JPhoneAccountHandle; cdecl;                     // ()Landroid/telecom/PhoneAccountHandle; A: $1
    function getCallCapabilities : Integer; cdecl;                              // ()I A: $1
...
const
  ...
  TJCall_DetailsCAPABILITY_CAN_PULL_CALL = 8388608;
  ...
  TJCall_DetailsCAPABILITY_SUPPORT_DEFLECT = 16777216;
  ...
  TJCall_DetailsPROPERTY_HAS_CDMA_VOICE_PRIVACY = 128;
  TJCall_DetailsPROPERTY_HIGH_DEF_AUDIO = 16;
  TJCall_DetailsPROPERTY_IS_EXTERNAL_CALL = 64;
  TJCall_DetailsPROPERTY_RTT = 1024;
  TJCall_DetailsPROPERTY_SELF_MANAGED = 256;
