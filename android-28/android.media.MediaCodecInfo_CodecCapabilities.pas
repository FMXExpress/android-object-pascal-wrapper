...
type
  ...
  JMediaCodecInfo_CodecCapabilitiesClass = interface(JObjectClass)
    ['{99FD7609-6DB3-44BB-A4EB-9956E28A78CA}']
    ...
    function _GetFEATURE_PartialFrame : JString; cdecl;                         //  A: $19
    ...
    function isFeatureRequired(&name : JString) : boolean; cdecl;               // (Ljava/lang/String;)Z A: $1
    function isFeatureSupported(&name : JString) : boolean; cdecl;              // (Ljava/lang/String;)Z A: $1
    function isFormatSupported(format : JMediaFormat) : boolean; cdecl;         // (Landroid/media/MediaFormat;)Z A: $1
    ...
    property FEATURE_PartialFrame : JString read _GetFEATURE_PartialFrame;      // Ljava/lang/String; A: $19
  ...
  JMediaCodecInfo_CodecCapabilities = interface(JObject)
    ['{580585DA-8C0D-4853-8245-D50B70D2C907}']
    function _GetcolorFormats : TJavaArray<Integer>; cdecl;                     //  A: $1
    function _GetprofileLevels : TJavaArray<JMediaCodecInfo_CodecProfileLevel>; cdecl;//  A: $1
    function getAudioCapabilities : JMediaCodecInfo_AudioCapabilities; cdecl;   // ()Landroid/media/MediaCodecInfo$AudioCapabilities; A: $1
    function getDefaultFormat : JMediaFormat; cdecl;                            // ()Landroid/media/MediaFormat; A: $1
...
const
  ...
  TJMediaCodecInfo_CodecCapabilitiesFEATURE_PartialFrame = 'partial-frame';
