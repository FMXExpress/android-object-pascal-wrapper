...
type
  ...
  JSettings_SecureClass = interface(JObjectClass)
    ['{6AD31BFB-D74D-4991-8B9A-CB6C294B277F}']
    ...
    function _GetRTT_CALLING_MODE : JString; cdecl;                             //  A: $19
    ...
    function isLocationProviderEnabled(cr : JContentResolver; provider : JString) : boolean; deprecated; cdecl;// (Landroid/content/ContentResolver;Ljava/lang/String;)Z A: $9
    ...
    procedure setLocationProviderEnabled(cr : JContentResolver; provider : JString; enabled : boolean) ; deprecated; cdecl;// (Landroid/content/ContentResolver;Ljava/lang/String;Z)V A: $9
    ...
    property RTT_CALLING_MODE : JString read _GetRTT_CALLING_MODE;              // Ljava/lang/String; A: $19
  ...
  JSettings_Secure = interface(JObject)
    ['{63374D96-8EAA-48F7-A611-213CE644F98B}']
  end;
...
const
  ...
  TJSettings_SecureRTT_CALLING_MODE = 'rtt_calling_mode';
