...
type
  ...
  JContacts_ContactMethodsClass = interface(JObjectClass)
    ['{9A20A4E9-F373-45BA-BFB0-61A94DABAE09}']
    ...
    function getDisplayLabel(context : JContext; kind : Integer; &type : Integer; &label : JCharSequence) : JCharSequence; deprecated; cdecl;// (Landroid/content/Context;IILjava/lang/CharSequence;)Ljava/lang/CharSequence; A: $9
  ...
  JContacts_ContactMethods = interface(JObject)
    ['{DBB96613-8F97-4F32-81FB-1F31401C4CA1}']
    procedure addPostalLocation(context : JContext; postalId : Int64; latitude : Double; longitude : Double) ; deprecated; cdecl;// (Landroid/content/Context;JDD)V A: $1
  end;
