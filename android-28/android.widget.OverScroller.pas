...
type
  ...
  JOverScrollerClass = interface(JObjectClass)
    ['{D9CF7184-97A8-4C32-B6F8-7DA53A8A3B58}']
    ...
    function init(context : JContext; interpolator : JInterpolator; bounceCoefficientX : Single; bounceCoefficientY : Single) : JOverScroller; deprecated; cdecl; overload;// (Landroid/content/Context;Landroid/view/animation/Interpolator;FF)V A: $1
    function init(context : JContext; interpolator : JInterpolator; bounceCoefficientX : Single; bounceCoefficientY : Single; flywheel : boolean) : JOverScroller; deprecated; cdecl; overload;// (Landroid/content/Context;Landroid/view/animation/Interpolator;FFZ)V A: $1
  ...
  JOverScroller = interface(JObject)
    ['{828D5E7B-7487-472D-A77F-4A9BA7A563AF}']
    function computeScrollOffset : boolean; cdecl;                              // ()Z A: $1
    function getCurrVelocity : Single; cdecl;                                   // ()F A: $1
    function isOverScrolled : boolean; cdecl;                                   // ()Z A: $1
    function springBack(startX : Integer; startY : Integer; minX : Integer; maxX : Integer; minY : Integer; maxY : Integer) : boolean; cdecl;// (IIIIII)Z A: $1
