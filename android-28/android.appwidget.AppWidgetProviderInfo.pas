...
type
  ...
  JAppWidgetProviderInfoClass = interface(JObjectClass)
    ['{F74C8695-EA6F-410D-B739-A1986C45615E}']
    ...
    function _GetWIDGET_FEATURE_HIDE_FROM_PICKER : Integer; cdecl;              //  A: $19
    function _GetWIDGET_FEATURE_RECONFIGURABLE : Integer; cdecl;                //  A: $19
    ...
    function _GetwidgetFeatures : Integer; cdecl;                               //  A: $1
    ...
    procedure _SetwidgetFeatures(Value : Integer) ; cdecl;                      //  A: $1
    ...
    property WIDGET_FEATURE_HIDE_FROM_PICKER : Integer read _GetWIDGET_FEATURE_HIDE_FROM_PICKER;// I A: $19
    property WIDGET_FEATURE_RECONFIGURABLE : Integer read _GetWIDGET_FEATURE_RECONFIGURABLE;// I A: $19
    ...
    property widgetFeatures : Integer read _GetwidgetFeatures write _SetwidgetFeatures;// I A: $1
  end;

  [JavaSignature('android/appwidget/AppWidgetProviderInfo')]
  JAppWidgetProviderInfo = interface(JObject)
    ['{746A9110-8317-4448-920F-956E9C3B23F6}']
    function _GetautoAdvanceViewId : Integer; cdecl;                            //  A: $1
    function _Getconfigure : JComponentName; cdecl;                             //  A: $1
    function _Geticon : Integer; cdecl;                                         //  A: $1
    function _GetinitialKeyguardLayout : Integer; cdecl;                        //  A: $1
...
const
  ...
  TJAppWidgetProviderInfoWIDGET_FEATURE_HIDE_FROM_PICKER = 2;
  TJAppWidgetProviderInfoWIDGET_FEATURE_RECONFIGURABLE = 1;
