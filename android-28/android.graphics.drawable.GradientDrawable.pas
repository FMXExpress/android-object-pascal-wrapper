...
type
  ...
  JGradientDrawableClass = interface(JObjectClass)
    ['{F39EAD84-B5BA-40EE-A29D-AF2B711C3E22}']
    ...
    function getColor : JColorStateList; cdecl;                                 // ()Landroid/content/res/ColorStateList; A: $1
    function getColorFilter : JColorFilter; cdecl;                              // ()Landroid/graphics/ColorFilter; A: $1
    function getColors : TJavaArray<Integer>; cdecl;                            // ()[I A: $1
    function getConstantState : JDrawable_ConstantState; cdecl;                 // ()Landroid/graphics/drawable/Drawable$ConstantState; A: $1
    function getCornerRadii : TJavaArray<Single>; cdecl;                        // ()[F A: $1
    function getCornerRadius : Single; cdecl;                                   // ()F A: $1
    function getGradientCenterX : Single; cdecl;                                // ()F A: $1
    function getGradientCenterY : Single; cdecl;                                // ()F A: $1
    function getGradientRadius : Single; cdecl;                                 // ()F A: $1
    function getGradientType : Integer; cdecl;                                  // ()I A: $1
    ...
    function getShape : Integer; cdecl;                                         // ()I A: $1
    function getUseLevel : boolean; cdecl;                                      // ()Z A: $1
  ...
  JGradientDrawable = interface(JObject)
    ['{84D5498B-43EC-4331-B787-21D5EE957CAC}']
    function canApplyTheme : boolean; cdecl;                                    // ()Z A: $1
    function getAlpha : Integer; cdecl;                                         // ()I A: $1
    function getChangingConfigurations : Integer; cdecl;                        // ()I A: $1
    function getColor : JColorStateList; cdecl;                                 // ()Landroid/content/res/ColorStateList; A: $1
