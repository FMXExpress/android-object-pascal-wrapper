...
type
  ...
  JR_interpolatorClass = interface(JObjectClass)
    ['{381C8EFC-43B0-484B-AAAF-13FAA2E61623}']
    ...
    function _Getfast_out_extra_slow_in : Integer; cdecl;                       //  A: $19
    ...
    property fast_out_extra_slow_in : Integer read _Getfast_out_extra_slow_in;  // I A: $19
  ...
  JR_interpolator = interface(JObject)
    ['{7BAD14B3-87F5-4AA1-BA11-39921971FC4E}']
  end;
...
const
  ...
  TJR_interpolatorfast_out_extra_slow_in = 17563674;
