...
type
  ...
  JAudioTrackClass = interface(JObjectClass)
    ['{F252F0B5-97F5-4458-83F8-00015C1AFA52}']
    ...
    function _GetPERFORMANCE_MODE_LOW_LATENCY : Integer; cdecl;                 //  A: $19
    function _GetPERFORMANCE_MODE_NONE : Integer; cdecl;                        //  A: $19
    function _GetPERFORMANCE_MODE_POWER_SAVING : Integer; cdecl;                //  A: $19
    ...
    function getPerformanceMode : Integer; cdecl;                               // ()I A: $1
    ...
    function init(streamType : Integer; sampleRateInHz : Integer; channelConfig : Integer; audioFormat : Integer; bufferSizeInBytes : Integer; mode : Integer) : JAudioTrack; deprecated; cdecl; overload;// (IIIIII)V A: $1
    function init(streamType : Integer; sampleRateInHz : Integer; channelConfig : Integer; audioFormat : Integer; bufferSizeInBytes : Integer; mode : Integer; sessionId : Integer) : JAudioTrack; deprecated; cdecl; overload;// (IIIIIII)V A: $1
    ...
    function setPresentation(presentation : JAudioPresentation) : Integer; cdecl;// (Landroid/media/AudioPresentation;)I A: $1
    ...
    procedure addOnRoutingChangedListener(listener : JAudioTrack_OnRoutingChangedListener; handler : JHandler) ; deprecated; cdecl; overload;// (Landroid/media/AudioTrack$OnRoutingChangedListener;Landroid/os/Handler;)V A: $1
    ...
    procedure removeOnRoutingChangedListener(listener : JAudioTrack_OnRoutingChangedListener) ; deprecated; cdecl; overload;// (Landroid/media/AudioTrack$OnRoutingChangedListener;)V A: $1
    ...
    property PERFORMANCE_MODE_LOW_LATENCY : Integer read _GetPERFORMANCE_MODE_LOW_LATENCY;// I A: $19
    property PERFORMANCE_MODE_NONE : Integer read _GetPERFORMANCE_MODE_NONE;    // I A: $19
    property PERFORMANCE_MODE_POWER_SAVING : Integer read _GetPERFORMANCE_MODE_POWER_SAVING;// I A: $19
  ...
  JAudioTrack = interface(JObject)
    ['{FAD1014D-8DC7-4B52-9FFE-D2D027BC08CF}']
    function &write(audioData : JByteBuffer; sizeInBytes : Integer; writeMode : Integer) : Integer; cdecl; overload;// (Ljava/nio/ByteBuffer;II)I A: $1
    function &write(audioData : JByteBuffer; sizeInBytes : Integer; writeMode : Integer; timestamp : Int64) : Integer; cdecl; overload;// (Ljava/nio/ByteBuffer;IIJ)I A: $1
    function &write(audioData : TJavaArray<Byte>; offsetInBytes : Integer; sizeInBytes : Integer) : Integer; cdecl; overload;// ([BII)I A: $1
    function &write(audioData : TJavaArray<Byte>; offsetInBytes : Integer; sizeInBytes : Integer; writeMode : Integer) : Integer; cdecl; overload;// ([BIII)I A: $1
  ...
  JAudioTrack_OnPlaybackPositionUpdateListenerClass = interface(JObjectClass)
    ['{800851F4-819D-4D88-B993-E45B1C1808D4}']
  ...
  JAudioTrack_OnPlaybackPositionUpdateListener = interface(JObject)
    ['{8373F279-B55D-4C45-821F-F5025194CCE5}']
    procedure onMarkerReached(JAudioTrackparam0 : JAudioTrack) ; cdecl;         // (Landroid/media/AudioTrack;)V A: $401
    procedure onPeriodicNotification(JAudioTrackparam0 : JAudioTrack) ; cdecl;  // (Landroid/media/AudioTrack;)V A: $401
  end;
  ...
  // Merged from: .\android.media.AudioTrack_OnRoutingChangedListener.pas
  JAudioTrack_OnRoutingChangedListenerClass = interface(JObjectClass)
    ['{76FECCCE-EFA0-48D5-919E-625867169FB7}']
    procedure onRoutingChanged(JAudioTrackparam0 : JAudioTrack) ; cdecl; overload;// (Landroid/media/AudioTrack;)V A: $401
  ...
  JAudioTrack_OnRoutingChangedListener = interface(JObject)
    ['{AF601F9B-4B09-4BCC-9870-D6E2652DFEED}']
    procedure onRoutingChanged(JAudioTrackparam0 : JAudioTrack) ; cdecl; overload;// (Landroid/media/AudioTrack;)V A: $401
    procedure onRoutingChanged(router : JAudioRouting) ; cdecl; overload;       // (Landroid/media/AudioRouting;)V A: $1
  end;
...
const
  ...
  TJAudioTrackERROR_DEAD_OBJECT = -6;
  TJAudioTrackERROR_INVALID_OPERATION = -3;
  TJAudioTrackMODE_STATIC = 0;
  TJAudioTrackMODE_STREAM = 1;
  TJAudioTrackPERFORMANCE_MODE_LOW_LATENCY = 1;
  TJAudioTrackPERFORMANCE_MODE_NONE = 0;
  TJAudioTrackPERFORMANCE_MODE_POWER_SAVING = 2;
