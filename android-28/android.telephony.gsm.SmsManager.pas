...
type
  ...
  JSmsManagerClass = interface(JObjectClass)
    ['{979D92D1-B94E-4618-B09B-1792399833FD}']
    ...
    function divideMessage(text : JString) : JArrayList; deprecated; cdecl;     // (Ljava/lang/String;)Ljava/util/ArrayList; A: $1
    function getDefault : JSmsManager; deprecated; cdecl;                       // ()Landroid/telephony/gsm/SmsManager; A: $9
    procedure sendDataMessage(destinationAddress : JString; scAddress : JString; destinationPort : SmallInt; data : TJavaArray<Byte>; sentIntent : JPendingIntent; deliveryIntent : JPendingIntent) ; deprecated; cdecl;// (Ljava/lang/String;Ljava/lang/String;S[BLandroid/app/PendingIntent;Landroid/app/PendingIntent;)V A: $1
    procedure sendMultipartTextMessage(destinationAddress : JString; scAddress : JString; parts : JArrayList; sentIntents : JArrayList; deliveryIntents : JArrayList) ; deprecated; cdecl;// (Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;)V A: $1
    procedure sendTextMessage(destinationAddress : JString; scAddress : JString; text : JString; sentIntent : JPendingIntent; deliveryIntent : JPendingIntent) ; deprecated; cdecl;// (Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/app/PendingIntent;Landroid/app/PendingIntent;)V A: $1
  ...
  JSmsManager = interface(JObject)
    ['{3C3675C1-2FB7-4EFA-AB7A-628F283837EB}']
    function divideMessage(text : JString) : JArrayList; deprecated; cdecl;     // (Ljava/lang/String;)Ljava/util/ArrayList; A: $1
    procedure sendDataMessage(destinationAddress : JString; scAddress : JString; destinationPort : SmallInt; data : TJavaArray<Byte>; sentIntent : JPendingIntent; deliveryIntent : JPendingIntent) ; deprecated; cdecl;// (Ljava/lang/String;Ljava/lang/String;S[BLandroid/app/PendingIntent;Landroid/app/PendingIntent;)V A: $1
    procedure sendMultipartTextMessage(destinationAddress : JString; scAddress : JString; parts : JArrayList; sentIntents : JArrayList; deliveryIntents : JArrayList) ; deprecated; cdecl;// (Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;)V A: $1
    procedure sendTextMessage(destinationAddress : JString; scAddress : JString; text : JString; sentIntent : JPendingIntent; deliveryIntent : JPendingIntent) ; deprecated; cdecl;// (Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/app/PendingIntent;Landroid/app/PendingIntent;)V A: $1
