...
uses
  ...
  Androidapi.JNI.os,
  android.nfc.Tag,
  android.nfc.NfcAdapter_OnTagRemovedListener;

type
  JNfcAdapter = interface;

  JNfcAdapterClass = interface(JObjectClass)
    ['{970EFCCE-43B7-4997-8F2B-C374779BD26B}']
    ...
    function _GetACTION_TRANSACTION_DETECTED : JString; cdecl;                  //  A: $19
    function _GetEXTRA_ADAPTER_STATE : JString; cdecl;                          //  A: $19
    function _GetEXTRA_AID : JString; cdecl;                                    //  A: $19
    function _GetEXTRA_DATA : JString; cdecl;                                   //  A: $19
    ...
    function _GetEXTRA_SECURE_ELEMENT_NAME : JString; cdecl;                    //  A: $19
    ...
    function ignore(tag : JTag; debounceMs : Integer; tagRemovedListener : JNfcAdapter_OnTagRemovedListener; handler : JHandler) : boolean; cdecl;// (Landroid/nfc/Tag;ILandroid/nfc/NfcAdapter$OnTagRemovedListener;Landroid/os/Handler;)Z A: $1
    ...
    property ACTION_TRANSACTION_DETECTED : JString read _GetACTION_TRANSACTION_DETECTED;// Ljava/lang/String; A: $19
    property EXTRA_ADAPTER_STATE : JString read _GetEXTRA_ADAPTER_STATE;        // Ljava/lang/String; A: $19
    property EXTRA_AID : JString read _GetEXTRA_AID;                            // Ljava/lang/String; A: $19
    property EXTRA_DATA : JString read _GetEXTRA_DATA;                          // Ljava/lang/String; A: $19
    ...
    property EXTRA_SECURE_ELEMENT_NAME : JString read _GetEXTRA_SECURE_ELEMENT_NAME;// Ljava/lang/String; A: $19
  ...
  [JavaSignature('android/nfc/NfcAdapter$OnTagRemovedListener')]
  JNfcAdapter = interface(JObject)
    ['{8036A2FA-ED90-4EF8-AE87-B5D26141EA30}']
    function ignore(tag : JTag; debounceMs : Integer; tagRemovedListener : JNfcAdapter_OnTagRemovedListener; handler : JHandler) : boolean; cdecl;// (Landroid/nfc/Tag;ILandroid/nfc/NfcAdapter$OnTagRemovedListener;Landroid/os/Handler;)Z A: $1
    function invokeBeam(activity : JActivity) : boolean; cdecl;                 // (Landroid/app/Activity;)Z A: $1
    function isEnabled : boolean; cdecl;                                        // ()Z A: $1
    function isNdefPushEnabled : boolean; cdecl;                                // ()Z A: $1
...
const
  ...
  TJNfcAdapterACTION_TRANSACTION_DETECTED = 'android.nfc.action.TRANSACTION_DETECTED';
  TJNfcAdapterEXTRA_ADAPTER_STATE = 'android.nfc.extra.ADAPTER_STATE';
  TJNfcAdapterEXTRA_AID = 'android.nfc.extra.AID';
  TJNfcAdapterEXTRA_DATA = 'android.nfc.extra.DATA';
  ...
  TJNfcAdapterEXTRA_SECURE_ELEMENT_NAME = 'android.nfc.extra.SECURE_ELEMENT_NAME';
