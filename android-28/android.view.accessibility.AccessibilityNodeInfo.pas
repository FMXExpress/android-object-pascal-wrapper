...
type
  ...
  JAccessibilityNodeInfoClass = interface(JObjectClass)
    ['{1885B8DE-9078-4282-BCFA-D1DD82375959}']
    ...
    function _GetACTION_ARGUMENT_MOVE_WINDOW_X : JString; cdecl;                //  A: $19
    function _GetACTION_ARGUMENT_MOVE_WINDOW_Y : JString; cdecl;                //  A: $19
    function _GetACTION_ARGUMENT_PROGRESS_VALUE : JString; cdecl;               //  A: $19
    ...
    function _GetEXTRA_DATA_TEXT_CHARACTER_LOCATION_ARG_LENGTH : JString; cdecl;//  A: $19
    function _GetEXTRA_DATA_TEXT_CHARACTER_LOCATION_ARG_START_INDEX : JString; cdecl;//  A: $19
    function _GetEXTRA_DATA_TEXT_CHARACTER_LOCATION_KEY : JString; cdecl;       //  A: $19
    ...
    function getAvailableExtraData : JList; cdecl;                              // ()Ljava/util/List; A: $1
    ...
    function getPaneTitle : JCharSequence; cdecl;                               // ()Ljava/lang/CharSequence; A: $1
    ...
    function isShowingHintText : boolean; cdecl;                                // ()Z A: $1
    ...
    function refreshWithExtraData(extraDataKey : JString; args : JBundle) : boolean; cdecl;// (Ljava/lang/String;Landroid/os/Bundle;)Z A: $1
    ...
    procedure setAvailableExtraData(extraDataKeys : JList) ; cdecl;             // (Ljava/util/List;)V A: $1
    ...
    procedure setDrawingOrder(drawingOrderInParent : Integer) ; cdecl;          // (I)V A: $1
    ...
    procedure setHeading(isHeading : boolean) ; cdecl;                          // (Z)V A: $1
    procedure setHintText(hintText : JCharSequence) ; cdecl;                    // (Ljava/lang/CharSequence;)V A: $1
    procedure setImportantForAccessibility(important : boolean) ; cdecl;        // (Z)V A: $1
    ...
    procedure setPaneTitle(paneTitle : JCharSequence) ; cdecl;                  // (Ljava/lang/CharSequence;)V A: $1
    ...
    procedure setShowingHintText(showingHintText : boolean) ; cdecl;            // (Z)V A: $1
    ...
    property ACTION_ARGUMENT_MOVE_WINDOW_X : JString read _GetACTION_ARGUMENT_MOVE_WINDOW_X;// Ljava/lang/String; A: $19
    property ACTION_ARGUMENT_MOVE_WINDOW_Y : JString read _GetACTION_ARGUMENT_MOVE_WINDOW_Y;// Ljava/lang/String; A: $19
    property ACTION_ARGUMENT_PROGRESS_VALUE : JString read _GetACTION_ARGUMENT_PROGRESS_VALUE;// Ljava/lang/String; A: $19
    ...
    property EXTRA_DATA_TEXT_CHARACTER_LOCATION_ARG_LENGTH : JString read _GetEXTRA_DATA_TEXT_CHARACTER_LOCATION_ARG_LENGTH;// Ljava/lang/String; A: $19
    property EXTRA_DATA_TEXT_CHARACTER_LOCATION_ARG_START_INDEX : JString read _GetEXTRA_DATA_TEXT_CHARACTER_LOCATION_ARG_START_INDEX;// Ljava/lang/String; A: $19
    property EXTRA_DATA_TEXT_CHARACTER_LOCATION_KEY : JString read _GetEXTRA_DATA_TEXT_CHARACTER_LOCATION_KEY;// Ljava/lang/String; A: $19
  ...
  JAccessibilityNodeInfo = interface(JObject)
    ['{17E9D9B1-BBD5-40C4-8908-1AA7FCA8E90B}']
    function canOpenPopup : boolean; cdecl;                                     // ()Z A: $1
    function describeContents : Integer; cdecl;                                 // ()I A: $1
    function equals(&object : JObject) : boolean; cdecl;                        // (Ljava/lang/Object;)Z A: $1
    function findAccessibilityNodeInfosByText(text : JString) : JList; cdecl;   // (Ljava/lang/String;)Ljava/util/List; A: $1
  ...
  JAccessibilityWindowInfoClass = interface(JObjectClass)
    ['{86F18C72-B464-4501-8D53-BC365A962A9F}']
    function _GetCREATOR : JParcelable_Creator; cdecl;                          //  A: $19
    ...
    function _GetTYPE_SPLIT_SCREEN_DIVIDER : Integer; cdecl;                    //  A: $19
    function _GetTYPE_SYSTEM : Integer; cdecl;                                  //  A: $19
    function describeContents : Integer; cdecl;                                 // ()I A: $1
    function equals(obj : JObject) : boolean; cdecl;                            // (Ljava/lang/Object;)Z A: $1
    function getAnchor : JAccessibilityNodeInfo; cdecl;                         // ()Landroid/view/accessibility/AccessibilityNodeInfo; A: $1
    ...
    property TYPE_SPLIT_SCREEN_DIVIDER : Integer read _GetTYPE_SPLIT_SCREEN_DIVIDER;// I A: $19
  ...
  JAccessibilityWindowInfo = interface(JObject)
    ['{EBC784A5-7C6A-4ECD-B0A1-A04988EE5AEA}']
    function describeContents : Integer; cdecl;                                 // ()I A: $1
    function equals(obj : JObject) : boolean; cdecl;                            // (Ljava/lang/Object;)Z A: $1
    function getAnchor : JAccessibilityNodeInfo; cdecl;                         // ()Landroid/view/accessibility/AccessibilityNodeInfo; A: $1
    function getChild(&index : Integer) : JAccessibilityWindowInfo; cdecl;      // (I)Landroid/view/accessibility/AccessibilityWindowInfo; A: $1
...
const
  ...
  TJAccessibilityWindowInfoTYPE_SPLIT_SCREEN_DIVIDER = 5;
  ...
  TJAccessibilityNodeInfoACTION_ARGUMENT_MOVE_WINDOW_X = 'ACTION_ARGUMENT_MOVE_WINDOW_X';
  TJAccessibilityNodeInfoACTION_ARGUMENT_MOVE_WINDOW_Y = 'ACTION_ARGUMENT_MOVE_WINDOW_Y';
  TJAccessibilityNodeInfoACTION_ARGUMENT_PROGRESS_VALUE = 'android.view.accessibility.action.ARGUMENT_PROGRESS_VALUE';
  ...
  TJAccessibilityNodeInfoEXTRA_DATA_TEXT_CHARACTER_LOCATION_ARG_LENGTH = 'android.view.accessibility.extra.DATA_TEXT_CHARACTER_LOCATION_ARG_LENGTH';
  TJAccessibilityNodeInfoEXTRA_DATA_TEXT_CHARACTER_LOCATION_ARG_START_INDEX = 'android.view.accessibility.extra.DATA_TEXT_CHARACTER_LOCATION_ARG_START_INDEX';
  TJAccessibilityNodeInfoEXTRA_DATA_TEXT_CHARACTER_LOCATION_KEY = 'android.view.accessibility.extra.DATA_TEXT_CHARACTER_LOCATION_KEY';
