...
type
  ...
  JAudioDeviceInfoClass = interface(JObjectClass)
    ['{5122ADF7-CD94-4BB3-ACB0-623255E54DC9}']
    ...
    function _GetTYPE_HEARING_AID : Integer; cdecl;                             //  A: $19
    ...
    function _GetTYPE_USB_HEADSET : Integer; cdecl;                             //  A: $19
    ...
    property TYPE_HEARING_AID : Integer read _GetTYPE_HEARING_AID;              // I A: $19
    ...
    property TYPE_USB_HEADSET : Integer read _GetTYPE_USB_HEADSET;              // I A: $19
  ...
  JAudioDeviceInfo = interface(JObject)
    ['{5AF5327F-24EF-4D43-A5DC-44CF293AFF6B}']
    function equals(o : JObject) : boolean; cdecl;                              // (Ljava/lang/Object;)Z A: $1
    function getAddress : JString; cdecl;                                       // ()Ljava/lang/String; A: $1
    function getChannelCounts : TJavaArray<Integer>; cdecl;                     // ()[I A: $1
    function getChannelIndexMasks : TJavaArray<Integer>; cdecl;                 // ()[I A: $1
...
const
  ...
  TJAudioDeviceInfoTYPE_HEARING_AID = 23;
  ...
  TJAudioDeviceInfoTYPE_USB_HEADSET = 22;
