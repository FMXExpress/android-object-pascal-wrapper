...
type
  ...
  JTelecomManagerClass = interface(JObjectClass)
    ...
    function endCall : boolean; cdecl;                                          // ()Z A: $1
    ...
    function isTtySupported : boolean; cdecl;                                   // ()Z A: $1
    ...
    procedure acceptHandover(srcAddr : JUri; videoState : Integer; destAcct : JPhoneAccountHandle) ; cdecl;// (Landroid/net/Uri;ILandroid/telecom/PhoneAccountHandle;)V A: $1
