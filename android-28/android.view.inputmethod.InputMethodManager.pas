...
type
  ...
  JInputMethodManagerClass = interface(JObjectClass)
    ['{A3358963-4442-4863-B031-71E689CDA479}']
    ...
    function isWatchingCursor(view : JView) : boolean; deprecated; cdecl;       // (Landroid/view/View;)Z A: $1
    ...
    function shouldOfferSwitchingToNextInputMethod(imeToken : JIBinder) : boolean; deprecated; cdecl;// (Landroid/os/IBinder;)Z A: $1
    ...
    function switchToLastInputMethod(imeToken : JIBinder) : boolean; deprecated; cdecl;// (Landroid/os/IBinder;)Z A: $1
    function switchToNextInputMethod(imeToken : JIBinder; onlyCurrentIme : boolean) : boolean; deprecated; cdecl;// (Landroid/os/IBinder;Z)Z A: $1
    procedure dispatchKeyEventFromInputMethod(targetView : JView; event : JKeyEvent) ; cdecl;// (Landroid/view/View;Landroid/view/KeyEvent;)V A: $1
    ...
    procedure hideSoftInputFromInputMethod(token : JIBinder; flags : Integer) ; deprecated; cdecl;// (Landroid/os/IBinder;I)V A: $1
    procedure hideStatusIcon(imeToken : JIBinder) ; deprecated; cdecl;          // (Landroid/os/IBinder;)V A: $1
    ...
    procedure setInputMethod(token : JIBinder; id : JString) ; deprecated; cdecl;// (Landroid/os/IBinder;Ljava/lang/String;)V A: $1
    procedure setInputMethodAndSubtype(token : JIBinder; id : JString; subtype : JInputMethodSubtype) ; deprecated; cdecl;// (Landroid/os/IBinder;Ljava/lang/String;Landroid/view/inputmethod/InputMethodSubtype;)V A: $1
    ...
    procedure showSoftInputFromInputMethod(token : JIBinder; flags : Integer) ; deprecated; cdecl;// (Landroid/os/IBinder;I)V A: $1
    procedure showStatusIcon(imeToken : JIBinder; packageName : JString; iconId : Integer) ; deprecated; cdecl;// (Landroid/os/IBinder;Ljava/lang/String;I)V A: $1
    ...
    procedure updateCursor(view : JView; left : Integer; top : Integer; right : Integer; bottom : Integer) ; deprecated; cdecl;// (Landroid/view/View;IIII)V A: $1
    procedure updateCursorAnchorInfo(view : JView; cursorAnchorInfo : JCursorAnchorInfo) ; cdecl;// (Landroid/view/View;Landroid/view/inputmethod/CursorAnchorInfo;)V A: $1
  ...
  JInputMethodManager = interface(JObject)
    ['{7813D823-4745-43C7-851A-231A353823A6}']
    function getCurrentInputMethodSubtype : JInputMethodSubtype; cdecl;         // ()Landroid/view/inputmethod/InputMethodSubtype; A: $1
    function getEnabledInputMethodList : JList; cdecl;                          // ()Ljava/util/List; A: $1
    function getEnabledInputMethodSubtypeList(imi : JInputMethodInfo; allowsImplicitlySelectedSubtypes : boolean) : JList; cdecl;// (Landroid/view/inputmethod/InputMethodInfo;Z)Ljava/util/List; A: $1
    function getInputMethodList : JList; cdecl;                                 // ()Ljava/util/List; A: $1
