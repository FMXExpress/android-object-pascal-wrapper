...
type
  ...
  JDeviceAdminReceiverClass = interface(JObjectClass)
    ['{008C3E77-517D-417F-9C20-752A51486E1B}']
    ...
    function _GetEXTRA_TRANSFER_OWNERSHIP_ADMIN_EXTRAS_BUNDLE : JString; cdecl; //  A: $19
    ...
    procedure onNetworkLogsAvailable(context : JContext; intent : JIntent; batchToken : Int64; networkLogsCount : Integer) ; cdecl;// (Landroid/content/Context;Landroid/content/Intent;JI)V A: $1
    procedure onPasswordChanged(context : JContext; intent : JIntent) ; deprecated; cdecl; overload;// (Landroid/content/Context;Landroid/content/Intent;)V A: $1
    procedure onPasswordChanged(context : JContext; intent : JIntent; user : JUserHandle) ; cdecl; overload;// (Landroid/content/Context;Landroid/content/Intent;Landroid/os/UserHandle;)V A: $1
    procedure onPasswordExpiring(context : JContext; intent : JIntent) ; deprecated; cdecl; overload;// (Landroid/content/Context;Landroid/content/Intent;)V A: $1
    procedure onPasswordExpiring(context : JContext; intent : JIntent; user : JUserHandle) ; cdecl; overload;// (Landroid/content/Context;Landroid/content/Intent;Landroid/os/UserHandle;)V A: $1
    procedure onPasswordFailed(context : JContext; intent : JIntent) ; deprecated; cdecl; overload;// (Landroid/content/Context;Landroid/content/Intent;)V A: $1
    procedure onPasswordFailed(context : JContext; intent : JIntent; user : JUserHandle) ; cdecl; overload;// (Landroid/content/Context;Landroid/content/Intent;Landroid/os/UserHandle;)V A: $1
    procedure onPasswordSucceeded(context : JContext; intent : JIntent) ; deprecated; cdecl; overload;// (Landroid/content/Context;Landroid/content/Intent;)V A: $1
    procedure onPasswordSucceeded(context : JContext; intent : JIntent; user : JUserHandle) ; cdecl; overload;// (Landroid/content/Context;Landroid/content/Intent;Landroid/os/UserHandle;)V A: $1
    ...
    procedure onTransferAffiliatedProfileOwnershipComplete(context : JContext; user : JUserHandle) ; cdecl;// (Landroid/content/Context;Landroid/os/UserHandle;)V A: $1
    procedure onTransferOwnershipComplete(context : JContext; bundle : JPersistableBundle) ; cdecl;// (Landroid/content/Context;Landroid/os/PersistableBundle;)V A: $1
    procedure onUserAdded(context : JContext; intent : JIntent; newUser : JUserHandle) ; cdecl;// (Landroid/content/Context;Landroid/content/Intent;Landroid/os/UserHandle;)V A: $1
    procedure onUserRemoved(context : JContext; intent : JIntent; removedUser : JUserHandle) ; cdecl;// (Landroid/content/Context;Landroid/content/Intent;Landroid/os/UserHandle;)V A: $1
    procedure onUserStarted(context : JContext; intent : JIntent; startedUser : JUserHandle) ; cdecl;// (Landroid/content/Context;Landroid/content/Intent;Landroid/os/UserHandle;)V A: $1
    procedure onUserStopped(context : JContext; intent : JIntent; stoppedUser : JUserHandle) ; cdecl;// (Landroid/content/Context;Landroid/content/Intent;Landroid/os/UserHandle;)V A: $1
    procedure onUserSwitched(context : JContext; intent : JIntent; switchedUser : JUserHandle) ; cdecl;// (Landroid/content/Context;Landroid/content/Intent;Landroid/os/UserHandle;)V A: $1
    ...
    property EXTRA_TRANSFER_OWNERSHIP_ADMIN_EXTRAS_BUNDLE : JString read _GetEXTRA_TRANSFER_OWNERSHIP_ADMIN_EXTRAS_BUNDLE;// Ljava/lang/String; A: $19
  end;

  [JavaSignature('android/app/admin/DeviceAdminReceiver')]
  JDeviceAdminReceiver = interface(JObject)
    ['{6FA03152-9E0D-489A-B84E-55D7B48EACE4}']
    function getManager(context : JContext) : JDevicePolicyManager; cdecl;      // (Landroid/content/Context;)Landroid/app/admin/DevicePolicyManager; A: $1
    function getWho(context : JContext) : JComponentName; cdecl;                // (Landroid/content/Context;)Landroid/content/ComponentName; A: $1
    function onChoosePrivateKeyAlias(context : JContext; intent : JIntent; uid : Integer; uri : JUri; alias : JString) : JString; cdecl;// (Landroid/content/Context;Landroid/content/Intent;ILandroid/net/Uri;Ljava/lang/String;)Ljava/lang/String; A: $1
    function onDisableRequested(context : JContext; intent : JIntent) : JCharSequence; cdecl;// (Landroid/content/Context;Landroid/content/Intent;)Ljava/lang/CharSequence; A: $1
...
const
  ...
  TJDeviceAdminReceiverEXTRA_TRANSFER_OWNERSHIP_ADMIN_EXTRAS_BUNDLE = 'android.app.extra.TRANSFER_OWNERSHIP_ADMIN_EXTRAS_BUNDLE';
