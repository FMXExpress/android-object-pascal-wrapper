...
type
  ...
  JGnssMeasurementClass = interface(JObjectClass)
    ['{EA6CF302-CBF8-4442-ACCC-4FB0B3E867BC}']
    function _GetADR_STATE_CYCLE_SLIP : Integer; cdecl;                         //  A: $19
    function _GetADR_STATE_HALF_CYCLE_REPORTED : Integer; cdecl;                //  A: $19
    function _GetADR_STATE_HALF_CYCLE_RESOLVED : Integer; cdecl;                //  A: $19
    ...
    function _GetSTATE_GLO_TOD_KNOWN : Integer; cdecl;                          //  A: $19
    ...
    function _GetSTATE_TOW_KNOWN : Integer; cdecl;                              //  A: $19
    ...
    function getAutomaticGainControlLevelDb : Double; cdecl;                    // ()D A: $1
    function getCarrierCycles : Int64; deprecated; cdecl;                       // ()J A: $1
    function getCarrierFrequencyHz : Single; cdecl;                             // ()F A: $1
    function getCarrierPhase : Double; deprecated; cdecl;                       // ()D A: $1
    function getCarrierPhaseUncertainty : Double; deprecated; cdecl;            // ()D A: $1
    ...
    function hasAutomaticGainControlLevelDb : boolean; cdecl;                   // ()Z A: $1
    function hasCarrierCycles : boolean; deprecated; cdecl;                     // ()Z A: $1
    function hasCarrierFrequencyHz : boolean; cdecl;                            // ()Z A: $1
    function hasCarrierPhase : boolean; deprecated; cdecl;                      // ()Z A: $1
    function hasCarrierPhaseUncertainty : boolean; deprecated; cdecl;           // ()Z A: $1
    ...
    property ADR_STATE_HALF_CYCLE_REPORTED : Integer read _GetADR_STATE_HALF_CYCLE_REPORTED;// I A: $19
    property ADR_STATE_HALF_CYCLE_RESOLVED : Integer read _GetADR_STATE_HALF_CYCLE_RESOLVED;// I A: $19
    ...
    property STATE_GLO_TOD_KNOWN : Integer read _GetSTATE_GLO_TOD_KNOWN;        // I A: $19
    ...
    property STATE_TOW_KNOWN : Integer read _GetSTATE_TOW_KNOWN;                // I A: $19
  ...
  JGnssMeasurement = interface(JObject)
    ['{C4B5A383-A90C-43D8-9CCC-6CC365BE109E}']
    function describeContents : Integer; cdecl;                                 // ()I A: $1
    function getAccumulatedDeltaRangeMeters : Double; cdecl;                    // ()D A: $1
    function getAccumulatedDeltaRangeState : Integer; cdecl;                    // ()I A: $1
    function getAccumulatedDeltaRangeUncertaintyMeters : Double; cdecl;         // ()D A: $1
...
const
  ...
  TJGnssMeasurementADR_STATE_HALF_CYCLE_REPORTED = 16;
  TJGnssMeasurementADR_STATE_HALF_CYCLE_RESOLVED = 8;
  ...
  TJGnssMeasurementSTATE_GLO_TOD_KNOWN = 32768;
  ...
  TJGnssMeasurementSTATE_TOW_KNOWN = 16384;
