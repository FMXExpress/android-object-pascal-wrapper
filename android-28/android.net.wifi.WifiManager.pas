...
uses
  ...
  android.net.wifi.WifiManager_LocalOnlyHotspotCallback,
  Androidapi.JNI.os,
...
type
  ...
  JWifiManagerClass = interface(JObjectClass)
    ['{B5EC0ABC-F994-442E-97D0-037807B0E7C9}']
    ...
    function enableNetwork(netId : Integer; attemptConnect : boolean) : boolean; cdecl;// (IZ)Z A: $1
    ...
    function getPasspointConfigurations : JList; cdecl;                         // ()Ljava/util/List; A: $1
    ...
    function pingSupplicant : boolean; deprecated; cdecl;                       // ()Z A: $1
    ...
    function saveConfiguration : boolean; deprecated; cdecl;                    // ()Z A: $1
    function setWifiEnabled(enabled : boolean) : boolean; cdecl;                // (Z)Z A: $1
    function startScan : boolean; deprecated; cdecl;                            // ()Z A: $1
    function updateNetwork(config : JWifiConfiguration) : Integer; cdecl;       // (Landroid/net/wifi/WifiConfiguration;)I A: $1
    procedure addOrUpdatePasspointConfiguration(config : JPasspointConfiguration) ; cdecl;// (Landroid/net/wifi/hotspot2/PasspointConfiguration;)V A: $1
    procedure cancelWps(listener : JWifiManager_WpsCallback) ; deprecated; cdecl;// (Landroid/net/wifi/WifiManager$WpsCallback;)V A: $1
    procedure removePasspointConfiguration(fqdn : JString) ; cdecl;             // (Ljava/lang/String;)V A: $1
    ...
    procedure startLocalOnlyHotspot(callback : JWifiManager_LocalOnlyHotspotCallback; handler : JHandler) ; cdecl;// (Landroid/net/wifi/WifiManager$LocalOnlyHotspotCallback;Landroid/os/Handler;)V A: $1
    procedure startWps(config : JWpsInfo; listener : JWifiManager_WpsCallback) ; deprecated; cdecl;// (Landroid/net/wifi/WpsInfo;Landroid/net/wifi/WifiManager$WpsCallback;)V A: $1
  ...
  JWifiManager = interface(JObject)
    ['{63C8E675-4D41-4815-A383-B6E5C3ECE565}']
    function addNetwork(config : JWifiConfiguration) : Integer; cdecl;          // (Landroid/net/wifi/WifiConfiguration;)I A: $1
    function createMulticastLock(tag : JString) : JWifiManager_MulticastLock; cdecl;// (Ljava/lang/String;)Landroid/net/wifi/WifiManager$MulticastLock; A: $1
    function createWifiLock(lockType : Integer; tag : JString) : JWifiManager_WifiLock; cdecl; overload;// (ILjava/lang/String;)Landroid/net/wifi/WifiManager$WifiLock; A: $1
    function createWifiLock(tag : JString) : JWifiManager_WifiLock; cdecl; overload;// (Ljava/lang/String;)Landroid/net/wifi/WifiManager$WifiLock; A: $1
  ...
  JWifiManager_WifiLockClass = interface(JObjectClass)
    ['{1B7017D1-A81B-43BD-893B-979AEBFD2424}']
  ...
  JWifiManager_WifiLock = interface(JObject)
    ['{4AF6CD8A-DEF7-4F7F-9D18-C30D1449C573}']
    function isHeld : boolean; cdecl;                                           // ()Z A: $1
    function toString : JString; cdecl;                                         // ()Ljava/lang/String; A: $1
    procedure acquire ; cdecl;                                                  // ()V A: $1
    procedure release ; cdecl;                                                  // ()V A: $1
  ...
  JWifiManager_MulticastLockClass = interface(JObjectClass)
    ['{2926B025-D05E-4FC6-9321-E22F5FE803AF}']
    function isHeld : boolean; cdecl;                                           // ()Z A: $1
    function toString : JString; cdecl;                                         // ()Ljava/lang/String; A: $1
    procedure acquire ; cdecl;                                                  // ()V A: $1
    procedure release ; cdecl;                                                  // ()V A: $1
  ...
  JWifiManager_MulticastLock = interface(JObject)
    ['{E00F7CBD-C17A-4CE3-ACE5-69351EB0A32B}']
    function isHeld : boolean; cdecl;                                           // ()Z A: $1
    function toString : JString; cdecl;                                         // ()Ljava/lang/String; A: $1
    procedure acquire ; cdecl;                                                  // ()V A: $1
    procedure release ; cdecl;                                                  // ()V A: $1
