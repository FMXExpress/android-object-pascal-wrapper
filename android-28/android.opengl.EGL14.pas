...
type
  ...
  JEGL14Class = interface(JObjectClass)
    ['{474C2EAE-E2EC-4026-A9DE-4A6A22B79964}']
    ...
    function eglCreatePixmapSurface(JEGLDisplayparam0 : JEGLDisplay; JEGLConfigparam1 : JEGLConfig; Integerparam2 : Integer; TJavaArrayIntegerparam3 : TJavaArray<Integer>; Integerparam4 : Integer) : JEGLSurface; deprecated; cdecl;// (Landroid/opengl/EGLDisplay;Landroid/opengl/EGLConfig;I[II)Landroid/opengl/EGLSurface; A: $109
  ...
  JEGL14 = interface(JObject)
    ['{B8C7AE99-C0FD-40D6-AB68-6EB3B7FC091F}']
  end;
