...
type
  ...
  JNotification_WearableExtenderClass = interface(JObjectClass)
    ['{4844CB4D-99E0-4388-8EAB-3DE71CA196E8}']
    ...
    function getContentIcon : Integer; deprecated; cdecl;                       // ()I A: $1
    function getContentIconGravity : Integer; deprecated; cdecl;                // ()I A: $1
    function getContentIntentAvailableOffline : boolean; cdecl;                 // ()Z A: $1
    function getCustomContentHeight : Integer; deprecated; cdecl;               // ()I A: $1
    function getCustomSizePreset : Integer; deprecated; cdecl;                  // ()I A: $1
    ...
    function getGravity : Integer; deprecated; cdecl;                           // ()I A: $1
    function getHintAmbientBigPicture : boolean; cdecl;                         // ()Z A: $1
    function getHintAvoidBackgroundClipping : boolean; deprecated; cdecl;       // ()Z A: $1
    function getHintContentIntentLaunchesActivity : boolean; cdecl;             // ()Z A: $1
    function getHintHideIcon : boolean; deprecated; cdecl;                      // ()Z A: $1
    function getHintScreenTimeout : Integer; deprecated; cdecl;                 // ()I A: $1
    function getHintShowBackgroundOnly : boolean; deprecated; cdecl;            // ()Z A: $1
    ...
    function setContentIcon(icon : Integer) : JNotification_WearableExtender; deprecated; cdecl;// (I)Landroid/app/Notification$WearableExtender; A: $1
    function setContentIconGravity(contentIconGravity : Integer) : JNotification_WearableExtender; deprecated; cdecl;// (I)Landroid/app/Notification$WearableExtender; A: $1
    ...
    function setCustomContentHeight(height : Integer) : JNotification_WearableExtender; deprecated; cdecl;// (I)Landroid/app/Notification$WearableExtender; A: $1
    function setCustomSizePreset(sizePreset : Integer) : JNotification_WearableExtender; deprecated; cdecl;// (I)Landroid/app/Notification$WearableExtender; A: $1
    ...
    function setGravity(gravity : Integer) : JNotification_WearableExtender; deprecated; cdecl;// (I)Landroid/app/Notification$WearableExtender; A: $1
    ...
    function setHintAvoidBackgroundClipping(hintAvoidBackgroundClipping : boolean) : JNotification_WearableExtender; deprecated; cdecl;// (Z)Landroid/app/Notification$WearableExtender; A: $1
    ...
    function setHintHideIcon(hintHideIcon : boolean) : JNotification_WearableExtender; deprecated; cdecl;// (Z)Landroid/app/Notification$WearableExtender; A: $1
    function setHintScreenTimeout(timeout : Integer) : JNotification_WearableExtender; deprecated; cdecl;// (I)Landroid/app/Notification$WearableExtender; A: $1
    function setHintShowBackgroundOnly(hintShowBackgroundOnly : boolean) : JNotification_WearableExtender; deprecated; cdecl;// (Z)Landroid/app/Notification$WearableExtender; A: $1
  ...
  JNotification_WearableExtender = interface(JObject)
    ['{5C8C19B4-7733-4D70-BEBA-78A7738CA00A}']
    function addAction(action : JNotification_Action) : JNotification_WearableExtender; cdecl;// (Landroid/app/Notification$Action;)Landroid/app/Notification$WearableExtender; A: $1
    function addActions(actions : JList) : JNotification_WearableExtender; cdecl;// (Ljava/util/List;)Landroid/app/Notification$WearableExtender; A: $1
    function addPage(page : JNotification) : JNotification_WearableExtender; cdecl;// (Landroid/app/Notification;)Landroid/app/Notification$WearableExtender; A: $1
    function addPages(pages : JList) : JNotification_WearableExtender; cdecl;   // (Ljava/util/List;)Landroid/app/Notification$WearableExtender; A: $1
