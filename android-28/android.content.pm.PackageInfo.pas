...
type
  ...
  JPackageInfoClass = interface(JObjectClass)
    ['{9EE46DA1-8C1F-44C2-8FB7-2B8DF9034433}']
    ...
    function _GetsigningInfo : JSigningInfo; cdecl;                             //  A: $1
    ...
    procedure _SetsigningInfo(Value : JSigningInfo) ; cdecl;                    //  A: $1
    ...
    procedure setLongVersionCode(longVersionCode : Int64) ; cdecl;              // (J)V A: $1
    ...
    property signingInfo : JSigningInfo read _GetsigningInfo write _SetsigningInfo;// Landroid/content/pm/SigningInfo; A: $1
  ...
  JPackageInfo = interface(JObject)
    ['{3AEB7E83-869D-4E62-9BCD-ADB8B6AF4980}']
    function _Getactivities : TJavaArray<JActivityInfo>; cdecl;                 //  A: $1
    function _GetapplicationInfo : JApplicationInfo; cdecl;                     //  A: $1
    function _GetbaseRevisionCode : Integer; cdecl;                             //  A: $1
    function _GetconfigPreferences : TJavaArray<JConfigurationInfo>; cdecl;     //  A: $1
