...
type
  ...
  JLocaleClass = interface(JObjectClass)
    ['{45FC4240-BAAB-4C19-ACA7-F65BE522A4F1}']
    ...
    function filter(priorityList : JList; locales : JCollection) : JList; cdecl; overload;// (Ljava/util/List;Ljava/util/Collection;)Ljava/util/List; A: $9
    function filter(priorityList : JList; locales : JCollection; mode : JLocale_FilteringMode) : JList; cdecl; overload;// (Ljava/util/List;Ljava/util/Collection;Ljava/util/Locale$FilteringMode;)Ljava/util/List; A: $9
    function filterTags(priorityList : JList; tags : JCollection) : JList; cdecl; overload;// (Ljava/util/List;Ljava/util/Collection;)Ljava/util/List; A: $9
    function filterTags(priorityList : JList; tags : JCollection; mode : JLocale_FilteringMode) : JList; cdecl; overload;// (Ljava/util/List;Ljava/util/Collection;Ljava/util/Locale$FilteringMode;)Ljava/util/List; A: $9
    ...
    function getDisplayScript(inLocale : JLocale) : JString; cdecl; overload;   // (Ljava/util/Locale;)Ljava/lang/String; A: $1
    function getDisplayVariant : JString; cdecl; overload;                      // ()Ljava/lang/String; A: $1
    function getDisplayVariant(inLocale : JLocale) : JString; cdecl; overload;  // (Ljava/util/Locale;)Ljava/lang/String; A: $1
    ...
    function hasExtensions : boolean; cdecl;                                    // ()Z A: $1
    ...
    function lookup(priorityList : JList; locales : JCollection) : JLocale; cdecl;// (Ljava/util/List;Ljava/util/Collection;)Ljava/util/Locale; A: $9
    function lookupTag(priorityList : JList; tags : JCollection) : JString; cdecl;// (Ljava/util/List;Ljava/util/Collection;)Ljava/lang/String; A: $9
    function stripExtensions : JLocale; cdecl;                                  // ()Ljava/util/Locale; A: $1
  ...
  [JavaSignature('java/util/Locale$LanguageRange')]
  JLocale = interface(JObject)
    ['{5111A05E-1B5A-4D78-A1CC-DCF5394C72D2}']
    function clone : JObject; cdecl;                                            // ()Ljava/lang/Object; A: $1
    function equals(obj : JObject) : boolean; cdecl;                            // (Ljava/lang/Object;)Z A: $1
    function getCountry : JString; cdecl;                                       // ()Ljava/lang/String; A: $1
    function getDisplayCountry : JString; cdecl; overload;                      // ()Ljava/lang/String; A: $1
