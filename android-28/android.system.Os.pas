...
type
  ...
  JOsClass = interface(JObjectClass)
    ['{A54ED1FB-3023-4056-8546-EE402A65DE33}']
    ...
    function sendfile(outFd : JFileDescriptor; inFd : JFileDescriptor; offset : JInt64Ref; byteCount : Int64) : Int64; cdecl;// (Ljava/io/FileDescriptor;Ljava/io/FileDescriptor;Landroid/system/Int64Ref;J)J A: $9
  ...
  JOs = interface(JObject)
    ['{A0239917-7901-468F-9587-A33A6E552D14}']
  end;
