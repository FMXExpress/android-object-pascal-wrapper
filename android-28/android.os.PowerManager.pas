...
type
  ...
  JPowerManagerClass = interface(JObjectClass)
    ['{1341B126-8750-4423-AF48-171EA52AD1B2}']
    ...
    function _GetLOCATION_MODE_ALL_DISABLED_WHEN_SCREEN_OFF : Integer; cdecl;   //  A: $19
    function _GetLOCATION_MODE_FOREGROUND_ONLY : Integer; cdecl;                //  A: $19
    function _GetLOCATION_MODE_GPS_DISABLED_WHEN_SCREEN_OFF : Integer; cdecl;   //  A: $19
    function _GetLOCATION_MODE_NO_CHANGE : Integer; cdecl;                      //  A: $19
    ...
    function getLocationPowerSaveMode : Integer; cdecl;                         // ()I A: $1
    ...
    property LOCATION_MODE_ALL_DISABLED_WHEN_SCREEN_OFF : Integer read _GetLOCATION_MODE_ALL_DISABLED_WHEN_SCREEN_OFF;// I A: $19
    property LOCATION_MODE_FOREGROUND_ONLY : Integer read _GetLOCATION_MODE_FOREGROUND_ONLY;// I A: $19
    property LOCATION_MODE_GPS_DISABLED_WHEN_SCREEN_OFF : Integer read _GetLOCATION_MODE_GPS_DISABLED_WHEN_SCREEN_OFF;// I A: $19
    property LOCATION_MODE_NO_CHANGE : Integer read _GetLOCATION_MODE_NO_CHANGE;// I A: $19
  ...
  JPowerManager = interface(JObject)
    ['{2C06C288-82F9-45F0-9986-9752A3F5BAF1}']
    function getLocationPowerSaveMode : Integer; cdecl;                         // ()I A: $1
    function isDeviceIdleMode : boolean; cdecl;                                 // ()Z A: $1
    function isIgnoringBatteryOptimizations(packageName : JString) : boolean; cdecl;// (Ljava/lang/String;)Z A: $1
    function isInteractive : boolean; cdecl;                                    // ()Z A: $1
...
const
  ...
  TJPowerManagerLOCATION_MODE_ALL_DISABLED_WHEN_SCREEN_OFF = 2;
  TJPowerManagerLOCATION_MODE_FOREGROUND_ONLY = 3;
  TJPowerManagerLOCATION_MODE_GPS_DISABLED_WHEN_SCREEN_OFF = 1;
  TJPowerManagerLOCATION_MODE_NO_CHANGE = 0;
