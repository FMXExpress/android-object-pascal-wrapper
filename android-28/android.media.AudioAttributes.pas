...
type
  ...
  JAudioAttributesClass = interface(JObjectClass)
    ['{8660BEF0-1E91-405C-A2BF-0F92D61BA866}']
    ...
    function _GetFLAG_LOW_LATENCY : Integer; cdecl;                             //  A: $19
    ...
    function _GetUSAGE_ASSISTANT : Integer; cdecl;                              //  A: $19
    ...
    function getVolumeControlStream : Integer; cdecl;                           // ()I A: $1
    ...
    property FLAG_LOW_LATENCY : Integer read _GetFLAG_LOW_LATENCY;              // I A: $19
    ...
    property USAGE_ASSISTANT : Integer read _GetUSAGE_ASSISTANT;                // I A: $19
  ...
  JAudioAttributes = interface(JObject)
    ['{2F78FB42-E9AF-4B13-BED6-F3185275C95C}']
    function describeContents : Integer; cdecl;                                 // ()I A: $1
    function equals(o : JObject) : boolean; cdecl;                              // (Ljava/lang/Object;)Z A: $1
    function getContentType : Integer; cdecl;                                   // ()I A: $1
    function getFlags : Integer; cdecl;                                         // ()I A: $1
...
const
  ...
  TJAudioAttributesFLAG_LOW_LATENCY = 256;
  ...
  TJAudioAttributesUSAGE_ASSISTANT = 16;
