...
type
  ...
  JMediaCodecClass = interface(JObjectClass)
    ['{C55F8D31-22E1-4715-B6CB-B7685704E5E3}']
    ...
    function dequeueInputBuffer(timeoutUs : Int64) : Integer; cdecl;            // (J)I A: $1
    function dequeueOutputBuffer(info : JMediaCodec_BufferInfo; timeoutUs : Int64) : Integer; cdecl;// (Landroid/media/MediaCodec$BufferInfo;J)I A: $1
    ...
    function getInputFormat : JMediaFormat; cdecl;                              // ()Landroid/media/MediaFormat; A: $1
    ...
    function getName : JString; cdecl;                                          // ()Ljava/lang/String; A: $101
    ...
    function getOutputFormat : JMediaFormat; cdecl; overload;                   // ()Landroid/media/MediaFormat; A: $1
    function getOutputFormat(&index : Integer) : JMediaFormat; cdecl; overload; // (I)Landroid/media/MediaFormat; A: $1
    ...
    procedure queueInputBuffer(&index : Integer; offset : Integer; size : Integer; presentationTimeUs : Int64; flags : Integer) ; cdecl;// (IIIJI)V A: $1
    procedure queueSecureInputBuffer(&index : Integer; offset : Integer; info : JMediaCodec_CryptoInfo; presentationTimeUs : Int64; flags : Integer) ; cdecl;// (IILandroid/media/MediaCodec$CryptoInfo;JI)V A: $1
    procedure release ; cdecl;                                                  // ()V A: $1
    procedure releaseOutputBuffer(&index : Integer; render : boolean) ; cdecl; overload;// (IZ)V A: $1
    procedure releaseOutputBuffer(&index : Integer; renderTimestampNs : Int64) ; cdecl; overload;// (IJ)V A: $1
    ...
    procedure setParameters(params : JBundle) ; cdecl;                          // (Landroid/os/Bundle;)V A: $1
    procedure setVideoScalingMode(Integerparam0 : Integer) ; cdecl;             // (I)V A: $101
    procedure signalEndOfInputStream ; cdecl;                                   // ()V A: $101
  ...
  JMediaCodec = interface(JObject)
    ['{3854DD1C-1425-46D9-B20B-5D40C7F73093}']
    function dequeueInputBuffer(timeoutUs : Int64) : Integer; cdecl;            // (J)I A: $1
    function dequeueOutputBuffer(info : JMediaCodec_BufferInfo; timeoutUs : Int64) : Integer; cdecl;// (Landroid/media/MediaCodec$BufferInfo;J)I A: $1
    function getCodecInfo : JMediaCodecInfo; cdecl;                             // ()Landroid/media/MediaCodecInfo; A: $1
    function getInputBuffer(&index : Integer) : JByteBuffer; cdecl;             // (I)Ljava/nio/ByteBuffer; A: $1
  ...
  JMediaCodec_CallbackClass = interface(JObjectClass)
    ['{C9C66890-991D-47E2-8889-87AFAE7B26B5}']
  ...
  JMediaCodec_Callback = interface(JObject)
    ['{4EB3BA95-C732-472D-A999-51B6E188A99C}']
    procedure onError(JMediaCodecparam0 : JMediaCodec; JMediaCodec_CodecExceptionparam1 : JMediaCodec_CodecException) ; cdecl;// (Landroid/media/MediaCodec;Landroid/media/MediaCodec$CodecException;)V A: $401
    procedure onInputBufferAvailable(JMediaCodecparam0 : JMediaCodec; Integerparam1 : Integer) ; cdecl;// (Landroid/media/MediaCodec;I)V A: $401
    procedure onOutputBufferAvailable(JMediaCodecparam0 : JMediaCodec; Integerparam1 : Integer; JMediaCodec_BufferInfoparam2 : JMediaCodec_BufferInfo) ; cdecl;// (Landroid/media/MediaCodec;ILandroid/media/MediaCodec$BufferInfo;)V A: $401
    procedure onOutputFormatChanged(JMediaCodecparam0 : JMediaCodec; JMediaFormatparam1 : JMediaFormat) ; cdecl;// (Landroid/media/MediaCodec;Landroid/media/MediaFormat;)V A: $401
  ...
  JMediaCodec_OnFrameRenderedListenerClass = interface(JObjectClass)
    ['{F6942243-2E68-4E38-94C1-A2C015F189A9}']
  ...
  JMediaCodec_OnFrameRenderedListener = interface(JObject)
    ['{B9C8B918-39B6-46B2-9A62-ECD012F70F76}']
    procedure onFrameRendered(JMediaCodecparam0 : JMediaCodec; Int64param1 : Int64; Int64param2 : Int64) ; cdecl;// (Landroid/media/MediaCodec;JJ)V A: $401
  end;
