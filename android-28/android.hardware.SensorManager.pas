...
uses
  ...
  android.hardware.SensorManager_DynamicSensorCallback,
...
type
  ...
  JSensorManagerClass = interface(JObjectClass)
    ['{47B80E40-475B-4DF4-9944-2562F1A55B42}']
    ...
    function _GetSENSOR_STATUS_NO_CONTACT : Integer; cdecl;                     //  A: $19
    ...
    function createDirectChannel(mem : JHardwareBuffer) : JSensorDirectChannel; cdecl; overload;// (Landroid/hardware/HardwareBuffer;)Landroid/hardware/SensorDirectChannel; A: $1
    function createDirectChannel(mem : JMemoryFile) : JSensorDirectChannel; cdecl; overload;// (Landroid/os/MemoryFile;)Landroid/hardware/SensorDirectChannel; A: $1
    function flush(listener : JSensorEventListener) : boolean; cdecl;           // (Landroid/hardware/SensorEventListener;)Z A: $1
    function getAltitude(p0 : Single; p : Single) : Single; cdecl;              // (FF)F A: $9
    function getDefaultSensor(&type : Integer) : JSensor; cdecl; overload;      // (I)Landroid/hardware/Sensor; A: $1
    function getDefaultSensor(&type : Integer; wakeUp : boolean) : JSensor; cdecl; overload;// (IZ)Landroid/hardware/Sensor; A: $1
    function getDynamicSensorList(&type : Integer) : JList; cdecl;              // (I)Ljava/util/List; A: $1
    ...
    function isDynamicSensorDiscoverySupported : boolean; cdecl;                // ()Z A: $1
    function registerListener(listener : JSensorEventListener; sensor : JSensor; samplingPeriodUs : Integer) : boolean; cdecl; overload;// (Landroid/hardware/SensorEventListener;Landroid/hardware/Sensor;I)Z A: $1
    function registerListener(listener : JSensorEventListener; sensor : JSensor; samplingPeriodUs : Integer; handler : JHandler) : boolean; cdecl; overload;// (Landroid/hardware/SensorEventListener;Landroid/hardware/Sensor;ILandroid/os/Handler;)Z A: $1
    function registerListener(listener : JSensorEventListener; sensor : JSensor; samplingPeriodUs : Integer; maxReportLatencyUs : Integer) : boolean; cdecl; overload;// (Landroid/hardware/SensorEventListener;Landroid/hardware/Sensor;II)Z A: $1
    function registerListener(listener : JSensorEventListener; sensor : JSensor; samplingPeriodUs : Integer; maxReportLatencyUs : Integer; handler : JHandler) : boolean; cdecl; overload;// (Landroid/hardware/SensorEventListener;Landroid/hardware/Sensor;IILandroid/os/Handler;)Z A: $1
    ...
    procedure registerDynamicSensorCallback(callback : JSensorManager_DynamicSensorCallback) ; cdecl; overload;// (Landroid/hardware/SensorManager$DynamicSensorCallback;)V A: $1
    procedure registerDynamicSensorCallback(callback : JSensorManager_DynamicSensorCallback; handler : JHandler) ; cdecl; overload;// (Landroid/hardware/SensorManager$DynamicSensorCallback;Landroid/os/Handler;)V A: $1
    procedure unregisterDynamicSensorCallback(callback : JSensorManager_DynamicSensorCallback) ; cdecl;// (Landroid/hardware/SensorManager$DynamicSensorCallback;)V A: $1
    ...
    property SENSOR_STATUS_NO_CONTACT : Integer read _GetSENSOR_STATUS_NO_CONTACT;// I A: $19
  ...
  JSensorManager = interface(JObject)
    ['{8FF2DAD2-DC17-4C13-84DC-F32D674FAA12}']
    function cancelTriggerSensor(listener : JTriggerEventListener; sensor : JSensor) : boolean; cdecl;// (Landroid/hardware/TriggerEventListener;Landroid/hardware/Sensor;)Z A: $1
    function createDirectChannel(mem : JHardwareBuffer) : JSensorDirectChannel; cdecl; overload;// (Landroid/hardware/HardwareBuffer;)Landroid/hardware/SensorDirectChannel; A: $1
    function createDirectChannel(mem : JMemoryFile) : JSensorDirectChannel; cdecl; overload;// (Landroid/os/MemoryFile;)Landroid/hardware/SensorDirectChannel; A: $1
    function flush(listener : JSensorEventListener) : boolean; cdecl;           // (Landroid/hardware/SensorEventListener;)Z A: $1
...
const
  ...
  TJSensorManagerSENSOR_STATUS_NO_CONTACT = -1;
