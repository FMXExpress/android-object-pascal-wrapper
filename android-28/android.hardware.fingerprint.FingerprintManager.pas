...
type
  ...
  JFingerprintManagerClass = interface(JObjectClass)
    ['{06950FF5-D0FF-4939-81D2-FC74D6B2AA3C}']
    ...
    function _GetFINGERPRINT_ERROR_HW_NOT_PRESENT : Integer; cdecl;             //  A: $19
    ...
    function _GetFINGERPRINT_ERROR_NO_FINGERPRINTS : Integer; cdecl;            //  A: $19
    ...
    function hasEnrolledFingerprints : boolean; deprecated; cdecl;              // ()Z A: $1
    function isHardwareDetected : boolean; deprecated; cdecl;                   // ()Z A: $1
    procedure authenticate(crypto : JFingerprintManager_CryptoObject; cancel : JCancellationSignal; flags : Integer; callback : JFingerprintManager_AuthenticationCallback; handler : JHandler) ; deprecated; cdecl;// (Landroid/hardware/fingerprint/FingerprintManager$CryptoObject;Landroid/os/CancellationSignal;ILandroid/hardware/fingerprint/FingerprintManager$AuthenticationCallback;Landroid/os/Handler;)V A: $1
    ...
    property FINGERPRINT_ERROR_HW_NOT_PRESENT : Integer read _GetFINGERPRINT_ERROR_HW_NOT_PRESENT;// I A: $19
    ...
    property FINGERPRINT_ERROR_NO_FINGERPRINTS : Integer read _GetFINGERPRINT_ERROR_NO_FINGERPRINTS;// I A: $19
  ...
  JFingerprintManager = interface(JObject)
    ['{728E4B2D-8895-42D3-A8EC-48B281C0B391}']
    function hasEnrolledFingerprints : boolean; deprecated; cdecl;              // ()Z A: $1
    function isHardwareDetected : boolean; deprecated; cdecl;                   // ()Z A: $1
    procedure authenticate(crypto : JFingerprintManager_CryptoObject; cancel : JCancellationSignal; flags : Integer; callback : JFingerprintManager_AuthenticationCallback; handler : JHandler) ; deprecated; cdecl;// (Landroid/hardware/fingerprint/FingerprintManager$CryptoObject;Landroid/os/CancellationSignal;ILandroid/hardware/fingerprint/FingerprintManager$AuthenticationCallback;Landroid/os/Handler;)V A: $1
  end;
...
const
  ...
  TJFingerprintManagerFINGERPRINT_ERROR_HW_NOT_PRESENT = 12;
  ...
  TJFingerprintManagerFINGERPRINT_ERROR_NO_FINGERPRINTS = 11;
