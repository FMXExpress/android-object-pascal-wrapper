...
type
  ...
  JProcessClass = interface(JObjectClass)
    ['{A1FD647A-445B-44BB-9376-77A8EF11711E}']
    ...
    function _GetTHREAD_PRIORITY_VIDEO : Integer; cdecl;                        //  A: $19
    function getElapsedCpuTime : Int64; cdecl;                                  // ()J A: $119
    function getExclusiveCores : TJavaArray<Integer>; cdecl;                    // ()[I A: $119
    function getGidForName(JStringparam0 : JString) : Integer; cdecl;           // (Ljava/lang/String;)I A: $119
    function getStartElapsedRealtime : Int64; cdecl;                            // ()J A: $19
    function getStartUptimeMillis : Int64; cdecl;                               // ()J A: $19
    ...
    function is64Bit : boolean; cdecl;                                          // ()Z A: $19
    function isApplicationUid(uid : Integer) : boolean; cdecl;                  // (I)Z A: $9
    function isIsolated : boolean; cdecl;                                       // ()Z A: $19
    function myPid : Integer; cdecl;                                            // ()I A: $19
    function myTid : Integer; cdecl;                                            // ()I A: $19
    function myUid : Integer; cdecl;                                            // ()I A: $19
    function myUserHandle : JUserHandle; cdecl;                                 // ()Landroid/os/UserHandle; A: $9
    ...
    property THREAD_PRIORITY_VIDEO : Integer read _GetTHREAD_PRIORITY_VIDEO;    // I A: $19
  end;

  [JavaSignature('android/os/Process')]
  JProcess = interface(JObject)
    ['{8E42FAAB-49E5-48DC-A89F-3B03FE30977F}']
  end;
...
const
  ...
  TJProcessTHREAD_PRIORITY_VIDEO = -10;
