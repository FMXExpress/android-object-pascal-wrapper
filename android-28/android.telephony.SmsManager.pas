...
type
  ...
  JSmsManagerClass = interface(JObjectClass)
    ['{58A4EF49-44F3-4D86-A05E-54DF9B885B61}']
    ...
    function _GetRESULT_ERROR_LIMIT_EXCEEDED : Integer; cdecl;                  //  A: $19
    ...
    function _GetRESULT_ERROR_SHORT_CODE_NEVER_ALLOWED : Integer; cdecl;        //  A: $19
    function _GetRESULT_ERROR_SHORT_CODE_NOT_ALLOWED : Integer; cdecl;          //  A: $19
    ...
    function createAppSpecificSmsToken(intent : JPendingIntent) : JString; cdecl;// (Landroid/app/PendingIntent;)Ljava/lang/String; A: $1
    ...
    procedure sendTextMessageWithoutPersisting(destinationAddress : JString; scAddress : JString; text : JString; sentIntent : JPendingIntent; deliveryIntent : JPendingIntent) ; cdecl;// (Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/app/PendingIntent;Landroid/app/PendingIntent;)V A: $1
    ...
    property RESULT_ERROR_LIMIT_EXCEEDED : Integer read _GetRESULT_ERROR_LIMIT_EXCEEDED;// I A: $19
    ...
    property RESULT_ERROR_SHORT_CODE_NEVER_ALLOWED : Integer read _GetRESULT_ERROR_SHORT_CODE_NEVER_ALLOWED;// I A: $19
    property RESULT_ERROR_SHORT_CODE_NOT_ALLOWED : Integer read _GetRESULT_ERROR_SHORT_CODE_NOT_ALLOWED;// I A: $19
  ...
  JSmsManager = interface(JObject)
    ['{1A86B7C9-63F8-434B-B1D0-DE319D87B6A7}']
    function createAppSpecificSmsToken(intent : JPendingIntent) : JString; cdecl;// (Landroid/app/PendingIntent;)Ljava/lang/String; A: $1
    function divideMessage(text : JString) : JArrayList; cdecl;                 // (Ljava/lang/String;)Ljava/util/ArrayList; A: $1
    function getCarrierConfigValues : JBundle; cdecl;                           // ()Landroid/os/Bundle; A: $1
    function getSubscriptionId : Integer; cdecl;                                // ()I A: $1
...
const
  ...
  TJSmsManagerRESULT_ERROR_LIMIT_EXCEEDED = 5;
  TJSmsManagerRESULT_ERROR_NO_SERVICE = 4;
  TJSmsManagerRESULT_ERROR_NULL_PDU = 3;
  TJSmsManagerRESULT_ERROR_RADIO_OFF = 2;
  TJSmsManagerRESULT_ERROR_SHORT_CODE_NEVER_ALLOWED = 8;
  TJSmsManagerRESULT_ERROR_SHORT_CODE_NOT_ALLOWED = 7;
