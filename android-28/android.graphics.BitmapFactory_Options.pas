...
type
  ...
  JBitmapFactory_OptionsClass = interface(JObjectClass)
    ['{07D92ADE-2F85-496D-B447-0C90F509AD78}']
    ...
    function _GetinPreferredColorSpace : JColorSpace; cdecl;                    //  A: $1
    ...
    function _GetoutColorSpace : JColorSpace; cdecl;                            //  A: $1
    function _GetoutConfig : JBitmap_Config; cdecl;                             //  A: $1
    ...
    procedure _SetinPreferredColorSpace(Value : JColorSpace) ; cdecl;           //  A: $1
    ...
    procedure _SetoutColorSpace(Value : JColorSpace) ; cdecl;                   //  A: $1
    procedure _SetoutConfig(Value : JBitmap_Config) ; cdecl;                    //  A: $1
    ...
    procedure requestCancelDecode ; deprecated; cdecl;                          // ()V A: $1
    ...
    property inPreferredColorSpace : JColorSpace read _GetinPreferredColorSpace write _SetinPreferredColorSpace;// Landroid/graphics/ColorSpace; A: $1
    ...
    property outColorSpace : JColorSpace read _GetoutColorSpace write _SetoutColorSpace;// Landroid/graphics/ColorSpace; A: $1
    property outConfig : JBitmap_Config read _GetoutConfig write _SetoutConfig; // Landroid/graphics/Bitmap$Config; A: $1
  ...
  JBitmapFactory_Options = interface(JObject)
    ['{F7514439-D9F8-432A-86E8-7C23AF8ECEFA}']
    function _GetinBitmap : JBitmap; cdecl;                                     //  A: $1
    function _GetinDensity : Integer; cdecl;                                    //  A: $1
    function _GetinDither : boolean; cdecl;                                     //  A: $1
    function _GetinInputShareable : boolean; cdecl;                             //  A: $1
