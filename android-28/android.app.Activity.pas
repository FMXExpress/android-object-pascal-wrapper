...
type
  ...
  JActivityClass = interface(JObjectClass)
    ['{07FD8450-C4BB-4037-B9F8-646A513598BA}']
    ...
    function getFragmentManager : JFragmentManager; deprecated; cdecl;          // ()Landroid/app/FragmentManager; A: $1
    ...
    function getLoaderManager : JLoaderManager; deprecated; cdecl;              // ()Landroid/app/LoaderManager; A: $1
    ...
    function onCreateThumbnail(outBitmap : JBitmap; canvas : JCanvas) : boolean; deprecated; cdecl;// (Landroid/graphics/Bitmap;Landroid/graphics/Canvas;)Z A: $1
    ...
    procedure onAttachFragment(fragment : JFragment) ; deprecated; cdecl;       // (Landroid/app/Fragment;)V A: $1
    ...
    procedure setShowWhenLocked(showWhenLocked : boolean) ; cdecl;              // (Z)V A: $1
    ...
    procedure setTurnScreenOn(turnScreenOn : boolean) ; cdecl;                  // (Z)V A: $1
    ...
    procedure startActivityFromFragment(fragment : JFragment; intent : JIntent; requestCode : Integer) ; deprecated; cdecl; overload;// (Landroid/app/Fragment;Landroid/content/Intent;I)V A: $1
    procedure startActivityFromFragment(fragment : JFragment; intent : JIntent; requestCode : Integer; options : JBundle) ; deprecated; cdecl; overload;// (Landroid/app/Fragment;Landroid/content/Intent;ILandroid/os/Bundle;)V A: $1
  ...
  JActivity = interface(JObject)
    ['{13877A1D-40DF-47CC-8E02-4472E105B279}']
    function createPendingResult(requestCode : Integer; data : JIntent; flags : Integer) : JPendingIntent; cdecl;// (ILandroid/content/Intent;I)Landroid/app/PendingIntent; A: $1
    function dispatchGenericMotionEvent(ev : JMotionEvent) : boolean; cdecl;    // (Landroid/view/MotionEvent;)Z A: $1
    function dispatchKeyEvent(event : JKeyEvent) : boolean; cdecl;              // (Landroid/view/KeyEvent;)Z A: $1
    function dispatchKeyShortcutEvent(event : JKeyEvent) : boolean; cdecl;      // (Landroid/view/KeyEvent;)Z A: $1
  ...
  JFragmentClass = interface(JObjectClass)
    ['{350802E6-DD4E-4935-A3AF-30AFEBE9D104}']
  ...
  JFragment = interface(JObject)
    ['{9002ADCE-FC66-4766-B8E3-4391AAE9D410}']
    function getAllowEnterTransitionOverlap : boolean; cdecl;                   // ()Z A: $1
    function getAllowReturnTransitionOverlap : boolean; cdecl;                  // ()Z A: $1
    function getContext : JContext; cdecl;                                      // ()Landroid/content/Context; A: $1
    function getEnterTransition : JTransition; cdecl;                           // ()Landroid/transition/Transition; A: $1
  ...
  JTaskStackBuilderClass = interface(JObjectClass)
    ['{D5B3626A-FFF8-4714-A4DA-EAFD33377F8A}']
  ...
  JTaskStackBuilder = interface(JObject)
    ['{C637E8BA-22F2-46A7-8F86-086CF0562900}']
    function addNextIntent(nextIntent : JIntent) : JTaskStackBuilder; cdecl;    // (Landroid/content/Intent;)Landroid/app/TaskStackBuilder; A: $1
    function addNextIntentWithParentStack(nextIntent : JIntent) : JTaskStackBuilder; cdecl;// (Landroid/content/Intent;)Landroid/app/TaskStackBuilder; A: $1
    function addParentStack(sourceActivity : JActivity) : JTaskStackBuilder; cdecl; overload;// (Landroid/app/Activity;)Landroid/app/TaskStackBuilder; A: $1
    function addParentStack(sourceActivityClass : JClass) : JTaskStackBuilder; cdecl; overload;// (Ljava/lang/Class;)Landroid/app/TaskStackBuilder; A: $1
  ...
  JDialogClass = interface(JObjectClass)
    ['{D476FE51-C8DD-4869-8A2F-1149D6007759}']
    function dispatchGenericMotionEvent(ev : JMotionEvent) : boolean; cdecl;    // (Landroid/view/MotionEvent;)Z A: $1
    function dispatchKeyEvent(event : JKeyEvent) : boolean; cdecl;              // (Landroid/view/KeyEvent;)Z A: $1
    function dispatchKeyShortcutEvent(event : JKeyEvent) : boolean; cdecl;      // (Landroid/view/KeyEvent;)Z A: $1
    function dispatchPopulateAccessibilityEvent(event : JAccessibilityEvent) : boolean; cdecl;// (Landroid/view/accessibility/AccessibilityEvent;)Z A: $1
  ...
  JDialog = interface(JObject)
    ['{7A1E1025-7846-431E-918F-C4B29E93CA5C}']
    function dispatchGenericMotionEvent(ev : JMotionEvent) : boolean; cdecl;    // (Landroid/view/MotionEvent;)Z A: $1
    function dispatchKeyEvent(event : JKeyEvent) : boolean; cdecl;              // (Landroid/view/KeyEvent;)Z A: $1
    function dispatchKeyShortcutEvent(event : JKeyEvent) : boolean; cdecl;      // (Landroid/view/KeyEvent;)Z A: $1
    function dispatchPopulateAccessibilityEvent(event : JAccessibilityEvent) : boolean; cdecl;// (Landroid/view/accessibility/AccessibilityEvent;)Z A: $1
  ...
  JFragmentManagerClass = interface(JObjectClass)
    ['{4E4B845C-8C87-4CBB-9463-D937CDEA2CD0}']
  ...
  JFragmentManager = interface(JObject)
    ['{0BEE45BA-5446-4D1A-AA98-1BBF3984EBF0}']
    function beginTransaction : JFragmentTransaction; cdecl;                    // ()Landroid/app/FragmentTransaction; A: $401
    function executePendingTransactions : boolean; cdecl;                       // ()Z A: $401
    function findFragmentById(Integerparam0 : Integer) : JFragment; cdecl;      // (I)Landroid/app/Fragment; A: $401
    function findFragmentByTag(JStringparam0 : JString) : JFragment; cdecl;     // (Ljava/lang/String;)Landroid/app/Fragment; A: $401
  ...
  JFragmentManager_FragmentLifecycleCallbacksClass = interface(JObjectClass)
    ['{8806CAD0-84D8-41AF-9B22-E8B13CC6715A}']
  ...
  JFragmentManager_FragmentLifecycleCallbacks = interface(JObject)
    ['{2469C52A-6B5A-44CB-BDB2-001352B1384B}']
    procedure onFragmentActivityCreated(fm : JFragmentManager; f : JFragment; savedInstanceState : JBundle) ; cdecl;// (Landroid/app/FragmentManager;Landroid/app/Fragment;Landroid/os/Bundle;)V A: $1
    procedure onFragmentAttached(fm : JFragmentManager; f : JFragment; context : JContext) ; cdecl;// (Landroid/app/FragmentManager;Landroid/app/Fragment;Landroid/content/Context;)V A: $1
    procedure onFragmentCreated(fm : JFragmentManager; f : JFragment; savedInstanceState : JBundle) ; cdecl;// (Landroid/app/FragmentManager;Landroid/app/Fragment;Landroid/os/Bundle;)V A: $1
    procedure onFragmentDestroyed(fm : JFragmentManager; f : JFragment) ; cdecl;// (Landroid/app/FragmentManager;Landroid/app/Fragment;)V A: $1
  ...
  JFragmentTransactionClass = interface(JObjectClass)
    ['{A902554B-E7FF-40AF-97E2-F907A99BF0C5}']
  ...
  JFragmentTransaction = interface(JObject)
    ['{6A3E8AAC-67D9-453A-8039-AB9F24250850}']
    function add(Integerparam0 : Integer; JFragmentparam1 : JFragment) : JFragmentTransaction; cdecl; overload;// (ILandroid/app/Fragment;)Landroid/app/FragmentTransaction; A: $401
    function add(Integerparam0 : Integer; JFragmentparam1 : JFragment; JStringparam2 : JString) : JFragmentTransaction; cdecl; overload;// (ILandroid/app/Fragment;Ljava/lang/String;)Landroid/app/FragmentTransaction; A: $401
    function add(JFragmentparam0 : JFragment; JStringparam1 : JString) : JFragmentTransaction; cdecl; overload;// (Landroid/app/Fragment;Ljava/lang/String;)Landroid/app/FragmentTransaction; A: $401
    function addSharedElement(JViewparam0 : JView; JStringparam1 : JString) : JFragmentTransaction; cdecl;// (Landroid/view/View;Ljava/lang/String;)Landroid/app/FragmentTransaction; A: $401
