...
type
  ...
  JRemoteViewsClass = interface(JObjectClass)
    ['{52E2070F-5DF7-4BC9-A429-BCEEE6843CF8}']
    ...
    function clone : JRemoteViews; deprecated; cdecl;                           // ()Landroid/widget/RemoteViews; A: $1
    ...
    function init(src : JRemoteViews) : JRemoteViews; cdecl; overload;          // (Landroid/widget/RemoteViews;)V A: $1
    ...
    procedure setAccessibilityTraversalAfter(viewId : Integer; nextId : Integer) ; cdecl;// (II)V A: $1
    procedure setAccessibilityTraversalBefore(viewId : Integer; nextId : Integer) ; cdecl;// (II)V A: $1
    ...
    procedure setChronometerCountDown(viewId : Integer; isCountDown : boolean) ; cdecl;// (IZ)V A: $1
    ...
    procedure setIcon(viewId : Integer; methodName : JString; value : JIcon) ; cdecl;// (ILjava/lang/String;Landroid/graphics/drawable/Icon;)V A: $1
    procedure setImageViewBitmap(viewId : Integer; bitmap : JBitmap) ; cdecl;   // (ILandroid/graphics/Bitmap;)V A: $1
    procedure setImageViewIcon(viewId : Integer; icon : JIcon) ; cdecl;         // (ILandroid/graphics/drawable/Icon;)V A: $1
  ...
  JRemoteViews = interface(JObject)
    ['{642EF215-3BC2-4807-8A0B-4EB690B76292}']
    function apply(context : JContext; parent : JViewGroup) : JView; cdecl;     // (Landroid/content/Context;Landroid/view/ViewGroup;)Landroid/view/View; A: $1
    function clone : JRemoteViews; deprecated; cdecl;                           // ()Landroid/widget/RemoteViews; A: $1
    function describeContents : Integer; cdecl;                                 // ()I A: $1
    function getLayoutId : Integer; cdecl;                                      // ()I A: $1
