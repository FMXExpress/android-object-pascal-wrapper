...
type
  ...
  JArrayClass = interface(JObjectClass)
    ['{2449345B-DBC3-44A0-9A48-872B92245027}']
    ...
    procedure setBoolean(&array : JObject; &index : Integer; z : boolean) ; cdecl;// (Ljava/lang/Object;IZ)V A: $9
    procedure setByte(&array : JObject; &index : Integer; b : Byte) ; cdecl;    // (Ljava/lang/Object;IB)V A: $9
    procedure setChar(&array : JObject; &index : Integer; c : Char) ; cdecl;    // (Ljava/lang/Object;IC)V A: $9
    procedure setDouble(&array : JObject; &index : Integer; d : Double) ; cdecl;// (Ljava/lang/Object;ID)V A: $9
    procedure setFloat(&array : JObject; &index : Integer; f : Single) ; cdecl; // (Ljava/lang/Object;IF)V A: $9
    procedure setInt(&array : JObject; &index : Integer; i : Integer) ; cdecl;  // (Ljava/lang/Object;II)V A: $9
    procedure setLong(&array : JObject; &index : Integer; l : Int64) ; cdecl;   // (Ljava/lang/Object;IJ)V A: $9
    procedure setShort(&array : JObject; &index : Integer; s : SmallInt) ; cdecl;// (Ljava/lang/Object;IS)V A: $9
  end;

  [JavaSignature('java/lang/reflect/Array')]
  JArray = interface(JObject)
    ['{90A914FE-9353-41BB-B758-442A44476C10}']
  end;
