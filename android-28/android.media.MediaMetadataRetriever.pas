...
uses
  ...
  android.media.MediaMetadataRetriever_BitmapParams;

type
  JMediaMetadataRetriever = interface;

  JMediaMetadataRetrieverClass = interface(JObjectClass)
    ['{34C02B52-5DC0-4E05-BE7A-E118E72C6AD1}']
    ...
    function _GetMETADATA_KEY_HAS_IMAGE : Integer; cdecl;                       //  A: $19
    function _GetMETADATA_KEY_HAS_VIDEO : Integer; cdecl;                       //  A: $19
    function _GetMETADATA_KEY_IMAGE_COUNT : Integer; cdecl;                     //  A: $19
    function _GetMETADATA_KEY_IMAGE_HEIGHT : Integer; cdecl;                    //  A: $19
    function _GetMETADATA_KEY_IMAGE_PRIMARY : Integer; cdecl;                   //  A: $19
    function _GetMETADATA_KEY_IMAGE_ROTATION : Integer; cdecl;                  //  A: $19
    function _GetMETADATA_KEY_IMAGE_WIDTH : Integer; cdecl;                     //  A: $19
    ...
    function _GetMETADATA_KEY_VIDEO_FRAME_COUNT : Integer; cdecl;               //  A: $19
    ...
    function getFrameAtIndex(frameIndex : Integer) : JBitmap; cdecl; overload;  // (I)Landroid/graphics/Bitmap; A: $1
    function getFrameAtIndex(frameIndex : Integer; params : JMediaMetadataRetriever_BitmapParams) : JBitmap; cdecl; overload;// (ILandroid/media/MediaMetadataRetriever$BitmapParams;)Landroid/graphics/Bitmap; A: $1
    ...
    function getFramesAtIndex(frameIndex : Integer; numFrames : Integer) : JList; cdecl; overload;// (II)Ljava/util/List; A: $1
    function getFramesAtIndex(frameIndex : Integer; numFrames : Integer; params : JMediaMetadataRetriever_BitmapParams) : JList; cdecl; overload;// (IILandroid/media/MediaMetadataRetriever$BitmapParams;)Ljava/util/List; A: $1
    function getImageAtIndex(imageIndex : Integer) : JBitmap; cdecl; overload;  // (I)Landroid/graphics/Bitmap; A: $1
    function getImageAtIndex(imageIndex : Integer; params : JMediaMetadataRetriever_BitmapParams) : JBitmap; cdecl; overload;// (ILandroid/media/MediaMetadataRetriever$BitmapParams;)Landroid/graphics/Bitmap; A: $1
    function getPrimaryImage : JBitmap; cdecl; overload;                        // ()Landroid/graphics/Bitmap; A: $1
    function getPrimaryImage(params : JMediaMetadataRetriever_BitmapParams) : JBitmap; cdecl; overload;// (Landroid/media/MediaMetadataRetriever$BitmapParams;)Landroid/graphics/Bitmap; A: $1
    function getScaledFrameAtTime(timeUs : Int64; option : Integer; dstWidth : Integer; dstHeight : Integer) : JBitmap; cdecl;// (JIII)Landroid/graphics/Bitmap; A: $1
    ...
    property METADATA_KEY_HAS_IMAGE : Integer read _GetMETADATA_KEY_HAS_IMAGE;  // I A: $19
    property METADATA_KEY_HAS_VIDEO : Integer read _GetMETADATA_KEY_HAS_VIDEO;  // I A: $19
    property METADATA_KEY_IMAGE_COUNT : Integer read _GetMETADATA_KEY_IMAGE_COUNT;// I A: $19
    property METADATA_KEY_IMAGE_HEIGHT : Integer read _GetMETADATA_KEY_IMAGE_HEIGHT;// I A: $19
    property METADATA_KEY_IMAGE_PRIMARY : Integer read _GetMETADATA_KEY_IMAGE_PRIMARY;// I A: $19
    property METADATA_KEY_IMAGE_ROTATION : Integer read _GetMETADATA_KEY_IMAGE_ROTATION;// I A: $19
    property METADATA_KEY_IMAGE_WIDTH : Integer read _GetMETADATA_KEY_IMAGE_WIDTH;// I A: $19
    ...
    property METADATA_KEY_VIDEO_FRAME_COUNT : Integer read _GetMETADATA_KEY_VIDEO_FRAME_COUNT;// I A: $19
  ...
  JMediaMetadataRetriever = interface(JObject)
    ['{E6E5865D-C444-4D4B-9A90-945AD9FC5BDF}']
    function getEmbeddedPicture : TJavaArray<Byte>; cdecl;                      // ()[B A: $1
    function getFrameAtIndex(frameIndex : Integer) : JBitmap; cdecl; overload;  // (I)Landroid/graphics/Bitmap; A: $1
    function getFrameAtIndex(frameIndex : Integer; params : JMediaMetadataRetriever_BitmapParams) : JBitmap; cdecl; overload;// (ILandroid/media/MediaMetadataRetriever$BitmapParams;)Landroid/graphics/Bitmap; A: $1
    function getFrameAtTime : JBitmap; cdecl; overload;                         // ()Landroid/graphics/Bitmap; A: $1
...
const
  ...
  TJMediaMetadataRetrieverMETADATA_KEY_HAS_IMAGE = 26;
  TJMediaMetadataRetrieverMETADATA_KEY_HAS_VIDEO = 17;
  TJMediaMetadataRetrieverMETADATA_KEY_IMAGE_COUNT = 27;
  TJMediaMetadataRetrieverMETADATA_KEY_IMAGE_HEIGHT = 30;
  TJMediaMetadataRetrieverMETADATA_KEY_IMAGE_PRIMARY = 28;
  TJMediaMetadataRetrieverMETADATA_KEY_IMAGE_ROTATION = 31;
  TJMediaMetadataRetrieverMETADATA_KEY_IMAGE_WIDTH = 29;
  ...
  TJMediaMetadataRetrieverMETADATA_KEY_VIDEO_FRAME_COUNT = 32;
