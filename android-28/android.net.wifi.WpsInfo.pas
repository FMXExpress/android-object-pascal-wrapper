...
type
  ...
  JWpsInfoClass = interface(JObjectClass)
    ['{4182092F-3AF8-4075-B232-DB0510DCA9A1}']
    ...
    function describeContents : Integer; deprecated; cdecl;                     // ()I A: $1
    function init : JWpsInfo; deprecated; cdecl; overload;                      // ()V A: $1
    function init(source : JWpsInfo) : JWpsInfo; deprecated; cdecl; overload;   // (Landroid/net/wifi/WpsInfo;)V A: $1
    ...
    procedure writeToParcel(dest : JParcel; flags : Integer) ; deprecated; cdecl;// (Landroid/os/Parcel;I)V A: $1
  ...
  JWpsInfo = interface(JObject)
    ['{FC94E18F-CAE9-4F4A-B997-2032DEA1FAD4}']
    function _GetBSSID : JString; cdecl;                                        //  A: $1
    function _Getpin : JString; cdecl;                                          //  A: $1
    function _Getsetup : Integer; cdecl;                                        //  A: $1
    function describeContents : Integer; deprecated; cdecl;                     // ()I A: $1
