...
uses
  ...
  android.webkit.WebChromeClient_FileChooserParams,
  Androidapi.JNI.Util,
...
type
  ...
  JWebChromeClientClass = interface(JObjectClass)
    ['{4FFA30A6-722B-418D-B817-7F39CBF9A46D}']
    ...
    function onShowFileChooser(webView : JWebView; filePathCallback : JValueCallback; fileChooserParams : JWebChromeClient_FileChooserParams) : boolean; cdecl;// (Landroid/webkit/WebView;Landroid/webkit/ValueCallback;Landroid/webkit/WebChromeClient$FileChooserParams;)Z A: $1
    ...
    procedure onPermissionRequest(request : JPermissionRequest) ; cdecl;        // (Landroid/webkit/PermissionRequest;)V A: $1
    procedure onPermissionRequestCanceled(request : JPermissionRequest) ; cdecl;// (Landroid/webkit/PermissionRequest;)V A: $1
  ...
  JWebChromeClient = interface(JObject)
    ['{BAD89FD9-24FA-4F96-837C-353417873337}']
    function getDefaultVideoPoster : JBitmap; cdecl;                            // ()Landroid/graphics/Bitmap; A: $1
    function getVideoLoadingProgressView : JView; cdecl;                        // ()Landroid/view/View; A: $1
    function onConsoleMessage(consoleMessage : JConsoleMessage) : boolean; cdecl; overload;// (Landroid/webkit/ConsoleMessage;)Z A: $1
    function onCreateWindow(view : JWebView; isDialog : boolean; isUserGesture : boolean; resultMsg : JMessage) : boolean; cdecl;// (Landroid/webkit/WebView;ZZLandroid/os/Message;)Z A: $1
  ...
  // Merged from: .\android.webkit.WebView.pas
  JWebViewClass = interface(JObjectClass)
    ['{EEA78767-A72A-40F1-BB87-40FBCE8682ED}']
    ...
    function findAddress(addr : JString) : JString; deprecated; cdecl;          // (Ljava/lang/String;)Ljava/lang/String; A: $9
    ...
    function getWebViewClassLoader : JClassLoader; cdecl;                       // ()Ljava/lang/ClassLoader; A: $9
    function getWebViewClient : JWebViewClient; cdecl;                          // ()Landroid/webkit/WebViewClient; A: $1
    function getWebViewLooper : JLooper; cdecl;                                 // ()Landroid/os/Looper; A: $1
    ...
    procedure disableWebView ; cdecl;                                           // ()V A: $9
    ...
    procedure setDataDirectorySuffix(suffix : JString) ; cdecl;                 // (Ljava/lang/String;)V A: $9
    ...
    procedure setSafeBrowsingWhitelist(hosts : JList; callback : JValueCallback) ; cdecl;// (Ljava/util/List;Landroid/webkit/ValueCallback;)V A: $9
  ...
  JWebView = interface(JObject)
    ['{8FDB8FAB-FA47-40D6-98DC-320C46711ACD}']
    function canGoBack : boolean; cdecl;                                        // ()Z A: $1
    function canGoBackOrForward(steps : Integer) : boolean; cdecl;              // (I)Z A: $1
    function canGoForward : boolean; cdecl;                                     // ()Z A: $1
    function canZoomIn : boolean; deprecated; cdecl;                            // ()Z A: $1
  ...
  JWebViewClientClass = interface(JObjectClass)
    ['{0B6EC1E1-A91A-4452-95BE-A7844CF4A278}']
    ...
    function _GetERROR_UNSAFE_RESOURCE : Integer; cdecl;                        //  A: $19
    function _GetERROR_UNSUPPORTED_AUTH_SCHEME : Integer; cdecl;                //  A: $19
    function _GetERROR_UNSUPPORTED_SCHEME : Integer; cdecl;                     //  A: $19
    function _GetSAFE_BROWSING_THREAT_MALWARE : Integer; cdecl;                 //  A: $19
    function _GetSAFE_BROWSING_THREAT_PHISHING : Integer; cdecl;                //  A: $19
    function _GetSAFE_BROWSING_THREAT_UNKNOWN : Integer; cdecl;                 //  A: $19
    function _GetSAFE_BROWSING_THREAT_UNWANTED_SOFTWARE : Integer; cdecl;       //  A: $19
    function init : JWebViewClient; cdecl;                                      // ()V A: $1
    function onRenderProcessGone(view : JWebView; detail : JRenderProcessGoneDetail) : boolean; cdecl;// (Landroid/webkit/WebView;Landroid/webkit/RenderProcessGoneDetail;)Z A: $1
    ...
    function shouldOverrideUrlLoading(view : JWebView; request : JWebResourceRequest) : boolean; cdecl; overload;// (Landroid/webkit/WebView;Landroid/webkit/WebResourceRequest;)Z A: $1
    function shouldOverrideUrlLoading(view : JWebView; url : JString) : boolean; deprecated; cdecl; overload;// (Landroid/webkit/WebView;Ljava/lang/String;)Z A: $1
    ...
    procedure onSafeBrowsingHit(view : JWebView; request : JWebResourceRequest; threatType : Integer; callback : JSafeBrowsingResponse) ; cdecl;// (Landroid/webkit/WebView;Landroid/webkit/WebResourceRequest;ILandroid/webkit/SafeBrowsingResponse;)V A: $1
    ...
    property ERROR_UNSAFE_RESOURCE : Integer read _GetERROR_UNSAFE_RESOURCE;    // I A: $19
    ...
    property SAFE_BROWSING_THREAT_MALWARE : Integer read _GetSAFE_BROWSING_THREAT_MALWARE;// I A: $19
    property SAFE_BROWSING_THREAT_PHISHING : Integer read _GetSAFE_BROWSING_THREAT_PHISHING;// I A: $19
    property SAFE_BROWSING_THREAT_UNKNOWN : Integer read _GetSAFE_BROWSING_THREAT_UNKNOWN;// I A: $19
    property SAFE_BROWSING_THREAT_UNWANTED_SOFTWARE : Integer read _GetSAFE_BROWSING_THREAT_UNWANTED_SOFTWARE;// I A: $19
  end;

  [JavaSignature('android/webkit/WebViewClient')]
  JWebViewClient = interface(JObject)
    ['{80CF9CC5-F06E-43C8-B220-02D435B60FCF}']
    function onRenderProcessGone(view : JWebView; detail : JRenderProcessGoneDetail) : boolean; cdecl;// (Landroid/webkit/WebView;Landroid/webkit/RenderProcessGoneDetail;)Z A: $1
    function shouldInterceptRequest(view : JWebView; request : JWebResourceRequest) : JWebResourceResponse; cdecl; overload;// (Landroid/webkit/WebView;Landroid/webkit/WebResourceRequest;)Landroid/webkit/WebResourceResponse; A: $1
    function shouldInterceptRequest(view : JWebView; url : JString) : JWebResourceResponse; deprecated; cdecl; overload;// (Landroid/webkit/WebView;Ljava/lang/String;)Landroid/webkit/WebResourceResponse; A: $1
    function shouldOverrideKeyEvent(view : JWebView; event : JKeyEvent) : boolean; cdecl;// (Landroid/webkit/WebView;Landroid/view/KeyEvent;)Z A: $1
  ...
  JWebView_PictureListenerClass = interface(JObjectClass)
    ['{D8C064C9-1BFF-4963-9115-C802605CC011}']
  ...
  JWebView_PictureListener = interface(JObject)
    ['{C4EBAD70-09B4-4832-95D7-602E385D1B40}']
    procedure onNewPicture(JWebViewparam0 : JWebView; JPictureparam1 : JPicture) ; deprecated; cdecl;// (Landroid/webkit/WebView;Landroid/graphics/Picture;)V A: $401
  end;
...
const
  ...
  TJWebViewClientERROR_UNSAFE_RESOURCE = -16;
  TJWebViewClientERROR_UNSUPPORTED_AUTH_SCHEME = -3;
  TJWebViewClientERROR_UNSUPPORTED_SCHEME = -10;
  TJWebViewClientSAFE_BROWSING_THREAT_MALWARE = 1;
  TJWebViewClientSAFE_BROWSING_THREAT_PHISHING = 2;
  TJWebViewClientSAFE_BROWSING_THREAT_UNKNOWN = 0;
  TJWebViewClientSAFE_BROWSING_THREAT_UNWANTED_SOFTWARE = 3;
