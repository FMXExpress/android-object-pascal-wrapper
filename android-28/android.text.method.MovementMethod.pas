...
type
  ...
  JMovementMethodClass = interface(JObjectClass)
    ['{810A680A-DB81-4F9A-9C08-53609D167C60}']
  ...
  JMovementMethod = interface(JObject)
    ['{0252715C-942B-46BF-8EE7-3AB3F047F448}']
    function canSelectArbitrarily : boolean; cdecl;                             // ()Z A: $401
    function onGenericMotionEvent(JTextViewparam0 : JTextView; JSpannableparam1 : JSpannable; JMotionEventparam2 : JMotionEvent) : boolean; cdecl;// (Landroid/widget/TextView;Landroid/text/Spannable;Landroid/view/MotionEvent;)Z A: $401
    function onKeyDown(JTextViewparam0 : JTextView; JSpannableparam1 : JSpannable; Integerparam2 : Integer; JKeyEventparam3 : JKeyEvent) : boolean; cdecl;// (Landroid/widget/TextView;Landroid/text/Spannable;ILandroid/view/KeyEvent;)Z A: $401
    function onKeyOther(JTextViewparam0 : JTextView; JSpannableparam1 : JSpannable; JKeyEventparam2 : JKeyEvent) : boolean; cdecl;// (Landroid/widget/TextView;Landroid/text/Spannable;Landroid/view/KeyEvent;)Z A: $401
  ...
  JTextViewClass = interface(JObjectClass)
    ['{3D2D88E4-31DE-4A7E-A77E-A0F94B378E73}']
    function _GetAUTO_SIZE_TEXT_TYPE_NONE : Integer; cdecl;                     //  A: $19
    function _GetAUTO_SIZE_TEXT_TYPE_UNIFORM : Integer; cdecl;                  //  A: $19
    ...
    function getAutoSizeMaxTextSize : Integer; cdecl;                           // ()I A: $1
    function getAutoSizeMinTextSize : Integer; cdecl;                           // ()I A: $1
    function getAutoSizeStepGranularity : Integer; cdecl;                       // ()I A: $1
    function getAutoSizeTextAvailableSizes : TJavaArray<Integer>; cdecl;        // ()[I A: $1
    function getAutoSizeTextType : Integer; cdecl;                              // ()I A: $1
    ...
    function getFirstBaselineToTopHeight : Integer; cdecl;                      // ()I A: $1
    function getFontFeatureSettings : JString; cdecl;                           // ()Ljava/lang/String; A: $1
    function getFontVariationSettings : JString; cdecl;                         // ()Ljava/lang/String; A: $1
    ...
    function getJustificationMode : Integer; cdecl;                             // ()I A: $1
    function getKeyListener : JKeyListener; cdecl;                              // ()Landroid/text/method/KeyListener; A: $11
    function getLastBaselineToBottomHeight : Integer; cdecl;                    // ()I A: $1
    ...
    function getTextMetricsParams : JPrecomputedText_Params; cdecl;             // ()Landroid/text/PrecomputedText$Params; A: $1
    ...
    function setFontVariationSettings(fontVariationSettings : JString) : boolean; cdecl;// (Ljava/lang/String;)Z A: $1
    ...
    procedure setAutoSizeTextTypeUniformWithConfiguration(autoSizeMinTextSize : Integer; autoSizeMaxTextSize : Integer; autoSizeStepGranularity : Integer; &unit : Integer) ; cdecl;// (IIII)V A: $1
    procedure setAutoSizeTextTypeUniformWithPresetSizes(presetSizes : TJavaArray<Integer>; &unit : Integer) ; cdecl;// ([II)V A: $1
    procedure setAutoSizeTextTypeWithDefaults(autoSizeTextType : Integer) ; cdecl;// (I)V A: $1
    ...
    procedure setFallbackLineSpacing(enabled : boolean) ; cdecl;                // (Z)V A: $1
    procedure setFilters(filters : TJavaArray<JInputFilter>) ; cdecl;           // ([Landroid/text/InputFilter;)V A: $1
    procedure setFirstBaselineToTopHeight(firstBaselineToTopHeight : Integer) ; cdecl;// (I)V A: $1
    ...
    procedure setJustificationMode(justificationMode : Integer) ; cdecl;        // (I)V A: $1
    procedure setKeyListener(input : JKeyListener) ; cdecl;                     // (Landroid/text/method/KeyListener;)V A: $1
    procedure setLastBaselineToBottomHeight(lastBaselineToBottomHeight : Integer) ; cdecl;// (I)V A: $1
    procedure setLetterSpacing(letterSpacing : Single) ; cdecl;                 // (F)V A: $1
    procedure setLineHeight(lineHeight : Integer) ; cdecl;                      // (I)V A: $1
    ...
    procedure setMaxHeight(maxPixels : Integer) ; cdecl;                        // (I)V A: $1
    ...
    procedure setMinHeight(minPixels : Integer) ; cdecl;                        // (I)V A: $1
    ...
    procedure setTextMetricsParams(params : JPrecomputedText_Params) ; cdecl;   // (Landroid/text/PrecomputedText$Params;)V A: $1
    ...
    property AUTO_SIZE_TEXT_TYPE_NONE : Integer read _GetAUTO_SIZE_TEXT_TYPE_NONE;// I A: $19
    property AUTO_SIZE_TEXT_TYPE_UNIFORM : Integer read _GetAUTO_SIZE_TEXT_TYPE_UNIFORM;// I A: $19
  end;

  [JavaSignature('android/widget/TextView$SavedState')]
  JTextView = interface(JObject)
    ['{A8594F47-ED3B-4765-9A59-A77DB40C75F3}']
    function bringPointIntoView(offset : Integer) : boolean; cdecl;             // (I)Z A: $1
    function didTouchFocusSelect : boolean; cdecl;                              // ()Z A: $1
    function extractText(request : JExtractedTextRequest; outText : JExtractedText) : boolean; cdecl;// (Landroid/view/inputmethod/ExtractedTextRequest;Landroid/view/inputmethod/ExtractedText;)Z A: $1
    function getAccessibilityClassName : JCharSequence; cdecl;                  // ()Ljava/lang/CharSequence; A: $1
  ...
  JTextView_OnEditorActionListenerClass = interface(JObjectClass)
    ['{A779FE2F-5E0E-4051-ABCD-2AE2A6625967}']
  ...
  JTextView_OnEditorActionListener = interface(JObject)
    ['{B23B4593-2617-41CF-BE41-0C3A323A72D5}']
    function onEditorAction(JTextViewparam0 : JTextView; Integerparam1 : Integer; JKeyEventparam2 : JKeyEvent) : boolean; cdecl;// (Landroid/widget/TextView;ILandroid/view/KeyEvent;)Z A: $401
  end;
...
const
  TJTextViewAUTO_SIZE_TEXT_TYPE_NONE = 0;
  TJTextViewAUTO_SIZE_TEXT_TYPE_UNIFORM = 1;
