...
type
  ...
  JCameraCharacteristicsClass = interface(JObjectClass)
    ['{A027312F-F9FA-41D4-9337-F407C5260D9E}']
    ...
    function _GetDISTORTION_CORRECTION_AVAILABLE_MODES : JCameraCharacteristics_Key; cdecl;//  A: $19
    ...
    function _GetINFO_VERSION : JCameraCharacteristics_Key; cdecl;              //  A: $19
    function _GetJPEG_AVAILABLE_THUMBNAIL_SIZES : JCameraCharacteristics_Key; cdecl;//  A: $19
    function _GetLENS_DISTORTION : JCameraCharacteristics_Key; cdecl;           //  A: $19
    ...
    function _GetLENS_POSE_REFERENCE : JCameraCharacteristics_Key; cdecl;       //  A: $19
    ...
    function _GetLOGICAL_MULTI_CAMERA_SENSOR_SYNC_TYPE : JCameraCharacteristics_Key; cdecl;//  A: $19
    ...
    function _GetSTATISTICS_INFO_AVAILABLE_OIS_DATA_MODES : JCameraCharacteristics_Key; cdecl;//  A: $19
    ...
    function getAvailablePhysicalCameraRequestKeys : JList; cdecl;              // ()Ljava/util/List; A: $1
    function getAvailableSessionKeys : JList; cdecl;                            // ()Ljava/util/List; A: $1
    function getKeys : JList; cdecl;                                            // ()Ljava/util/List; A: $1
    function getPhysicalCameraIds : JSet; cdecl;                                // ()Ljava/util/Set; A: $1
    ...
    property DISTORTION_CORRECTION_AVAILABLE_MODES : JCameraCharacteristics_Key read _GetDISTORTION_CORRECTION_AVAILABLE_MODES;// Landroid/hardware/camera2/CameraCharacteristics$Key; A: $19
    ...
    property INFO_VERSION : JCameraCharacteristics_Key read _GetINFO_VERSION;   // Landroid/hardware/camera2/CameraCharacteristics$Key; A: $19
    ...
    property LENS_DISTORTION : JCameraCharacteristics_Key read _GetLENS_DISTORTION;// Landroid/hardware/camera2/CameraCharacteristics$Key; A: $19
    ...
    property LENS_POSE_REFERENCE : JCameraCharacteristics_Key read _GetLENS_POSE_REFERENCE;// Landroid/hardware/camera2/CameraCharacteristics$Key; A: $19
    ...
    property LOGICAL_MULTI_CAMERA_SENSOR_SYNC_TYPE : JCameraCharacteristics_Key read _GetLOGICAL_MULTI_CAMERA_SENSOR_SYNC_TYPE;// Landroid/hardware/camera2/CameraCharacteristics$Key; A: $19
    ...
    property STATISTICS_INFO_AVAILABLE_OIS_DATA_MODES : JCameraCharacteristics_Key read _GetSTATISTICS_INFO_AVAILABLE_OIS_DATA_MODES;// Landroid/hardware/camera2/CameraCharacteristics$Key; A: $19
  ...
  JCameraCharacteristics = interface(JObject)
    ['{6DD28BEE-1D30-4979-8CEA-981F8B3BEDDC}']
    function get(key : JCameraCharacteristics_Key) : JObject; cdecl;            // (Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object; A: $1
    function getAvailableCaptureRequestKeys : JList; cdecl;                     // ()Ljava/util/List; A: $1
    function getAvailableCaptureResultKeys : JList; cdecl;                      // ()Ljava/util/List; A: $1
    function getAvailablePhysicalCameraRequestKeys : JList; cdecl;              // ()Ljava/util/List; A: $1
