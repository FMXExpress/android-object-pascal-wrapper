...
uses
  ...
  android.telephony.TelephonyScanManager_NetworkScanCallback,
...
type
  ...
  JTelephonyManagerClass = interface(JObjectClass)
    ['{46E3BAC9-8CF2-4290-A9DC-E408D7F42AF6}']
    ...
    function _GetACTION_SUBSCRIPTION_CARRIER_IDENTITY_CHANGED : JString; cdecl; //  A: $19
    ...
    function _GetCDMA_ROAMING_MODE_AFFILIATED : Integer; cdecl;                 //  A: $19
    function _GetCDMA_ROAMING_MODE_ANY : Integer; cdecl;                        //  A: $19
    function _GetCDMA_ROAMING_MODE_HOME : Integer; cdecl;                       //  A: $19
    function _GetCDMA_ROAMING_MODE_RADIO_DEFAULT : Integer; cdecl;              //  A: $19
    ...
    function _GetEXTRA_CARRIER_ID : JString; cdecl;                             //  A: $19
    function _GetEXTRA_CARRIER_NAME : JString; cdecl;                           //  A: $19
    ...
    function _GetEXTRA_SUBSCRIPTION_ID : JString; cdecl;                        //  A: $19
    ...
    function _GetUNKNOWN_CARRIER_ID : Integer; cdecl;                           //  A: $19
    ...
    function getNai : JString; cdecl;                                           // ()Ljava/lang/String; A: $1
    ...
    function getSignalStrength : JSignalStrength; cdecl;                        // ()Landroid/telephony/SignalStrength; A: $1
    function getSimCarrierId : Integer; cdecl;                                  // ()I A: $1
    function getSimCarrierIdName : JCharSequence; cdecl;                        // ()Ljava/lang/CharSequence; A: $1
    ...
    function isTtyModeSupported : boolean; deprecated; cdecl;                   // ()Z A: $1
    ...
    function requestNetworkScan(request : JNetworkScanRequest; executor : JExecutor; callback : JTelephonyScanManager_NetworkScanCallback) : JNetworkScan; cdecl;// (Landroid/telephony/NetworkScanRequest;Ljava/util/concurrent/Executor;Landroid/telephony/TelephonyScanManager$NetworkScanCallback;)Landroid/telephony/NetworkScan; A: $1
    ...
    function setNetworkSelectionModeManual(operatorNumeric : JString; persistSelection : boolean) : boolean; cdecl;// (Ljava/lang/String;Z)Z A: $1
    ...
    procedure setNetworkSelectionModeAutomatic ; cdecl;                         // ()V A: $1
    ...
    procedure setVoicemailRingtoneUri(phoneAccountHandle : JPhoneAccountHandle; uri : JUri) ; deprecated; cdecl;// (Landroid/telecom/PhoneAccountHandle;Landroid/net/Uri;)V A: $1
    procedure setVoicemailVibrationEnabled(phoneAccountHandle : JPhoneAccountHandle; enabled : boolean) ; deprecated; cdecl;// (Landroid/telecom/PhoneAccountHandle;Z)V A: $1
    ...
    property ACTION_SUBSCRIPTION_CARRIER_IDENTITY_CHANGED : JString read _GetACTION_SUBSCRIPTION_CARRIER_IDENTITY_CHANGED;// Ljava/lang/String; A: $19
    ...
    property CDMA_ROAMING_MODE_AFFILIATED : Integer read _GetCDMA_ROAMING_MODE_AFFILIATED;// I A: $19
    property CDMA_ROAMING_MODE_ANY : Integer read _GetCDMA_ROAMING_MODE_ANY;    // I A: $19
    property CDMA_ROAMING_MODE_HOME : Integer read _GetCDMA_ROAMING_MODE_HOME;  // I A: $19
    property CDMA_ROAMING_MODE_RADIO_DEFAULT : Integer read _GetCDMA_ROAMING_MODE_RADIO_DEFAULT;// I A: $19
    ...
    property EXTRA_CARRIER_ID : JString read _GetEXTRA_CARRIER_ID;              // Ljava/lang/String; A: $19
    property EXTRA_CARRIER_NAME : JString read _GetEXTRA_CARRIER_NAME;          // Ljava/lang/String; A: $19
    ...
    property EXTRA_SUBSCRIPTION_ID : JString read _GetEXTRA_SUBSCRIPTION_ID;    // Ljava/lang/String; A: $19
    ...
    property UNKNOWN_CARRIER_ID : Integer read _GetUNKNOWN_CARRIER_ID;          // I A: $19
  ...
  JTelephonyManager = interface(JObject)
    ['{96C2BF8E-7D55-4943-9414-35CB2F53EC6A}']
    function canChangeDtmfToneLength : boolean; cdecl;                          // ()Z A: $1
    function createForPhoneAccountHandle(phoneAccountHandle : JPhoneAccountHandle) : JTelephonyManager; cdecl;// (Landroid/telecom/PhoneAccountHandle;)Landroid/telephony/TelephonyManager; A: $1
    function createForSubscriptionId(subId : Integer) : JTelephonyManager; cdecl;// (I)Landroid/telephony/TelephonyManager; A: $1
    function getAllCellInfo : JList; cdecl;                                     // ()Ljava/util/List; A: $1
  ...
  JTelephonyManager_UssdResponseCallbackClass = interface(JObjectClass)
    ['{AFC893B3-FF96-4485-82B7-46CE9F85F04A}']
  ...
  JTelephonyManager_UssdResponseCallback = interface(JObject)
    ['{5F76E5E3-8BCB-48A0-A90C-86088BD2C77D}']
    procedure onReceiveUssdResponse(telephonyManager : JTelephonyManager; request : JString; response : JCharSequence) ; cdecl;// (Landroid/telephony/TelephonyManager;Ljava/lang/String;Ljava/lang/CharSequence;)V A: $1
    procedure onReceiveUssdResponseFailed(telephonyManager : JTelephonyManager; request : JString; failureCode : Integer) ; cdecl;// (Landroid/telephony/TelephonyManager;Ljava/lang/String;I)V A: $1
  end;
...
const
  ...
  TJTelephonyManagerACTION_SUBSCRIPTION_CARRIER_IDENTITY_CHANGED = 'android.telephony.action.SUBSCRIPTION_CARRIER_IDENTITY_CHANGED';
  ...
  TJTelephonyManagerCDMA_ROAMING_MODE_AFFILIATED = 1;
  TJTelephonyManagerCDMA_ROAMING_MODE_ANY = 2;
  TJTelephonyManagerCDMA_ROAMING_MODE_HOME = 0;
  TJTelephonyManagerCDMA_ROAMING_MODE_RADIO_DEFAULT = -1;
  ...
  TJTelephonyManagerEXTRA_CARRIER_ID = 'android.telephony.extra.CARRIER_ID';
  TJTelephonyManagerEXTRA_CARRIER_NAME = 'android.telephony.extra.CARRIER_NAME';
  ...
  TJTelephonyManagerEXTRA_SUBSCRIPTION_ID = 'android.telephony.extra.SUBSCRIPTION_ID';
  ...
  TJTelephonyManagerUNKNOWN_CARRIER_ID = -1;
