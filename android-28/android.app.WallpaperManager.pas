...
uses
  ...
  Androidapi.JNI.os,
  android.app.WallpaperManager_OnColorsChangedListener,
...
type
  ...
  JWallpaperManagerClass = interface(JObjectClass)
    ...
    function _GetFLAG_LOCK : Integer; cdecl;                                    //  A: $19
    ...
    function getBuiltInDrawable(outWidth : Integer; outHeight : Integer; scaleToFit : boolean; horizontalAlignment : Single; verticalAlignment : Single; which : Integer) : JDrawable; cdecl; overload;// (IIZFFI)Landroid/graphics/drawable/Drawable; A: $1
    function getBuiltInDrawable(which : Integer) : JDrawable; cdecl; overload;  // (I)Landroid/graphics/drawable/Drawable; A: $1
    ...
    function getWallpaperColors(which : Integer) : JWallpaperColors; cdecl;     // (I)Landroid/app/WallpaperColors; A: $1
    ...
    function isSetWallpaperAllowed : boolean; cdecl;                            // ()Z A: $1
    ...
    procedure addOnColorsChangedListener(listener : JWallpaperManager_OnColorsChangedListener; handler : JHandler) ; cdecl;// (Landroid/app/WallpaperManager$OnColorsChangedListener;Landroid/os/Handler;)V A: $1
    ...
    procedure removeOnColorsChangedListener(callback : JWallpaperManager_OnColorsChangedListener) ; cdecl;// (Landroid/app/WallpaperManager$OnColorsChangedListener;)V A: $1
    ...
    procedure setDisplayPadding(padding : JRect) ; cdecl;                       // (Landroid/graphics/Rect;)V A: $1
    ...
    property FLAG_LOCK : Integer read _GetFLAG_LOCK;                            // I A: $19
  ...
  [JavaSignature('android/app/WallpaperManager$OnColorsChangedListener')]
...
const
  ...
  TJWallpaperManagerFLAG_LOCK = 2;
  TJWallpaperManagerFLAG_SYSTEM = 1;
