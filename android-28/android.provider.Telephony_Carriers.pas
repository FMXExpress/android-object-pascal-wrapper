...
type
  ...
  JTelephony_CarriersClass = interface(JObjectClass)
    ['{A79EB8B9-52BB-4DE7-88FB-4ECCA4F7FC04}']
    ...
    function _GetNETWORK_TYPE_BITMASK : JString; cdecl;                         //  A: $19
    ...
    property NETWORK_TYPE_BITMASK : JString read _GetNETWORK_TYPE_BITMASK;      // Ljava/lang/String; A: $19
  ...
  JTelephony_Carriers = interface(JObject)
    ['{33DFFDF0-8288-496C-9882-4C454F12D102}']
  end;
...
const
  ...
  TJTelephony_CarriersNETWORK_TYPE_BITMASK = 'network_type_bitmask';
