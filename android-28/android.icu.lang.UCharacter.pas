...
type
  ...
  JUCharacterClass = interface(JObjectClass)
    ['{E2722D7E-364F-47A7-A8E1-87D9EF3B64C0}']
    ...
    function codePointAt(text : TJavaArray<Char>; &index : Integer) : Integer; cdecl; overload;// ([CI)I A: $9
    function codePointAt(text : TJavaArray<Char>; &index : Integer; limit : Integer) : Integer; cdecl; overload;// ([CII)I A: $9
    function codePointBefore(seq : JCharSequence; &index : Integer) : Integer; cdecl; overload;// (Ljava/lang/CharSequence;I)I A: $9
    function codePointBefore(text : TJavaArray<Char>; &index : Integer) : Integer; cdecl; overload;// ([CI)I A: $9
    function codePointBefore(text : TJavaArray<Char>; &index : Integer; limit : Integer) : Integer; cdecl; overload;// ([CII)I A: $9
    ...
    function foldCase(str : JString; options : Integer) : JString; cdecl; overload;// (Ljava/lang/String;I)Ljava/lang/String; A: $9
    ...
    function isSupplementaryCodePoint(cp : Integer) : boolean; cdecl;           // (I)Z A: $9
    ...
    function isValidCodePoint(cp : Integer) : boolean; cdecl;                   // (I)Z A: $9
    ...
    function toChars(cp : Integer) : TJavaArray<Char>; cdecl; overload;         // (I)[C A: $9
    function toChars(cp : Integer; dst : TJavaArray<Char>; dstIndex : Integer) : Integer; cdecl; overload;// (I[CI)I A: $9
  ...
  JUCharacter = interface(JObject)
    ['{D89D9911-CCB5-4731-B550-C53479B32308}']
  end;
