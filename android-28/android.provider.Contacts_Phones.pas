...
type
  ...
  JContacts_PhonesClass = interface(JObjectClass)
    ['{09278605-F6A3-47CA-AD7C-E4D1435619D7}']
    ...
    function getDisplayLabel(context : JContext; &type : Integer; &label : JCharSequence) : JCharSequence; deprecated; cdecl; overload;// (Landroid/content/Context;ILjava/lang/CharSequence;)Ljava/lang/CharSequence; A: $9
    function getDisplayLabel(context : JContext; &type : Integer; &label : JCharSequence; labelArray : TJavaArray<JCharSequence>) : JCharSequence; deprecated; cdecl; overload;// (Landroid/content/Context;ILjava/lang/CharSequence;[Ljava/lang/CharSequence;)Ljava/lang/CharSequence; A: $9
  ...
  JContacts_Phones = interface(JObject)
    ['{3397A00E-2169-442B-8192-5D9796682B56}']
  end;
