...
type
  ...
  JResolveInfoClass = interface(JObjectClass)
    ['{FC63A993-69C4-4240-B02B-99EF32317736}']
    ...
    function _GetisInstantAppAvailable : boolean; cdecl;                        //  A: $1
    ...
    procedure _SetisInstantAppAvailable(Value : boolean) ; cdecl;               //  A: $1
    ...
    property isInstantAppAvailable : boolean read _GetisInstantAppAvailable write _SetisInstantAppAvailable;// Z A: $1
  ...
  JResolveInfo = interface(JObject)
    ['{C788BFA5-48B3-41B0-B91B-FAEEF632BCBD}']
    function _GetactivityInfo : JActivityInfo; cdecl;                           //  A: $1
    function _Getfilter : JIntentFilter; cdecl;                                 //  A: $1
    function _Geticon : Integer; cdecl;                                         //  A: $1
    function _GetisDefault : boolean; cdecl;                                    //  A: $1
