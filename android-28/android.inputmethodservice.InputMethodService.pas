...
type
  ...
  JInputMethodServiceClass = interface(JObjectClass)
    ['{4237D77A-03AE-4C03-9D39-5D2791E3F591}']
    function _GetBACK_DISPOSITION_ADJUST_NOTHING : Integer; cdecl;              //  A: $19
    ...
    function shouldOfferSwitchingToNextInputMethod : boolean; cdecl;            // ()Z A: $11
    function switchToNextInputMethod(onlyCurrentIme : boolean) : boolean; cdecl;// (Z)Z A: $11
    function switchToPreviousInputMethod : boolean; cdecl;                      // ()Z A: $11
    ...
    procedure requestShowSelf(flags : Integer) ; cdecl;                         // (I)V A: $11
    ...
    procedure switchInputMethod(id : JString) ; cdecl; overload;                // (Ljava/lang/String;)V A: $1
    procedure switchInputMethod(id : JString; subtype : JInputMethodSubtype) ; cdecl; overload;// (Ljava/lang/String;Landroid/view/inputmethod/InputMethodSubtype;)V A: $11
    procedure updateFullscreenMode ; cdecl;                                     // ()V A: $1
    procedure updateInputViewShown ; cdecl;                                     // ()V A: $1
    property BACK_DISPOSITION_ADJUST_NOTHING : Integer read _GetBACK_DISPOSITION_ADJUST_NOTHING;// I A: $19
  ...
  JInputMethodService = interface(JObject)
    ['{2DDE750A-66B9-43C5-8F70-A1A09ADE7E2B}']
    function enableHardwareAcceleration : boolean; deprecated; cdecl;           // ()Z A: $1
    function getBackDisposition : Integer; cdecl;                               // ()I A: $1
    function getCandidatesHiddenVisibility : Integer; cdecl;                    // ()I A: $1
    function getCurrentInputBinding : JInputBinding; cdecl;                     // ()Landroid/view/inputmethod/InputBinding; A: $1
...
const
  TJInputMethodServiceBACK_DISPOSITION_ADJUST_NOTHING = 3;
