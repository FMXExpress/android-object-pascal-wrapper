...
type
  ...
  JContactsContract_CommonDataKinds_ImClass = interface(JObjectClass)
    ['{732EA8A1-2D5A-4B6F-87AC-82B49AA5992A}']
    ...
    function getProtocolLabel(res : JResources; &type : Integer; &label : JCharSequence) : JCharSequence; cdecl;// (Landroid/content/res/Resources;ILjava/lang/CharSequence;)Ljava/lang/CharSequence; A: $9
    function getProtocolLabelResource(&type : Integer) : Integer; cdecl;        // (I)I A: $9
  ...
  JContactsContract_CommonDataKinds_Im = interface(JObject)
    ['{842222FC-4A7E-4B9E-B8C7-A344286C0040}']
  end;
...
const
  ...
  TJContactsContract_CommonDataKinds_ImEXTRA_ADDRESS_BOOK_INDEX = 'android.provider.extra.ADDRESS_BOOK_INDEX';
  TJContactsContract_CommonDataKinds_ImEXTRA_ADDRESS_BOOK_INDEX_COUNTS = 'android.provider.extra.ADDRESS_BOOK_INDEX_COUNTS';
  TJContactsContract_CommonDataKinds_ImEXTRA_ADDRESS_BOOK_INDEX_TITLES = 'android.provider.extra.ADDRESS_BOOK_INDEX_TITLES';
