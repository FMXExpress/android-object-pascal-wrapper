...
type
  ...
  JBatteryManagerClass = interface(JObjectClass)
    ['{1F48D9C6-F93D-4F21-9D73-1A94AE73141E}']
    ...
    function _GetBATTERY_PROPERTY_STATUS : Integer; cdecl;                      //  A: $19
    ...
    function _GetEXTRA_BATTERY_LOW : JString; cdecl;                            //  A: $19
    ...
    function computeChargeTimeRemaining : Int64; cdecl;                         // ()J A: $1
    ...
    property BATTERY_PROPERTY_STATUS : Integer read _GetBATTERY_PROPERTY_STATUS;// I A: $19
    ...
    property EXTRA_BATTERY_LOW : JString read _GetEXTRA_BATTERY_LOW;            // Ljava/lang/String; A: $19
  ...
  JBatteryManager = interface(JObject)
    ['{B050B44B-4652-4AF4-8068-2A1AEFB10A6C}']
    function computeChargeTimeRemaining : Int64; cdecl;                         // ()J A: $1
    function getIntProperty(id : Integer) : Integer; cdecl;                     // (I)I A: $1
    function getLongProperty(id : Integer) : Int64; cdecl;                      // (I)J A: $1
    function isCharging : boolean; cdecl;                                       // ()Z A: $1
...
const
  ...
  TJBatteryManagerBATTERY_PROPERTY_STATUS = 6;
  ...
  TJBatteryManagerEXTRA_BATTERY_LOW = 'battery_low';
