...
type
  ...
  JContactsContract_DataColumnsClass = interface(JObjectClass)
    ['{ACC84D41-ACC8-4DEE-8C54-ECE08ABC7AA4}']
    ...
    function _GetPREFERRED_PHONE_ACCOUNT_COMPONENT_NAME : JString; cdecl;       //  A: $19
    function _GetPREFERRED_PHONE_ACCOUNT_ID : JString; cdecl;                   //  A: $19
    ...
    property PREFERRED_PHONE_ACCOUNT_COMPONENT_NAME : JString read _GetPREFERRED_PHONE_ACCOUNT_COMPONENT_NAME;// Ljava/lang/String; A: $19
    property PREFERRED_PHONE_ACCOUNT_ID : JString read _GetPREFERRED_PHONE_ACCOUNT_ID;// Ljava/lang/String; A: $19
  ...
  JContactsContract_DataColumns = interface(JObject)
    ['{A69C217C-226F-4BA8-8C97-C24BD1BA4B0E}']
  end;
...
const
  ...
  TJContactsContract_DataColumnsPREFERRED_PHONE_ACCOUNT_COMPONENT_NAME = 'preferred_phone_account_component_name';
  TJContactsContract_DataColumnsPREFERRED_PHONE_ACCOUNT_ID = 'preferred_phone_account_id';
