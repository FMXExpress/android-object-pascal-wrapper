...
type
  ...
  JSmsMessageClass = interface(JObjectClass)
    ['{385C54EA-5065-43E9-8BEF-4D9435781490}']
    ...
    function _GetFORMAT_3GPP : JString; cdecl;                                  //  A: $19
    function _GetFORMAT_3GPP2 : JString; cdecl;                                 //  A: $19
    ...
    function createFromPdu(pdu : TJavaArray<Byte>) : JSmsMessage; deprecated; cdecl; overload;// ([B)Landroid/telephony/SmsMessage; A: $9
    function createFromPdu(pdu : TJavaArray<Byte>; format : JString) : JSmsMessage; cdecl; overload;// ([BLjava/lang/String;)Landroid/telephony/SmsMessage; A: $9
    ...
    property FORMAT_3GPP : JString read _GetFORMAT_3GPP;                        // Ljava/lang/String; A: $19
    property FORMAT_3GPP2 : JString read _GetFORMAT_3GPP2;                      // Ljava/lang/String; A: $19
  ...
  JSmsMessage = interface(JObject)
    ['{5095ABB5-7A38-41FF-B0B1-C9EF62AFB173}']
    function getDisplayMessageBody : JString; cdecl;                            // ()Ljava/lang/String; A: $1
    function getDisplayOriginatingAddress : JString; cdecl;                     // ()Ljava/lang/String; A: $1
    function getEmailBody : JString; cdecl;                                     // ()Ljava/lang/String; A: $1
    function getEmailFrom : JString; cdecl;                                     // ()Ljava/lang/String; A: $1
...
const
  ...
  TJSmsMessageFORMAT_3GPP = '3gpp';
  TJSmsMessageFORMAT_3GPP2 = '3gpp2';
