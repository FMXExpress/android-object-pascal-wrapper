...
type
  ...
  JNotificationManagerClass = interface(JObjectClass)
    ['{58E0D747-C53E-439F-A765-1F147D63FB34}']
    function _GetACTION_APP_BLOCK_STATE_CHANGED : JString; cdecl;               //  A: $19
    function _GetACTION_INTERRUPTION_FILTER_CHANGED : JString; cdecl;           //  A: $19
    function _GetACTION_NOTIFICATION_CHANNEL_BLOCK_STATE_CHANGED : JString; cdecl;//  A: $19
    function _GetACTION_NOTIFICATION_CHANNEL_GROUP_BLOCK_STATE_CHANGED : JString; cdecl;//  A: $19
    ...
    function _GetEXTRA_BLOCKED_STATE : JString; cdecl;                          //  A: $19
    function _GetEXTRA_NOTIFICATION_CHANNEL_GROUP_ID : JString; cdecl;          //  A: $19
    function _GetEXTRA_NOTIFICATION_CHANNEL_ID : JString; cdecl;                //  A: $19
    ...
    function getNotificationChannelGroup(channelGroupId : JString) : JNotificationChannelGroup; cdecl;// (Ljava/lang/String;)Landroid/app/NotificationChannelGroup; A: $1
    ...
    function isNotificationListenerAccessGranted(listener : JComponentName) : boolean; cdecl;// (Landroid/content/ComponentName;)Z A: $1
    ...
    property ACTION_APP_BLOCK_STATE_CHANGED : JString read _GetACTION_APP_BLOCK_STATE_CHANGED;// Ljava/lang/String; A: $19
    property ACTION_INTERRUPTION_FILTER_CHANGED : JString read _GetACTION_INTERRUPTION_FILTER_CHANGED;// Ljava/lang/String; A: $19
    property ACTION_NOTIFICATION_CHANNEL_BLOCK_STATE_CHANGED : JString read _GetACTION_NOTIFICATION_CHANNEL_BLOCK_STATE_CHANGED;// Ljava/lang/String; A: $19
    property ACTION_NOTIFICATION_CHANNEL_GROUP_BLOCK_STATE_CHANGED : JString read _GetACTION_NOTIFICATION_CHANNEL_GROUP_BLOCK_STATE_CHANGED;// Ljava/lang/String; A: $19
    ...
    property EXTRA_BLOCKED_STATE : JString read _GetEXTRA_BLOCKED_STATE;        // Ljava/lang/String; A: $19
    property EXTRA_NOTIFICATION_CHANNEL_GROUP_ID : JString read _GetEXTRA_NOTIFICATION_CHANNEL_GROUP_ID;// Ljava/lang/String; A: $19
    property EXTRA_NOTIFICATION_CHANNEL_ID : JString read _GetEXTRA_NOTIFICATION_CHANNEL_ID;// Ljava/lang/String; A: $19
  ...
  JNotificationManager = interface(JObject)
    ['{8D7BCFF0-861A-4733-8B93-CB6DBBB44221}']
    function addAutomaticZenRule(automaticZenRule : JAutomaticZenRule) : JString; cdecl;// (Landroid/app/AutomaticZenRule;)Ljava/lang/String; A: $1
    function areNotificationsEnabled : boolean; cdecl;                          // ()Z A: $1
    function getActiveNotifications : TJavaArray<JStatusBarNotification>; cdecl;// ()[Landroid/service/notification/StatusBarNotification; A: $1
    function getAutomaticZenRule(id : JString) : JAutomaticZenRule; cdecl;      // (Ljava/lang/String;)Landroid/app/AutomaticZenRule; A: $1
...
const
  TJNotificationManagerACTION_APP_BLOCK_STATE_CHANGED = 'android.app.action.APP_BLOCK_STATE_CHANGED';
  TJNotificationManagerACTION_INTERRUPTION_FILTER_CHANGED = 'android.app.action.INTERRUPTION_FILTER_CHANGED';
  TJNotificationManagerACTION_NOTIFICATION_CHANNEL_BLOCK_STATE_CHANGED = 'android.app.action.NOTIFICATION_CHANNEL_BLOCK_STATE_CHANGED';
  TJNotificationManagerACTION_NOTIFICATION_CHANNEL_GROUP_BLOCK_STATE_CHANGED = 'android.app.action.NOTIFICATION_CHANNEL_GROUP_BLOCK_STATE_CHANGED';
  ...
  TJNotificationManagerEXTRA_BLOCKED_STATE = 'android.app.extra.BLOCKED_STATE';
  TJNotificationManagerEXTRA_NOTIFICATION_CHANNEL_GROUP_ID = 'android.app.extra.NOTIFICATION_CHANNEL_GROUP_ID';
  TJNotificationManagerEXTRA_NOTIFICATION_CHANNEL_ID = 'android.app.extra.NOTIFICATION_CHANNEL_ID';
