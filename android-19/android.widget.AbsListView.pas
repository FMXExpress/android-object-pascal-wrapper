...
type
  ...
  JAbsListViewClass = interface(JObjectClass)
    ['{4298F147-45ED-4417-9EE0-1CFDE5337C63}']
  ...
  JAbsListView = interface(JObject)
    ['{197ADE43-4798-400F-8596-A10CAE6BF9BC}']
    function canScrollList(direction : Integer) : boolean; cdecl;               // (I)Z A: $1
    function checkInputConnectionProxy(view : JView) : boolean; cdecl;          // (Landroid/view/View;)Z A: $1
    function generateLayoutParams(attrs : JAttributeSet) : JAbsListView_LayoutParams; cdecl; overload;// (Landroid/util/AttributeSet;)Landroid/widget/AbsListView$LayoutParams; A: $1
    function getCacheColorHint : Integer; cdecl;                                // ()I A: $1
  ...
  // Merged from: .\android-19\android.widget.AbsListView_OnScrollListener.pas
  JAbsListView_OnScrollListenerClass = interface(JObjectClass)
    ['{EEE96392-642C-4F01-8D27-83DD7CC4942B}']
  ...
  JAbsListView_OnScrollListener = interface(JObject)
    ['{F14D00C5-10FB-4531-8FA1-307110728DBC}']
    procedure onScroll(JAbsListViewparam0 : JAbsListView; Integerparam1 : Integer; Integerparam2 : Integer; Integerparam3 : Integer) ; cdecl;// (Landroid/widget/AbsListView;III)V A: $401
    procedure onScrollStateChanged(JAbsListViewparam0 : JAbsListView; Integerparam1 : Integer) ; cdecl;// (Landroid/widget/AbsListView;I)V A: $401
  end;
