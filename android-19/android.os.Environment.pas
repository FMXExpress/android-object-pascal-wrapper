...
type
  ...
  JEnvironmentClass = interface(JObjectClass)
    ['{97E77FDB-C619-422D-9696-359CF30EC48F}']
    ...
    function getStorageState(path : JFile) : JString; cdecl;                    // (Ljava/io/File;)Ljava/lang/String; A: $9
  ...
  JEnvironment = interface(JObject)
    ['{5F56E735-E35B-4FDA-8D12-CD3FC5E4592C}']
  end;
