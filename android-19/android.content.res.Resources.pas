...
type
  ...
  JResourcesClass = interface(JObjectClass)
    ['{FED62441-5506-48CB-AEA9-EEAB2B619AE5}']
    ...
    function getDrawableForDensity(id : Integer; density : Integer) : JDrawable; cdecl;// (II)Landroid/graphics/drawable/Drawable; A: $1
  ...
  JResources = interface(JObject)
    ['{793FBE73-DB0B-4135-AD8D-79DAD915556A}']
    function getAnimation(id : Integer) : JXmlResourceParser; cdecl;            // (I)Landroid/content/res/XmlResourceParser; A: $1
    function getBoolean(id : Integer) : boolean; cdecl;                         // (I)Z A: $1
    function getColor(id : Integer) : Integer; cdecl;                           // (I)I A: $1
    function getColorStateList(id : Integer) : JColorStateList; cdecl;          // (I)Landroid/content/res/ColorStateList; A: $1
