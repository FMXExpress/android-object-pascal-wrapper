...
type
  ...
  JWebSettingsClass = interface(JObjectClass)
    ['{A0AF95E3-8744-4AD1-AC60-634710901F8A}']
    ...
    function getDatabasePath : JString; deprecated; cdecl;                      // ()Ljava/lang/String; A: $21
    ...
    function getDefaultZoom : JWebSettings_ZoomDensity; deprecated; cdecl;      // ()Landroid/webkit/WebSettings$ZoomDensity; A: $1
    ...
    procedure setDatabasePath(databasePath : JString) ; deprecated; cdecl;      // (Ljava/lang/String;)V A: $21
    ...
    procedure setDefaultZoom(zoom : JWebSettings_ZoomDensity) ; deprecated; cdecl;// (Landroid/webkit/WebSettings$ZoomDensity;)V A: $1
  ...
  JWebSettings = interface(JObject)
    ['{6EA9FEEA-C7F8-4ABA-8D70-8E0A459460D1}']
    function enableSmoothTransition : boolean; deprecated; cdecl;               // ()Z A: $1
    function getAllowContentAccess : boolean; cdecl;                            // ()Z A: $1
    function getAllowFileAccess : boolean; cdecl;                               // ()Z A: $1
    function getAllowFileAccessFromFileURLs : boolean; cdecl;                   // ()Z A: $401
