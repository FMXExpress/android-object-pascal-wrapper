...
type
  ...
  JIntentFilterClass = interface(JObjectClass)
    ['{8B416C4F-7C9F-4FD3-BE73-2E0B93BB3AB4}']
    ...
    function _GetMATCH_CATEGORY_SCHEME_SPECIFIC_PART : Integer; cdecl;          //  A: $19
    ...
    function countDataSchemeSpecificParts : Integer; cdecl;                     // ()I A: $11
    ...
    function getDataSchemeSpecificPart(&index : Integer) : JPatternMatcher; cdecl;// (I)Landroid/os/PatternMatcher; A: $11
    ...
    function hasDataSchemeSpecificPart(data : JString) : boolean; cdecl;        // (Ljava/lang/String;)Z A: $11
    ...
    function schemeSpecificPartsIterator : JIterator; cdecl;                    // ()Ljava/util/Iterator; A: $11
    ...
    procedure addDataSchemeSpecificPart(ssp : JString; &type : Integer) ; cdecl;// (Ljava/lang/String;I)V A: $11
    ...
    property MATCH_CATEGORY_SCHEME_SPECIFIC_PART : Integer read _GetMATCH_CATEGORY_SCHEME_SPECIFIC_PART;// I A: $19
  ...
  JIntentFilter = interface(JObject)
    ['{426BD5E3-C0B6-4603-9CC0-9E2AF470FCF3}']
    procedure dump(du : JPrinter; prefix : JString) ; cdecl;                    // (Landroid/util/Printer;Ljava/lang/String;)V A: $1
    procedure readFromXml(parser : JXmlPullParser) ; cdecl;                     // (Lorg/xmlpull/v1/XmlPullParser;)V A: $1
    procedure writeToXml(serializer : JXmlSerializer) ; cdecl;                  // (Lorg/xmlpull/v1/XmlSerializer;)V A: $1
  end;
...
const
  ...
  TJIntentFilterMATCH_CATEGORY_SCHEME_SPECIFIC_PART = 5767168;
