...
type
  ...
  JSensorManagerClass = interface(JObjectClass)
    ['{5611E596-27B1-4160-9405-E198DD3C38DB}']
    ...
    function registerListener(listener : JSensorEventListener; sensor : JSensor; rateUs : Integer) : boolean; cdecl; overload;// (Landroid/hardware/SensorEventListener;Landroid/hardware/Sensor;I)Z A: $1
    function registerListener(listener : JSensorEventListener; sensor : JSensor; rateUs : Integer; handler : JHandler) : boolean; cdecl; overload;// (Landroid/hardware/SensorEventListener;Landroid/hardware/Sensor;ILandroid/os/Handler;)Z A: $1
    function registerListener(listener : JSensorEventListener; sensor : JSensor; rateUs : Integer; maxBatchReportLatencyUs : Integer) : boolean; cdecl; overload;// (Landroid/hardware/SensorEventListener;Landroid/hardware/Sensor;II)Z A: $1
    function registerListener(listener : JSensorEventListener; sensor : JSensor; rateUs : Integer; maxBatchReportLatencyUs : Integer; handler : JHandler) : boolean; cdecl; overload;// (Landroid/hardware/SensorEventListener;Landroid/hardware/Sensor;IILandroid/os/Handler;)Z A: $1
  ...
  JSensorManager = interface(JObject)
    ['{D4ED6B6F-5C76-4AD2-BE3B-70AF2F82F2B0}']
    function cancelTriggerSensor(listener : JTriggerEventListener; sensor : JSensor) : boolean; cdecl;// (Landroid/hardware/TriggerEventListener;Landroid/hardware/Sensor;)Z A: $1
    function flush(listener : JSensorEventListener) : boolean; cdecl;           // (Landroid/hardware/SensorEventListener;)Z A: $1
    function getDefaultSensor(&type : Integer) : JSensor; cdecl; overload;      // (I)Landroid/hardware/Sensor; A: $1
    function getDefaultSensor(&type : Integer; wakeUp : boolean) : JSensor; cdecl; overload;// (IZ)Landroid/hardware/Sensor; A: $1
