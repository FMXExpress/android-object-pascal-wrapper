...
type
  ...
  JDevicePolicyManagerClass = interface(JObjectClass)
    ...
    function createAndInitializeUser(admin : JComponentName; &name : JString; ownerName : JString; profileOwnerComponent : JComponentName; adminExtras : JBundle) : JUserHandle; deprecated; cdecl;// (Landroid/content/ComponentName;Ljava/lang/String;Ljava/lang/String;Landroid/content/ComponentName;Landroid/os/Bundle;)Landroid/os/UserHandle; A: $1
    function createUser(admin : JComponentName; &name : JString) : JUserHandle; deprecated; cdecl;// (Landroid/content/ComponentName;Ljava/lang/String;)Landroid/os/UserHandle; A: $1
