...
type
  ...
  JNotificationManager_PolicyClass = interface(JObjectClass)
    ['{9EA2BFC3-51E1-4E11-A389-91C6D7030302}']
    ...
    function init(priorityCategories : Integer; priorityCallSenders : Integer; priorityMessageSenders : Integer) : JNotificationManager_Policy; cdecl;// (III)V A: $1
  ...
  JNotificationManager_Policy = interface(JObject)
    ['{F64D7209-DF72-4D6F-A8E5-B71BA0A14B84}']
    function describeContents : Integer; cdecl;                                 // ()I A: $1
    function equals(o : JObject) : boolean; cdecl;                              // (Ljava/lang/Object;)Z A: $1
    function hashCode : Integer; cdecl;                                         // ()I A: $1
    function toString : JString; cdecl;                                         // ()Ljava/lang/String; A: $1
