...
type
  ...
  JCipherClass = interface(JObjectClass)
    ['{461A3E47-99DC-4F37-AFB0-0D9E94A9C95D}']
    ...
    procedure updateAAD(input : JByteBuffer) ; cdecl; overload;                 // (Ljava/nio/ByteBuffer;)V A: $11
    procedure updateAAD(input : TJavaArray<Byte>) ; cdecl; overload;            // ([B)V A: $11
    procedure updateAAD(input : TJavaArray<Byte>; inputOffset : Integer; inputLen : Integer) ; cdecl; overload;// ([BII)V A: $11
  ...
  JCipher = interface(JObject)
    ['{68AF524B-341E-4744-BE8F-AC7D0C0DF2B2}']
  end;
