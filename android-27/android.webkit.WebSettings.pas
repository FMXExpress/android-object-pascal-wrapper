...
type
  ...
  JWebSettingsClass = interface(JObjectClass)
    ['{C407BA8F-3CA3-44A8-BC13-40BC7C664BC5}']
    ...
    function _GetMENU_ITEM_NONE : Integer; cdecl;                               //  A: $19
    function _GetMENU_ITEM_PROCESS_TEXT : Integer; cdecl;                       //  A: $19
    function _GetMENU_ITEM_SHARE : Integer; cdecl;                              //  A: $19
    function _GetMENU_ITEM_WEB_SEARCH : Integer; cdecl;                         //  A: $19
    ...
    function getDisabledActionModeMenuItems : Integer; cdecl;                   // ()I A: $401
    ...
    procedure setDisabledActionModeMenuItems(Integerparam0 : Integer) ; cdecl;  // (I)V A: $401
    ...
    procedure setGeolocationDatabasePath(JStringparam0 : JString) ; deprecated; cdecl;// (Ljava/lang/String;)V A: $401
    ...
    procedure setOffscreenPreRaster(booleanparam0 : boolean) ; cdecl;           // (Z)V A: $401
    ...
    procedure setSafeBrowsingEnabled(booleanparam0 : boolean) ; cdecl;          // (Z)V A: $401
    procedure setSansSerifFontFamily(JStringparam0 : JString) ; cdecl;          // (Ljava/lang/String;)V A: $401
    procedure setSaveFormData(booleanparam0 : boolean) ; deprecated; cdecl;     // (Z)V A: $401
    ...
    property MENU_ITEM_NONE : Integer read _GetMENU_ITEM_NONE;                  // I A: $19
    property MENU_ITEM_PROCESS_TEXT : Integer read _GetMENU_ITEM_PROCESS_TEXT;  // I A: $19
    property MENU_ITEM_SHARE : Integer read _GetMENU_ITEM_SHARE;                // I A: $19
    property MENU_ITEM_WEB_SEARCH : Integer read _GetMENU_ITEM_WEB_SEARCH;      // I A: $19
  ...
  JWebSettings = interface(JObject)
    ['{A5D4FCB6-B59A-430C-A02E-C912E71ABA82}']
    function enableSmoothTransition : boolean; deprecated; cdecl;               // ()Z A: $401
    function getAllowContentAccess : boolean; cdecl;                            // ()Z A: $401
    function getAllowFileAccess : boolean; cdecl;                               // ()Z A: $401
    function getAllowFileAccessFromFileURLs : boolean; cdecl;                   // ()Z A: $401
...
const
  ...
  TJWebSettingsMENU_ITEM_NONE = 0;
  TJWebSettingsMENU_ITEM_PROCESS_TEXT = 4;
  TJWebSettingsMENU_ITEM_SHARE = 1;
  TJWebSettingsMENU_ITEM_WEB_SEARCH = 2;
