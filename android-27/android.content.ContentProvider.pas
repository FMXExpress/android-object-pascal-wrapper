...
type
  ...
  JContentProviderClass = interface(JObjectClass)
    ['{B52404D2-4C7A-4F6C-ABB3-9EF3703FA5EF}']
    ...
    function query(uri : JUri; projection : TJavaArray<JString>; queryArgs : JBundle; cancellationSignal : JCancellationSignal) : JCursor; cdecl; overload;// (Landroid/net/Uri;[Ljava/lang/String;Landroid/os/Bundle;Landroid/os/CancellationSignal;)Landroid/database/Cursor; A: $1
    ...
    function refresh(uri : JUri; args : JBundle; cancellationSignal : JCancellationSignal) : boolean; cdecl;// (Landroid/net/Uri;Landroid/os/Bundle;Landroid/os/CancellationSignal;)Z A: $1
  ...
  JContentProvider = interface(JObject)
    ['{8039FFBF-BE45-4C62-937F-C3115EDC3E55}']
    function applyBatch(operations : JArrayList) : TJavaArray<JContentProviderResult>; cdecl;// (Ljava/util/ArrayList;)[Landroid/content/ContentProviderResult; A: $1
    function bulkInsert(uri : JUri; values : TJavaArray<JContentValues>) : Integer; cdecl;// (Landroid/net/Uri;[Landroid/content/ContentValues;)I A: $1
    function call(method : JString; arg : JString; extras : JBundle) : JBundle; cdecl;// (Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle; A: $1
    function canonicalize(url : JUri) : JUri; cdecl;                            // (Landroid/net/Uri;)Landroid/net/Uri; A: $1
  ...
  // Merged from: .\android.content.ContentProviderClient.pas
  JContentProviderClientClass = interface(JObjectClass)
    ['{CC1AF69D-BA35-468C-9665-2B26AFF4D8A1}']
    function applyBatch(operations : JArrayList) : TJavaArray<JContentProviderResult>; cdecl;// (Ljava/util/ArrayList;)[Landroid/content/ContentProviderResult; A: $1
    ...
    function refresh(url : JUri; args : JBundle; cancellationSignal : JCancellationSignal) : boolean; cdecl;// (Landroid/net/Uri;Landroid/os/Bundle;Landroid/os/CancellationSignal;)Z A: $1
  ...
  JContentProviderClient = interface(JObject)
    ['{2E7F4A58-3120-4431-BA5B-9D0ACF6DF8E4}']
    function applyBatch(operations : JArrayList) : TJavaArray<JContentProviderResult>; cdecl;// (Ljava/util/ArrayList;)[Landroid/content/ContentProviderResult; A: $1
    function bulkInsert(url : JUri; initialValues : TJavaArray<JContentValues>) : Integer; cdecl;// (Landroid/net/Uri;[Landroid/content/ContentValues;)I A: $1
    function call(method : JString; arg : JString; extras : JBundle) : JBundle; cdecl;// (Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle; A: $1
    function delete(url : JUri; selection : JString; selectionArgs : TJavaArray<JString>) : Integer; cdecl;// (Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I A: $1
  ...
  // Merged from: .\android.content.ContentResolver.pas
  JContentResolverClass = interface(JObjectClass)
    ['{6D18A81A-BED8-4E0B-95C9-D50C46D7E29D}']
    ...
    function _GetEXTRA_HONORED_ARGS : JString; cdecl;                           //  A: $19
    function _GetEXTRA_REFRESH_SUPPORTED : JString; cdecl;                      //  A: $19
    function _GetEXTRA_SIZE : JString; cdecl;                                   //  A: $19
    function _GetEXTRA_TOTAL_COUNT : JString; cdecl;                            //  A: $19
    function _GetNOTIFY_SKIP_NOTIFY_FOR_DESCENDANTS : Integer; cdecl;           //  A: $19
    function _GetNOTIFY_SYNC_TO_NETWORK : Integer; cdecl;                       //  A: $19
    function _GetQUERY_ARG_LIMIT : JString; cdecl;                              //  A: $19
    function _GetQUERY_ARG_OFFSET : JString; cdecl;                             //  A: $19
    function _GetQUERY_ARG_SORT_COLLATION : JString; cdecl;                     //  A: $19
    function _GetQUERY_ARG_SORT_COLUMNS : JString; cdecl;                       //  A: $19
    function _GetQUERY_ARG_SORT_DIRECTION : JString; cdecl;                     //  A: $19
    function _GetQUERY_ARG_SQL_SELECTION : JString; cdecl;                      //  A: $19
    function _GetQUERY_ARG_SQL_SELECTION_ARGS : JString; cdecl;                 //  A: $19
    function _GetQUERY_ARG_SQL_SORT_ORDER : JString; cdecl;                     //  A: $19
    function _GetQUERY_SORT_DIRECTION_ASCENDING : Integer; cdecl;               //  A: $19
    function _GetQUERY_SORT_DIRECTION_DESCENDING : Integer; cdecl;              //  A: $19
    ...
    function query(uri : JUri; projection : TJavaArray<JString>; selection : JString; selectionArgs : TJavaArray<JString>; sortOrder : JString; cancellationSignal : JCancellationSignal) : JCursor; cdecl; overload;// (Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/database/Cursor; A: $11
    function refresh(url : JUri; args : JBundle; cancellationSignal : JCancellationSignal) : boolean; cdecl;// (Landroid/net/Uri;Landroid/os/Bundle;Landroid/os/CancellationSignal;)Z A: $11
    function uncanonicalize(url : JUri) : JUri; cdecl;                          // (Landroid/net/Uri;)Landroid/net/Uri; A: $11
    ...
    procedure notifyChange(uri : JUri; observer : JContentObserver; flags : Integer) ; cdecl; overload;// (Landroid/net/Uri;Landroid/database/ContentObserver;I)V A: $1
    ...
    property EXTRA_HONORED_ARGS : JString read _GetEXTRA_HONORED_ARGS;          // Ljava/lang/String; A: $19
    property EXTRA_REFRESH_SUPPORTED : JString read _GetEXTRA_REFRESH_SUPPORTED;// Ljava/lang/String; A: $19
    property EXTRA_SIZE : JString read _GetEXTRA_SIZE;                          // Ljava/lang/String; A: $19
    property EXTRA_TOTAL_COUNT : JString read _GetEXTRA_TOTAL_COUNT;            // Ljava/lang/String; A: $19
    property NOTIFY_SKIP_NOTIFY_FOR_DESCENDANTS : Integer read _GetNOTIFY_SKIP_NOTIFY_FOR_DESCENDANTS;// I A: $19
    property NOTIFY_SYNC_TO_NETWORK : Integer read _GetNOTIFY_SYNC_TO_NETWORK;  // I A: $19
    property QUERY_ARG_LIMIT : JString read _GetQUERY_ARG_LIMIT;                // Ljava/lang/String; A: $19
    property QUERY_ARG_OFFSET : JString read _GetQUERY_ARG_OFFSET;              // Ljava/lang/String; A: $19
    property QUERY_ARG_SORT_COLLATION : JString read _GetQUERY_ARG_SORT_COLLATION;// Ljava/lang/String; A: $19
    property QUERY_ARG_SORT_COLUMNS : JString read _GetQUERY_ARG_SORT_COLUMNS;  // Ljava/lang/String; A: $19
    property QUERY_ARG_SORT_DIRECTION : JString read _GetQUERY_ARG_SORT_DIRECTION;// Ljava/lang/String; A: $19
    property QUERY_ARG_SQL_SELECTION : JString read _GetQUERY_ARG_SQL_SELECTION;// Ljava/lang/String; A: $19
    property QUERY_ARG_SQL_SELECTION_ARGS : JString read _GetQUERY_ARG_SQL_SELECTION_ARGS;// Ljava/lang/String; A: $19
    property QUERY_ARG_SQL_SORT_ORDER : JString read _GetQUERY_ARG_SQL_SORT_ORDER;// Ljava/lang/String; A: $19
    property QUERY_SORT_DIRECTION_ASCENDING : Integer read _GetQUERY_SORT_DIRECTION_ASCENDING;// I A: $19
    property QUERY_SORT_DIRECTION_DESCENDING : Integer read _GetQUERY_SORT_DIRECTION_DESCENDING;// I A: $19
  ...
  JContentResolver = interface(JObject)
    ['{1DE74DD7-EF81-464E-9CC1-7E0E8470E269}']
    function applyBatch(authority : JString; operations : JArrayList) : TJavaArray<JContentProviderResult>; cdecl;// (Ljava/lang/String;Ljava/util/ArrayList;)[Landroid/content/ContentProviderResult; A: $1
    function getOutgoingPersistedUriPermissions : JList; cdecl;                 // ()Ljava/util/List; A: $1
    function getPersistedUriPermissions : JList; cdecl;                         // ()Ljava/util/List; A: $1
    function getStreamTypes(url : JUri; mimeTypeFilter : JString) : TJavaArray<JString>; cdecl;// (Landroid/net/Uri;Ljava/lang/String;)[Ljava/lang/String; A: $1
  ...
  JCursorClass = interface(JObjectClass)
    ['{C53AD345-0C83-478B-808E-F6ED1C2122C9}']
  ...
  JCursor = interface(JObject)
    ['{E73ADC56-34B9-4932-8D9E-725A32ED6E96}']
    function getBlob(Integerparam0 : Integer) : TJavaArray<Byte>; cdecl;        // (I)[B A: $401
    function getColumnCount : Integer; cdecl;                                   // ()I A: $401
    function getColumnIndex(JStringparam0 : JString) : Integer; cdecl;          // (Ljava/lang/String;)I A: $401
    function getColumnIndexOrThrow(JStringparam0 : JString) : Integer; cdecl;   // (Ljava/lang/String;)I A: $401
...
const
  ...
  TJContentResolverEXTRA_HONORED_ARGS = 'android.content.extra.HONORED_ARGS';
  TJContentResolverEXTRA_REFRESH_SUPPORTED = 'android.content.extra.REFRESH_SUPPORTED';
  TJContentResolverEXTRA_SIZE = 'android.content.extra.SIZE';
  TJContentResolverEXTRA_TOTAL_COUNT = 'android.content.extra.TOTAL_COUNT';
  TJContentResolverNOTIFY_SKIP_NOTIFY_FOR_DESCENDANTS = 2;
  TJContentResolverNOTIFY_SYNC_TO_NETWORK = 1;
  TJContentResolverQUERY_ARG_LIMIT = 'android:query-arg-limit';
  TJContentResolverQUERY_ARG_OFFSET = 'android:query-arg-offset';
  TJContentResolverQUERY_ARG_SORT_COLLATION = 'android:query-arg-sort-collation';
  TJContentResolverQUERY_ARG_SORT_COLUMNS = 'android:query-arg-sort-columns';
  TJContentResolverQUERY_ARG_SORT_DIRECTION = 'android:query-arg-sort-direction';
  TJContentResolverQUERY_ARG_SQL_SELECTION = 'android:query-arg-sql-selection';
  TJContentResolverQUERY_ARG_SQL_SELECTION_ARGS = 'android:query-arg-sql-selection-args';
  TJContentResolverQUERY_ARG_SQL_SORT_ORDER = 'android:query-arg-sql-sort-order';
  TJContentResolverQUERY_SORT_DIRECTION_ASCENDING = 0;
  TJContentResolverQUERY_SORT_DIRECTION_DESCENDING = 1;
