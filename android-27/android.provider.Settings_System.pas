...
type
  ...
  JSettings_SystemClass = interface(JObjectClass)
    ['{8A87013D-6FC2-4454-BE97-B895CF84F603}']
    ...
    function _GetDTMF_TONE_TYPE_WHEN_DIALING : JString; cdecl;                  //  A: $19
    ...
    function _GetVIBRATE_WHEN_RINGING : JString; cdecl;                         //  A: $19
    ...
    function canWrite(context : JContext) : boolean; cdecl;                     // (Landroid/content/Context;)Z A: $9
    ...
    property DTMF_TONE_TYPE_WHEN_DIALING : JString read _GetDTMF_TONE_TYPE_WHEN_DIALING;// Ljava/lang/String; A: $19
    ...
    property VIBRATE_WHEN_RINGING : JString read _GetVIBRATE_WHEN_RINGING;      // Ljava/lang/String; A: $19
  ...
  JSettings_System = interface(JObject)
    ['{C598C6D4-9978-463C-B3DF-CBCB03B92666}']
  end;
...
const
  ...
  TJSettings_SystemDTMF_TONE_TYPE_WHEN_DIALING = 'dtmf_tone_type';
  ...
  TJSettings_SystemVIBRATE_WHEN_RINGING = 'vibrate_when_ringing';
