...
type
  ...
  JAccountManagerClass = interface(JObjectClass)
    ['{99373AD4-FADD-4E9A-9D30-B31CE28DC509}']
    function _GetACTION_ACCOUNT_REMOVED : JString; cdecl;                       //  A: $19
    ...
    function _GetKEY_ACCOUNT_SESSION_BUNDLE : JString; cdecl;                   //  A: $19
    function _GetKEY_ACCOUNT_STATUS_TOKEN : JString; cdecl;                     //  A: $19
    ...
    function _GetKEY_LAST_AUTHENTICATED_TIME : JString; cdecl;                  //  A: $19
    ...
    function _GetPACKAGE_NAME_KEY_LEGACY_NOT_VISIBLE : JString; cdecl;          //  A: $19
    function _GetPACKAGE_NAME_KEY_LEGACY_VISIBLE : JString; cdecl;              //  A: $19
    function _GetVISIBILITY_NOT_VISIBLE : Integer; cdecl;                       //  A: $19
    function _GetVISIBILITY_UNDEFINED : Integer; cdecl;                         //  A: $19
    function _GetVISIBILITY_USER_MANAGED_NOT_VISIBLE : Integer; cdecl;          //  A: $19
    function _GetVISIBILITY_USER_MANAGED_VISIBLE : Integer; cdecl;              //  A: $19
    ...
    function addAccountExplicitly(account : JAccount; password : JString; extras : JBundle; visibility : JMap) : boolean; cdecl; overload;// (Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;Ljava/util/Map;)Z A: $1
    function addAccountExplicitly(account : JAccount; password : JString; userdata : JBundle) : boolean; cdecl; overload;// (Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Z A: $1
    ...
    function finishSession(sessionBundle : JBundle; activity : JActivity; callback : JAccountManagerCallback; handler : JHandler) : JAccountManagerFuture; cdecl;// (Landroid/os/Bundle;Landroid/app/Activity;Landroid/accounts/AccountManagerCallback;Landroid/os/Handler;)Landroid/accounts/AccountManagerFuture; A: $1
    function get(context : JContext) : JAccountManager; cdecl;                  // (Landroid/content/Context;)Landroid/accounts/AccountManager; A: $9
    function getAccountVisibility(account : JAccount; packageName : JString) : Integer; cdecl;// (Landroid/accounts/Account;Ljava/lang/String;)I A: $1
    function getAccounts : TJavaArray<JAccount>; cdecl;                         // ()[Landroid/accounts/Account; A: $1
    function getAccountsAndVisibilityForPackage(packageName : JString; accountType : JString) : JMap; cdecl;// (Ljava/lang/String;Ljava/lang/String;)Ljava/util/Map; A: $1
    ...
    function getPackagesAndVisibilityForAccount(account : JAccount) : JMap; cdecl;// (Landroid/accounts/Account;)Ljava/util/Map; A: $1
    function getPassword(account : JAccount) : JString; cdecl;                  // (Landroid/accounts/Account;)Ljava/lang/String; A: $1
    function getPreviousName(account : JAccount) : JString; cdecl;              // (Landroid/accounts/Account;)Ljava/lang/String; A: $1
    ...
    function isCredentialsUpdateSuggested(account : JAccount; statusToken : JString; callback : JAccountManagerCallback; handler : JHandler) : JAccountManagerFuture; cdecl;// (Landroid/accounts/Account;Ljava/lang/String;Landroid/accounts/AccountManagerCallback;Landroid/os/Handler;)Landroid/accounts/AccountManagerFuture; A: $1
    function newChooseAccountIntent(selectedAccount : JAccount; allowableAccounts : JArrayList; allowableAccountTypes : TJavaArray<JString>; alwaysPromptForAccount : boolean; descriptionOverrideText : JString; addAccountAuthTokenType : JString; addAccountRequiredFeatures : TJavaArray<JString>; addAccountOptions : JBundle) : JIntent; deprecated; cdecl; overload;// (Landroid/accounts/Account;Ljava/util/ArrayList;[Ljava/lang/String;ZLjava/lang/String;Ljava/lang/String;[Ljava/lang/String;Landroid/os/Bundle;)Landroid/content/Intent; A: $9
    function newChooseAccountIntent(selectedAccount : JAccount; allowableAccounts : JList; allowableAccountTypes : TJavaArray<JString>; descriptionOverrideText : JString; addAccountAuthTokenType : JString; addAccountRequiredFeatures : TJavaArray<JString>; addAccountOptions : JBundle) : JIntent; cdecl; overload;// (Landroid/accounts/Account;Ljava/util/List;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Landroid/os/Bundle;)Landroid/content/Intent; A: $9
    function notifyAccountAuthenticated(account : JAccount) : boolean; cdecl;   // (Landroid/accounts/Account;)Z A: $1
    ...
    function removeAccount(account : JAccount; activity : JActivity; callback : JAccountManagerCallback; handler : JHandler) : JAccountManagerFuture; cdecl; overload;// (Landroid/accounts/Account;Landroid/app/Activity;Landroid/accounts/AccountManagerCallback;Landroid/os/Handler;)Landroid/accounts/AccountManagerFuture; A: $1
    function removeAccount(account : JAccount; callback : JAccountManagerCallback; handler : JHandler) : JAccountManagerFuture; deprecated; cdecl; overload;// (Landroid/accounts/Account;Landroid/accounts/AccountManagerCallback;Landroid/os/Handler;)Landroid/accounts/AccountManagerFuture; A: $1
    function removeAccountExplicitly(account : JAccount) : boolean; cdecl;      // (Landroid/accounts/Account;)Z A: $1
    function renameAccount(account : JAccount; newName : JString; callback : JAccountManagerCallback; handler : JHandler) : JAccountManagerFuture; cdecl;// (Landroid/accounts/Account;Ljava/lang/String;Landroid/accounts/AccountManagerCallback;Landroid/os/Handler;)Landroid/accounts/AccountManagerFuture; A: $1
    function setAccountVisibility(account : JAccount; packageName : JString; visibility : Integer) : boolean; cdecl;// (Landroid/accounts/Account;Ljava/lang/String;I)Z A: $1
    function startAddAccountSession(accountType : JString; authTokenType : JString; requiredFeatures : TJavaArray<JString>; options : JBundle; activity : JActivity; callback : JAccountManagerCallback; handler : JHandler) : JAccountManagerFuture; cdecl;// (Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Landroid/os/Bundle;Landroid/app/Activity;Landroid/accounts/AccountManagerCallback;Landroid/os/Handler;)Landroid/accounts/AccountManagerFuture; A: $1
    function startUpdateCredentialsSession(account : JAccount; authTokenType : JString; options : JBundle; activity : JActivity; callback : JAccountManagerCallback; handler : JHandler) : JAccountManagerFuture; cdecl;// (Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;Landroid/app/Activity;Landroid/accounts/AccountManagerCallback;Landroid/os/Handler;)Landroid/accounts/AccountManagerFuture; A: $1
    function updateCredentials(account : JAccount; authTokenType : JString; options : JBundle; activity : JActivity; callback : JAccountManagerCallback; handler : JHandler) : JAccountManagerFuture; cdecl;// (Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;Landroid/app/Activity;Landroid/accounts/AccountManagerCallback;Landroid/os/Handler;)Landroid/accounts/AccountManagerFuture; A: $1
    procedure addOnAccountsUpdatedListener(listener : JOnAccountsUpdateListener; handler : JHandler; updateImmediately : boolean) ; cdecl; overload;// (Landroid/accounts/OnAccountsUpdateListener;Landroid/os/Handler;Z)V A: $1
    procedure addOnAccountsUpdatedListener(listener : JOnAccountsUpdateListener; handler : JHandler; updateImmediately : boolean; accountTypes : TJavaArray<JString>) ; cdecl; overload;// (Landroid/accounts/OnAccountsUpdateListener;Landroid/os/Handler;Z[Ljava/lang/String;)V A: $1
    ...
    property ACTION_ACCOUNT_REMOVED : JString read _GetACTION_ACCOUNT_REMOVED;  // Ljava/lang/String; A: $19
    ...
    property KEY_ACCOUNT_SESSION_BUNDLE : JString read _GetKEY_ACCOUNT_SESSION_BUNDLE;// Ljava/lang/String; A: $19
    property KEY_ACCOUNT_STATUS_TOKEN : JString read _GetKEY_ACCOUNT_STATUS_TOKEN;// Ljava/lang/String; A: $19
    ...
    property KEY_LAST_AUTHENTICATED_TIME : JString read _GetKEY_LAST_AUTHENTICATED_TIME;// Ljava/lang/String; A: $19
    ...
    property PACKAGE_NAME_KEY_LEGACY_NOT_VISIBLE : JString read _GetPACKAGE_NAME_KEY_LEGACY_NOT_VISIBLE;// Ljava/lang/String; A: $19
    property PACKAGE_NAME_KEY_LEGACY_VISIBLE : JString read _GetPACKAGE_NAME_KEY_LEGACY_VISIBLE;// Ljava/lang/String; A: $19
    property VISIBILITY_NOT_VISIBLE : Integer read _GetVISIBILITY_NOT_VISIBLE;  // I A: $19
    property VISIBILITY_UNDEFINED : Integer read _GetVISIBILITY_UNDEFINED;      // I A: $19
    property VISIBILITY_USER_MANAGED_NOT_VISIBLE : Integer read _GetVISIBILITY_USER_MANAGED_NOT_VISIBLE;// I A: $19
    property VISIBILITY_USER_MANAGED_VISIBLE : Integer read _GetVISIBILITY_USER_MANAGED_VISIBLE;// I A: $19
  ...
  JAccountManager = interface(JObject)
    ['{F514FAD8-524A-452A-AAA3-ED0CAF0C854D}']
    function addAccount(accountType : JString; authTokenType : JString; requiredFeatures : TJavaArray<JString>; addAccountOptions : JBundle; activity : JActivity; callback : JAccountManagerCallback; handler : JHandler) : JAccountManagerFuture; cdecl;// (Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Landroid/os/Bundle;Landroid/app/Activity;Landroid/accounts/AccountManagerCallback;Landroid/os/Handler;)Landroid/accounts/AccountManagerFuture; A: $1
    function addAccountExplicitly(account : JAccount; password : JString; extras : JBundle; visibility : JMap) : boolean; cdecl; overload;// (Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;Ljava/util/Map;)Z A: $1
    function addAccountExplicitly(account : JAccount; password : JString; userdata : JBundle) : boolean; cdecl; overload;// (Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Z A: $1
    function blockingGetAuthToken(account : JAccount; authTokenType : JString; notifyAuthFailure : boolean) : JString; cdecl;// (Landroid/accounts/Account;Ljava/lang/String;Z)Ljava/lang/String; A: $1
...
const
  TJAccountManagerACTION_ACCOUNT_REMOVED = 'android.accounts.action.ACCOUNT_REMOVED';
  ...
  TJAccountManagerKEY_ACCOUNT_SESSION_BUNDLE = 'accountSessionBundle';
  TJAccountManagerKEY_ACCOUNT_STATUS_TOKEN = 'accountStatusToken';
  ...
  TJAccountManagerKEY_LAST_AUTHENTICATED_TIME = 'lastAuthenticatedTime';
  ...
  TJAccountManagerPACKAGE_NAME_KEY_LEGACY_NOT_VISIBLE = 'android:accounts:key_legacy_not_visible';
  TJAccountManagerPACKAGE_NAME_KEY_LEGACY_VISIBLE = 'android:accounts:key_legacy_visible';
  TJAccountManagerVISIBILITY_NOT_VISIBLE = 3;
  TJAccountManagerVISIBILITY_UNDEFINED = 0;
  TJAccountManagerVISIBILITY_USER_MANAGED_NOT_VISIBLE = 4;
  TJAccountManagerVISIBILITY_USER_MANAGED_VISIBLE = 2;
  TJAccountManagerVISIBILITY_VISIBLE = 1;
