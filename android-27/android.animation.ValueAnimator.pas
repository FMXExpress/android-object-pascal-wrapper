...
type
  ...
  JValueAnimator = interface(JObject)
    ['{8B3B4CDD-FDA9-42B3-B3C8-DB98D9563EA4}']
    function clone : JValueAnimator; cdecl;                                     // ()Landroid/animation/ValueAnimator; A: $1
    function getAnimatedFraction : Single; cdecl;                               // ()F A: $1
    function getAnimatedValue : JObject; cdecl; overload;                       // ()Ljava/lang/Object; A: $1
    function getAnimatedValue(propertyName : JString) : JObject; cdecl; overload;// (Ljava/lang/String;)Ljava/lang/Object; A: $1
  ...
  JValueAnimator_AnimatorUpdateListenerClass = interface(JObjectClass)
    ['{DDF5D9E4-6B50-48D7-8056-5206DE2BEAF6}']
  ...
  JValueAnimator_AnimatorUpdateListener = interface(JObject)
    ['{6ADFE48A-FB89-45B6-A4A8-F000A2502473}']
    procedure onAnimationUpdate(JValueAnimatorparam0 : JValueAnimator) ; cdecl; // (Landroid/animation/ValueAnimator;)V A: $401
  end;
