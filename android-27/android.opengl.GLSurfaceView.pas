...
type
  ...
  JGLSurfaceViewClass = interface(JObjectClass)
    ['{66AC7BD2-E382-4686-B4DA-0439833F751D}']
    ...
    procedure surfaceRedrawNeeded(holder : JSurfaceHolder) ; deprecated; cdecl; // (Landroid/view/SurfaceHolder;)V A: $1
    procedure surfaceRedrawNeededAsync(holder : JSurfaceHolder; finishDrawing : JRunnable) ; cdecl;// (Landroid/view/SurfaceHolder;Ljava/lang/Runnable;)V A: $1
  ...
  JGLSurfaceView = interface(JObject)
    ['{AD640ABA-3BA7-41EE-AFF3-E9C050A2CD51}']
    function getDebugFlags : Integer; cdecl;                                    // ()I A: $1
    function getPreserveEGLContextOnPause : boolean; cdecl;                     // ()Z A: $1
    function getRenderMode : Integer; cdecl;                                    // ()I A: $1
    procedure onPause ; cdecl;                                                  // ()V A: $1
