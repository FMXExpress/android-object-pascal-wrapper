...
type
  ...
  JMediaMetadataClass = interface(JObjectClass)
    ['{2AF50010-7EBF-4BA0-AEEC-C7EBC0E4D202}']
    ...
    function _GetMETADATA_KEY_BT_FOLDER_TYPE : JString; cdecl;                  //  A: $19
    ...
    function _GetMETADATA_KEY_MEDIA_URI : JString; cdecl;                       //  A: $19
    ...
    property METADATA_KEY_BT_FOLDER_TYPE : JString read _GetMETADATA_KEY_BT_FOLDER_TYPE;// Ljava/lang/String; A: $19
    ...
    property METADATA_KEY_MEDIA_URI : JString read _GetMETADATA_KEY_MEDIA_URI;  // Ljava/lang/String; A: $19
  ...
  JMediaMetadata = interface(JObject)
    ['{E49E6003-A569-43F2-827D-B8EB8855B990}']
    function containsKey(key : JString) : boolean; cdecl;                       // (Ljava/lang/String;)Z A: $1
    function describeContents : Integer; cdecl;                                 // ()I A: $1
    function getBitmap(key : JString) : JBitmap; cdecl;                         // (Ljava/lang/String;)Landroid/graphics/Bitmap; A: $1
    function getDescription : JMediaDescription; cdecl;                         // ()Landroid/media/MediaDescription; A: $1
...
const
  ...
  TJMediaMetadataMETADATA_KEY_BT_FOLDER_TYPE = 'android.media.metadata.BT_FOLDER_TYPE';
  ...
  TJMediaMetadataMETADATA_KEY_MEDIA_URI = 'android.media.metadata.MEDIA_URI';
