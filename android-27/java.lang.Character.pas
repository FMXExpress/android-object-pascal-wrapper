...
type
  ...
  JCharacterClass = interface(JObjectClass)
    ['{98371C7B-ABD9-41AE-8521-22CFBF1D3742}']
    ...
    function codePointAt(a : TJavaArray<Char>; &index : Integer) : Integer; cdecl; overload;// ([CI)I A: $9
    function codePointAt(a : TJavaArray<Char>; &index : Integer; limit : Integer) : Integer; cdecl; overload;// ([CII)I A: $9
    function codePointAt(seq : JCharSequence; &index : Integer) : Integer; cdecl; overload;// (Ljava/lang/CharSequence;I)I A: $9
    function codePointBefore(a : TJavaArray<Char>; &index : Integer) : Integer; cdecl; overload;// ([CI)I A: $9
    function codePointBefore(a : TJavaArray<Char>; &index : Integer; start : Integer) : Integer; cdecl; overload;// ([CII)I A: $9
    function codePointBefore(seq : JCharSequence; &index : Integer) : Integer; cdecl; overload;// (Ljava/lang/CharSequence;I)I A: $9
    function codePointCount(a : TJavaArray<Char>; offset : Integer; count : Integer) : Integer; cdecl; overload;// ([CII)I A: $9
    ...
    function compare(x : Char; y : Char) : Integer; cdecl;                      // (CC)I A: $9
    function compareTo(anotherCharacter : JCharacter) : Integer; cdecl;         // (Ljava/lang/Character;)I A: $1
    function digit(ch : Char; radix : Integer) : Integer; cdecl; overload;      // (CI)I A: $9
    ...
    function getDirectionality(ch : Char) : Byte; cdecl; overload;              // (C)B A: $9
    ...
    function getNumericValue(ch : Char) : Integer; cdecl; overload;             // (C)I A: $9
    function getNumericValue(codePoint : Integer) : Integer; cdecl; overload;   // (I)I A: $9
    function getType(ch : Char) : Integer; cdecl; overload;                     // (C)I A: $9
    function getType(codePoint : Integer) : Integer; cdecl; overload;           // (I)I A: $9
    function hashCode : Integer; cdecl; overload;                               // ()I A: $1
    function hashCode(value : Char) : Integer; cdecl; overload;                 // (C)I A: $9
    function highSurrogate(codePoint : Integer) : Char; cdecl;                  // (I)C A: $9
    function init(value : Char) : JCharacter; cdecl;                            // (C)V A: $1
    function isAlphabetic(codePoint : Integer) : boolean; cdecl;                // (I)Z A: $9
    function isBmpCodePoint(codePoint : Integer) : boolean; cdecl;              // (I)Z A: $9
    function isDefined(ch : Char) : boolean; cdecl; overload;                   // (C)Z A: $9
    function isDefined(codePoint : Integer) : boolean; cdecl; overload;         // (I)Z A: $9
    function isDigit(ch : Char) : boolean; cdecl; overload;                     // (C)Z A: $9
    function isDigit(codePoint : Integer) : boolean; cdecl; overload;           // (I)Z A: $9
    function isHighSurrogate(ch : Char) : boolean; cdecl;                       // (C)Z A: $9
    function isISOControl(ch : Char) : boolean; cdecl; overload;                // (C)Z A: $9
    function isISOControl(codePoint : Integer) : boolean; cdecl; overload;      // (I)Z A: $9
    function isIdentifierIgnorable(ch : Char) : boolean; cdecl; overload;       // (C)Z A: $9
    function isIdentifierIgnorable(codePoint : Integer) : boolean; cdecl; overload;// (I)Z A: $9
    function isIdeographic(codePoint : Integer) : boolean; cdecl;               // (I)Z A: $9
    function isJavaIdentifierPart(ch : Char) : boolean; cdecl; overload;        // (C)Z A: $9
    function isJavaIdentifierPart(codePoint : Integer) : boolean; cdecl; overload;// (I)Z A: $9
    function isJavaIdentifierStart(ch : Char) : boolean; cdecl; overload;       // (C)Z A: $9
    function isJavaIdentifierStart(codePoint : Integer) : boolean; cdecl; overload;// (I)Z A: $9
    function isJavaLetter(ch : Char) : boolean; deprecated; cdecl;              // (C)Z A: $9
    function isJavaLetterOrDigit(ch : Char) : boolean; deprecated; cdecl;       // (C)Z A: $9
    function isLetter(ch : Char) : boolean; cdecl; overload;                    // (C)Z A: $9
    function isLetter(codePoint : Integer) : boolean; cdecl; overload;          // (I)Z A: $9
    function isLetterOrDigit(ch : Char) : boolean; cdecl; overload;             // (C)Z A: $9
    ...
    function isLowerCase(ch : Char) : boolean; cdecl; overload;                 // (C)Z A: $9
    function isLowerCase(codePoint : Integer) : boolean; cdecl; overload;       // (I)Z A: $9
    function isMirrored(ch : Char) : boolean; cdecl; overload;                  // (C)Z A: $9
    function isMirrored(codePoint : Integer) : boolean; cdecl; overload;        // (I)Z A: $9
    function isSpace(ch : Char) : boolean; deprecated; cdecl;                   // (C)Z A: $9
    function isSpaceChar(ch : Char) : boolean; cdecl; overload;                 // (C)Z A: $9
    ...
    function isTitleCase(ch : Char) : boolean; cdecl; overload;                 // (C)Z A: $9
    function isTitleCase(codePoint : Integer) : boolean; cdecl; overload;       // (I)Z A: $9
    function isUnicodeIdentifierPart(ch : Char) : boolean; cdecl; overload;     // (C)Z A: $9
    function isUnicodeIdentifierPart(codePoint : Integer) : boolean; cdecl; overload;// (I)Z A: $9
    function isUnicodeIdentifierStart(ch : Char) : boolean; cdecl; overload;    // (C)Z A: $9
    function isUnicodeIdentifierStart(codePoint : Integer) : boolean; cdecl; overload;// (I)Z A: $9
    function isUpperCase(ch : Char) : boolean; cdecl; overload;                 // (C)Z A: $9
    ...
    function isWhitespace(ch : Char) : boolean; cdecl; overload;                // (C)Z A: $9
    ...
    function offsetByCodePoints(a : TJavaArray<Char>; start : Integer; count : Integer; &index : Integer; codePointOffset : Integer) : Integer; cdecl; overload;// ([CIIII)I A: $9
    ...
    function reverseBytes(ch : Char) : Char; cdecl;                             // (C)C A: $9
    ...
    function toLowerCase(ch : Char) : Char; cdecl; overload;                    // (C)C A: $9
    ...
    function toString(c : Char) : JString; cdecl; overload;                     // (C)Ljava/lang/String; A: $9
    function toTitleCase(ch : Char) : Char; cdecl; overload;                    // (C)C A: $9
    function toTitleCase(codePoint : Integer) : Integer; cdecl; overload;       // (I)I A: $9
    function toUpperCase(ch : Char) : Char; cdecl; overload;                    // (C)C A: $9
  ...
  [JavaSignature('java/lang/Character$UnicodeScript')]
  JCharacter = interface(JObject)
    ['{20AD7208-240A-43B7-AE6C-3C645D4EB1BB}']
    function charValue : Char; cdecl;                                           // ()C A: $1
    function compareTo(anotherCharacter : JCharacter) : Integer; cdecl;         // (Ljava/lang/Character;)I A: $1
    function equals(obj : JObject) : boolean; cdecl;                            // (Ljava/lang/Object;)Z A: $1
    function hashCode : Integer; cdecl; overload;                               // ()I A: $1
