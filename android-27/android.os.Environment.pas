...
type
  ...
  JEnvironmentClass = interface(JObjectClass)
    ['{2EF034AC-EF15-4F1D-9B54-876F2486344C}']
    ...
    function _GetMEDIA_EJECTING : JString; cdecl;                               //  A: $19
    ...
    property MEDIA_EJECTING : JString read _GetMEDIA_EJECTING;                  // Ljava/lang/String; A: $19
  ...
  JEnvironment = interface(JObject)
    ['{573F4228-4B5C-46B3-B040-D3AE36C38617}']
  end;
...
const
  ...
  TJEnvironmentMEDIA_EJECTING = 'ejecting';
