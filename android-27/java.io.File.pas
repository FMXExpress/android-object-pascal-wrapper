...
type
  ...
  JFileClass = interface(JObjectClass)
    ['{D3F6FFAD-7F27-479E-97D1-B803A29E1427}']
    ...
    function compareTo(pathname : JFile) : Integer; cdecl;                      // (Ljava/io/File;)I A: $1
    ...
    function init(parent : JFile; child : JString) : JFile; cdecl; overload;    // (Ljava/io/File;Ljava/lang/String;)V A: $1
    function init(parent : JString; child : JString) : JFile; cdecl; overload;  // (Ljava/lang/String;Ljava/lang/String;)V A: $1
    function init(pathname : JString) : JFile; cdecl; overload;                 // (Ljava/lang/String;)V A: $1
    ...
    function renameTo(dest : JFile) : boolean; cdecl;                           // (Ljava/io/File;)Z A: $1
    ...
    function toPath : JPath; cdecl;                                             // ()Ljava/nio/file/Path; A: $1
    function toString : JString; cdecl;                                         // ()Ljava/lang/String; A: $1
    function toURI : JURI; cdecl;                                               // ()Ljava/net/URI; A: $1
    function toURL : JURL; deprecated; cdecl;                                   // ()Ljava/net/URL; A: $1
  ...
  JFile = interface(JObject)
    ['{ED1D7114-08CD-433F-85FC-A1974B524FF5}']
    function canExecute : boolean; cdecl;                                       // ()Z A: $1
    function canRead : boolean; cdecl;                                          // ()Z A: $1
    function canWrite : boolean; cdecl;                                         // ()Z A: $1
    function compareTo(pathname : JFile) : Integer; cdecl;                      // (Ljava/io/File;)I A: $1
